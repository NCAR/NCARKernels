...
CONTAINS
  ...
  SUBROUTINE psrad_interface( ncid, ncvarids, &
       ...
       & par_dff_frc                                                         )
integer, intent(in) :: ncid, ncvarids(:)
    INTEGER,INTENT(IN)  ::             &
...
!dir$ attributes align : 64 :: pm_sfc
    !
...
!dir$ attributes align: 64:: tk_hl_vr
...
!dir$ vector aligned
    ...
    !
    CALL srtm(krow, ncid, ncvarids,  kproma                                    , & 
