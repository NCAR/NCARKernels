...
IMPLICIT NONE
  ...
  PUBLIC :: lw_spec_samp, sw_spec_samp, lw_gpts_ts, sw_gpts_ts, rad_perm, l_lw_unique, l_sw_unique
  PUBLIC :: i_overlap, l_do_sep_clear_sky, l_partition_h2o
  ...
  LOGICAL :: l_lw_unique = .FALSE., l_sw_unique = .FALSE. 
  ...
  LOGICAL :: l_partition_h2o = .FALSE.   ! Use separate water vapor amounts in clear, cloudy skies
