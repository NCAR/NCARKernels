...
!EOP
  ...
  PUBLIC kw_externs_in_shr_log_mod
contains
...
!write in state subroutine for kw_externs_in_shr_log_mod
SUBROUTINE kw_externs_in_shr_log_mod(kgen_unit)
    INTEGER, INTENT(IN) :: kgen_unit
    LOGICAL :: kgen_istrue
    REAL(KIND=8) :: kgen_array_sum
    
    kgen_istrue = .TRUE.
    WRITE (UNIT = kgen_unit) shr_log_unit
END SUBROUTINE kw_externs_in_shr_log_mod
