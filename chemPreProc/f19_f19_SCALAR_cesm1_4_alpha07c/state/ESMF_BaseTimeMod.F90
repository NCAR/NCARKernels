...
!==============================================================================
      ...
      PUBLIC kw_esmf_basetimemod_esmf_basetime
      contains
...
!read state subroutine for kw_esmf_basetimemod_esmf_basetime
RECURSIVE SUBROUTINE kw_esmf_basetimemod_esmf_basetime(var, kgen_unit, printvar)
    TYPE(esmf_basetime), INTENT(IN) :: var
