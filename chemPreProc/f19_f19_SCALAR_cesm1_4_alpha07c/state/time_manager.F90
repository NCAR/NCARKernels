...
public ::&
   timemgr_set_step_size,    &! time manager initialization
...
!=========================================================================================
PUBLIC kw_externs_in_time_manager
PUBLIC kw_externs_out_time_manager
contains
!=========================================================================================

subroutine timemgr_set_step_size(dtime_in)
...
end subroutine timemgr_set_step_size
...
!write in state subroutine for kw_externs_in_time_manager
SUBROUTINE kw_externs_in_time_manager(kgen_unit)
    INTEGER, INTENT(IN) :: kgen_unit
    LOGICAL :: kgen_istrue
    REAL(KIND=8) :: kgen_array_sum
    
    CALL kw_esmf_clockmod_esmf_clock(tm_clock, kgen_unit)
END SUBROUTINE kw_externs_in_time_manager

!write out state subroutine for kw_externs_out_time_manager
SUBROUTINE kw_externs_out_time_manager(kgen_unit)
    INTEGER, INTENT(IN) :: kgen_unit
    LOGICAL :: kgen_istrue
    REAL(KIND=8) :: kgen_array_sum
    
END SUBROUTINE kw_externs_out_time_manager
