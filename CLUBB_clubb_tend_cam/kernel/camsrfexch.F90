...
!======================================================================
  ...
  RECURSIVE SUBROUTINE kr_camsrfexch_cam_in_t(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%asdir", kgen_array_sum, REAL(SUM(var%asdir, mask=(var%asdir .eq. var%asdir)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%asdif", kgen_array_sum, REAL(SUM(var%asdif, mask=(var%asdif .eq. var%asdif)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%aldir", kgen_array_sum, REAL(SUM(var%aldir, mask=(var%aldir .eq. var%aldir)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%aldif", kgen_array_sum, REAL(SUM(var%aldif, mask=(var%aldif .eq. var%aldif)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%lwup", kgen_array_sum, REAL(SUM(var%lwup, mask=(var%lwup .eq. var%lwup)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%lhf", kgen_array_sum, REAL(SUM(var%lhf, mask=(var%lhf .eq. var%lhf)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%shf", kgen_array_sum, REAL(SUM(var%shf, mask=(var%shf .eq. var%shf)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%wsx", kgen_array_sum, REAL(SUM(var%wsx, mask=(var%wsx .eq. var%wsx)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%wsy", kgen_array_sum, REAL(SUM(var%wsy, mask=(var%wsy .eq. var%wsy)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%tref", kgen_array_sum, REAL(SUM(var%tref, mask=(var%tref .eq. var%tref)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%qref", kgen_array_sum, REAL(SUM(var%qref, mask=(var%qref .eq. var%qref)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%u10", kgen_array_sum, REAL(SUM(var%u10, mask=(var%u10 .eq. var%u10)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%ts", kgen_array_sum, REAL(SUM(var%ts, mask=(var%ts .eq. var%ts)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%sst", kgen_array_sum, REAL(SUM(var%sst, mask=(var%sst .eq. var%sst)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%snowhland", kgen_array_sum, REAL(SUM(var%snowhland, mask=(var%snowhland .eq. &
          &var%snowhland)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%snowhice", kgen_array_sum, REAL(SUM(var%snowhice, mask=(var%snowhice .eq. var%snowhice)), &
          &8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%fco2_lnd", kgen_array_sum, REAL(SUM(var%fco2_lnd, mask=(var%fco2_lnd .eq. var%fco2_lnd)), &
          &8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%fco2_ocn", kgen_array_sum, REAL(SUM(var%fco2_ocn, mask=(var%fco2_ocn .eq. var%fco2_ocn)), &
          &8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%fdms", kgen_array_sum, REAL(SUM(var%fdms, mask=(var%fdms .eq. var%fdms)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%landfrac", kgen_array_sum, REAL(SUM(var%landfrac, mask=(var%landfrac .eq. var%landfrac)), &
          &8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%icefrac", kgen_array_sum, REAL(SUM(var%icefrac, mask=(var%icefrac .eq. var%icefrac)), 8), &
          &.TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%ocnfrac", kgen_array_sum, REAL(SUM(var%ocnfrac, mask=(var%ocnfrac .eq. var%ocnfrac)), 8), &
          &.TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%ram1, kgen_unit, printvar // "%ram1") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%ram1, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%fv, kgen_unit, printvar // "%fv") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%fv, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%soilw, kgen_unit, printvar // "%soilw") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%soilw, kgen_unit) 
      END IF   
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%cflx", kgen_array_sum, REAL(SUM(var%cflx, mask=(var%cflx .eq. var%cflx)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%ustar", kgen_array_sum, REAL(SUM(var%ustar, mask=(var%ustar .eq. var%ustar)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%re", kgen_array_sum, REAL(SUM(var%re, mask=(var%re .eq. var%re)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("var%ssq", kgen_array_sum, REAL(SUM(var%ssq, mask=(var%ssq .eq. var%ssq)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
      ...
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%depvel, kgen_unit, printvar // "%depvel") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%depvel, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%dstflx, kgen_unit, printvar // "%dstflx") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%dstflx, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%meganflx, kgen_unit, printvar // "%meganflx") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%meganflx, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%fireflx, kgen_unit, printvar // "%fireflx") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim2_ptr(var%fireflx, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%fireztop, kgen_unit, printvar // "%fireztop") 
      ELSE 
          CALL kr_cam_in_t_real__r8_dim1_ptr(var%fireztop, kgen_unit) 
      END IF   
        
  END SUBROUTINE kr_camsrfexch_cam_in_t 
    
  !write state subroutine for kr_cam_in_t_real__r8_dim1_ptr 
  SUBROUTINE kr_cam_in_t_real__r8_dim1_ptr(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("ram1", kgen_array_sum, REAL(SUM(var, mask=(var .eq. var)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
  ...
  SUBROUTINE kr_cam_in_t_real__r8_dim2_ptr(var, kgen_unit, printvar) 
      REAL(KIND=r8), INTENT(INOUT), POINTER, DIMENSION(:,:) :: var 
      INTEGER, INTENT(IN) :: kgen_unit 
      CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
      LOGICAL :: kgen_istrue 
      ...
      IF (kgen_istrue) THEN 
          ...
          READ (UNIT = kgen_unit) var 
          CALL kgen_array_sumcheck("depvel", kgen_array_sum, REAL(SUM(var, mask=(var .eq. var)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
              WRITE (*, *) "** KGEN DEBUG: REAL(SUM(" // printvar // "), 8) **", REAL(SUM(var), 8) 
          END IF   
      END IF   
  ...
  RECURSIVE SUBROUTINE kv_camsrfexch_cam_in_t(varname, check_status, var, kgenref_var) 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%asdir) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_asdir > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%asdif) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_asdif > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%aldir) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_aldir > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%aldif) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_aldif > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%lwup) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_lwup > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%lhf) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_lhf > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%shf) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_shf > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%wsx) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_wsx > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%wsy) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_wsy > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%tref) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_tref > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%qref) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_qref > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%u10) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_u10 > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%ts) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_ts > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%sst) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_sst > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%snowhland) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_snowhland > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%snowhice) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_snowhice > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE IF (check_result == CHECK_OUT_TOL) THEN 
          IF (check_status%verboseLevel > 2) THEN 
              WRITE (*, *) count( var%snowhice /= kgenref_var%snowhice), " of ", size( var%snowhice ), " elements are different." 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%fco2_lnd) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_fco2_lnd > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE IF (check_result == CHECK_OUT_TOL) THEN 
          IF (check_status%verboseLevel > 2) THEN 
              WRITE (*, *) count( var%fco2_lnd /= kgenref_var%fco2_lnd), " of ", size( var%fco2_lnd ), " elements are different." 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%fco2_ocn) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_fco2_ocn > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE IF (check_result == CHECK_OUT_TOL) THEN 
          IF (check_status%verboseLevel > 2) THEN 
              WRITE (*, *) count( var%fco2_ocn /= kgenref_var%fco2_ocn), " of ", size( var%fco2_ocn ), " elements are different." 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%fdms) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_fdms > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%landfrac) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_landfrac > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE IF (check_result == CHECK_OUT_TOL) THEN 
          IF (check_status%verboseLevel > 2) THEN 
              WRITE (*, *) count( var%landfrac /= kgenref_var%landfrac), " of ", size( var%landfrac ), " elements are different." 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%icefrac) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_icefrac > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE IF (check_result == CHECK_OUT_TOL) THEN 
          IF (check_status%verboseLevel > 2) THEN 
              WRITE (*, *) count( var%icefrac /= kgenref_var%icefrac), " of ", size( var%icefrac ), " elements are different." 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%ocnfrac) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_ocnfrac > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE IF (check_result == CHECK_OUT_TOL) THEN 
          IF (check_status%verboseLevel > 2) THEN 
              WRITE (*, *) count( var%ocnfrac /= kgenref_var%ocnfrac), " of ", size( var%ocnfrac ), " elements are different." 
      ...
      IF (ASSOCIATED(var%ram1)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%ram1) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_ram1 > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
      ...
      IF (ASSOCIATED(var%fv)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%fv) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_fv > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
      ...
      IF (ASSOCIATED(var%soilw)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%soilw) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_soilw > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%cflx) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_cflx > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%ustar) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_ustar > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%re) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_re > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      ELSE 
          ...
          WHERE ( ABS(kgenref_var%ssq) > dtype_check_status%minvalue ) 
          ...
          IF (nrmsdiff_ssq > dtype_check_status%tolerance) THEN 
              dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
              IF (check_status%verboseLevel > 1) THEN 
      ...
      IF (ASSOCIATED(var%depvel)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%depvel) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_depvel > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
          ...
          ELSE IF (check_result == CHECK_OUT_TOL) THEN 
              IF (check_status%verboseLevel > 2) THEN 
                  WRITE (*, *) count( var%depvel /= kgenref_var%depvel), " of ", size( var%depvel ), " elements are different." 
      ...
      IF (ASSOCIATED(var%dstflx)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%dstflx) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_dstflx > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
          ...
          ELSE IF (check_result == CHECK_OUT_TOL) THEN 
              IF (check_status%verboseLevel > 2) THEN 
                  WRITE (*, *) count( var%dstflx /= kgenref_var%dstflx), " of ", size( var%dstflx ), " elements are different." 
      ...
      IF (ASSOCIATED(var%meganflx)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%meganflx) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_meganflx > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
      ...
      IF (ASSOCIATED(var%fireflx)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%fireflx) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_fireflx > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
      ...
      IF (ASSOCIATED(var%fireztop)) THEN 
          ...
          ELSE 
              ...
              WHERE ( ABS(kgenref_var%fireztop) > dtype_check_status%minvalue ) 
              ...
              IF (nrmsdiff_fireztop > dtype_check_status%tolerance) THEN 
                  dtype_check_status%numOutTol = dtype_check_status%numOutTol + 1 
                  IF (check_status%verboseLevel > 1) THEN 
