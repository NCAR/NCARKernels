...
! End Vince Larson's change
  ...
  SUBROUTINE kr_externs_in_sponge_layer_damping(kgen_unit) 
      ...
      CALL kr_sponge_layer_damping_sponge_damp_settings(thlm_sponge_damp_settings, kgen_unit) 
      CALL kr_sponge_layer_damping_sponge_damp_settings(uv_sponge_damp_settings, kgen_unit) 
      CALL kr_sponge_layer_damping_sponge_damp_settings(rtm_sponge_damp_settings, kgen_unit) 
      CALL kr_sponge_layer_damping_sponge_damp_profile(rtm_sponge_damp_profile, kgen_unit) 
      CALL kr_sponge_layer_damping_sponge_damp_profile(thlm_sponge_damp_profile, kgen_unit) 
  ...
  SUBROUTINE kr_sponge_damp_profile_real__core_rknd_dim1_ptr(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("tau_sponge_damp", kgen_array_sum, REAL(SUM(var, mask=(var .eq. var)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
