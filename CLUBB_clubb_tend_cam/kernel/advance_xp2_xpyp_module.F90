...
!Generated at : 2016-06-15 08:50:03 
!KGEN version : 0.7.0 
...
module advance_xp2_xpyp_module
  ...
  !-----------------------------------------------------------------------
    ...
    PRIVATE xp2_xpyp_lhs, xp2_xpyp_solve, xp2_xpyp_uv_rhs, xp2_xpyp_rhs, xp2_xpyp_implicit_stats, term_ta_lhs, &
    &term_ta_lhs_upwind, term_ta_rhs, term_tp, term_dp1_lhs, term_dp1_rhs, term_pr1, term_pr2 
  ...
  subroutine advance_xp2_xpyp( tau_zm, wm_zm, rtm, wprtp, thlm, &
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: w_tol_sqd, rt_tol, thl_tol, w_tol_sqd, fstderr, one, two_thirds, one_half, one_third, zero, &
      &zero_threshold 

      USE model_flags, ONLY: l_hole_fill, l_single_c2_skw 
      ...
      USE clip_explicit, ONLY: clip_covar, clip_variance, clip_sclrp2, clip_sclrprtp, clip_sclrpthlp 
      
      USE stats_type_utilities, ONLY: stat_modify 

      USE error_code, ONLY: clubb_no_error, clubb_var_out_of_range, clubb_singular_matrix 

      USE error_code, ONLY: fatal_error, clubb_at_least_debug_level 

      USE stats_variables, ONLY: stats_zm, irtp2_cl, l_stats_samp 
...
!         threshold = sclr_tol(i)*sclr_tol(i)
  ...
  subroutine xp2_xpyp_lhs( dt, l_iter, wp3_on_wp2_zt, wp3_on_wp2, &
    ...
    !-----------------------------------------------------------------------
      ...
      &l_stats_samp, irtp2_ma, irtp2_ta, irtp2_dp1, irtp2_dp2, ithlp2_ma, ithlp2_ta, ithlp2_dp1, ithlp2_dp2, irtpthlp_ma, &
      &irtpthlp_ta, irtpthlp_dp1, irtpthlp_dp2, iup2_ma, iup2_ta, iup2_dp2, ivp2_ma, ivp2_ta, ivp2_dp2 
...
!        band_solve
  ...
  subroutine xp2_xpyp_uv_rhs( solve_type, dt, l_iter, a1, a1_zt, wp2, &
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: ivp2_ta, ivp2_tp, ivp2_dp1, ivp2_pr1, ivp2_pr2, iup2_ta, iup2_tp, iup2_dp1, iup2_pr1, iup2_pr2, &
      &stats_zm, zmscr01, zmscr11, l_stats_samp 
  ...
  !-----------------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: one_third, zero 
  ...
  result( rhs )
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: one, one_third 
