...
!===============================================================================
  PUBLIC kw_physics_types_physics_state 
  PUBLIC kw_physics_types_physics_ptend 
contains
!===============================================================================
...
!read state subroutine for kw_physics_types_physics_state 
RECURSIVE SUBROUTINE kw_physics_types_physics_state(var, kgen_unit, printvar) 
    TYPE(physics_state), INTENT(IN) :: var 
    ...
    END IF   
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%ngrdcol 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%ngrdcol **" // NEW_LINE("A"), var%ngrdcol 
    END IF   
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%psetcols 
    IF (PRESENT( printvar )) THEN 
    ...
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%lat, kgen_unit, printvar // "%lat") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%lat, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%lon, kgen_unit, printvar // "%lon") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%lon, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%ps, kgen_unit, printvar // "%ps") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%ps, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%psdry, kgen_unit, printvar // "%psdry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%psdry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%phis, kgen_unit, printvar // "%phis") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%phis, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%ulat, kgen_unit, printvar // "%ulat") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%ulat, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%ulon, kgen_unit, printvar // "%ulon") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%ulon, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%t, kgen_unit, printvar // "%t") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%t, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%u, kgen_unit, printvar // "%u") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%u, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%v, kgen_unit, printvar // "%v") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%v, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%s, kgen_unit, printvar // "%s") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%s, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%omega, kgen_unit, printvar // "%omega") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%omega, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%pmid, kgen_unit, printvar // "%pmid") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%pmid, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%pmiddry, kgen_unit, printvar // "%pmiddry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%pmiddry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%pdel, kgen_unit, printvar // "%pdel") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%pdel, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%pdeldry, kgen_unit, printvar // "%pdeldry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%pdeldry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%rpdel, kgen_unit, printvar // "%rpdel") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%rpdel, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%rpdeldry, kgen_unit, printvar // "%rpdeldry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%rpdeldry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%lnpmid, kgen_unit, printvar // "%lnpmid") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%lnpmid, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%lnpmiddry, kgen_unit, printvar // "%lnpmiddry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%lnpmiddry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%exner, kgen_unit, printvar // "%exner") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%exner, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%zm, kgen_unit, printvar // "%zm") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%zm, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim3(var%q, kgen_unit, printvar // "%q") 
    ELSE 
        CALL kw_physics_state_real__r8_dim3(var%q, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%pint, kgen_unit, printvar // "%pint") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%pint, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%pintdry, kgen_unit, printvar // "%pintdry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%pintdry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%lnpint, kgen_unit, printvar // "%lnpint") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%lnpint, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%lnpintdry, kgen_unit, printvar // "%lnpintdry") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%lnpintdry, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim2(var%zi, kgen_unit, printvar // "%zi") 
    ELSE 
        CALL kw_physics_state_real__r8_dim2(var%zi, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%te_ini, kgen_unit, printvar // "%te_ini") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%te_ini, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%te_cur, kgen_unit, printvar // "%te_cur") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%te_cur, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%tw_ini, kgen_unit, printvar // "%tw_ini") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%tw_ini, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_real__r8_dim1(var%tw_cur, kgen_unit, printvar // "%tw_cur") 
    ELSE 
        CALL kw_physics_state_real__r8_dim1(var%tw_cur, kgen_unit) 
    END IF   
      
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%count 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%count **" // NEW_LINE("A"), var%count 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_integer___dim1(var%latmapback, kgen_unit, printvar // "%latmapback") 
    ELSE 
        CALL kw_physics_state_integer___dim1(var%latmapback, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_integer___dim1(var%lonmapback, kgen_unit, printvar // "%lonmapback") 
    ELSE 
        CALL kw_physics_state_integer___dim1(var%lonmapback, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_state_integer___dim1(var%cid, kgen_unit, printvar // "%cid") 
    ELSE 
        CALL kw_physics_state_integer___dim1(var%cid, kgen_unit) 
    END IF   
      
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%ulatcnt 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%ulatcnt **" // NEW_LINE("A"), var%ulatcnt 
    END IF   
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%uloncnt 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%uloncnt **" // NEW_LINE("A"), var%uloncnt 
    END IF   
      
END SUBROUTINE kw_physics_types_physics_state 
  
!write state subroutine for kw_physics_state_real__r8_dim1 
SUBROUTINE kw_physics_state_real__r8_dim1(var, kgen_unit, printvar) 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_state_real__r8_dim1 
  
!write state subroutine for kw_physics_state_real__r8_dim2 
SUBROUTINE kw_physics_state_real__r8_dim2(var, kgen_unit, printvar) 
    REAL(KIND=r8), INTENT(IN), ALLOCATABLE, DIMENSION(:,:) :: var 
    INTEGER, INTENT(IN) :: kgen_unit 
    CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
    LOGICAL :: kgen_istrue 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_state_real__r8_dim2 
  
!write state subroutine for kw_physics_state_real__r8_dim3 
SUBROUTINE kw_physics_state_real__r8_dim3(var, kgen_unit, printvar) 
    REAL(KIND=r8), INTENT(IN), ALLOCATABLE, DIMENSION(:,:,:) :: var 
    INTEGER, INTENT(IN) :: kgen_unit 
    CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
    LOGICAL :: kgen_istrue 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_state_real__r8_dim3 
  
!write state subroutine for kw_physics_state_integer___dim1 
SUBROUTINE kw_physics_state_integer___dim1(var, kgen_unit, printvar) 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_state_integer___dim1 
  
!read state subroutine for kw_physics_types_physics_ptend 
RECURSIVE SUBROUTINE kw_physics_types_physics_ptend(var, kgen_unit, printvar) 
    TYPE(physics_ptend), INTENT(IN) :: var 
    INTEGER, INTENT(IN) :: kgen_unit 
    CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
    LOGICAL :: kgen_istrue 
    REAL(KIND=8) :: kgen_array_sum 
    ...
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%ls 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%ls **" // NEW_LINE("A"), var%ls 
    END IF   
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%lu 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%lu **" // NEW_LINE("A"), var%lu 
    END IF   
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%lv 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%lv **" // NEW_LINE("A"), var%lv 
    END IF   
      
    IF (SIZE(var%lq)==1) THEN 
        IF (UBOUND(var%lq, 1)<LBOUND(var%lq, 1)) THEN 
            kgen_istrue = .FALSE. 
        ELSE IF (UBOUND(var%lq, 1)==0 .AND. LBOUND(var%lq, 1)==0) THEN 
            kgen_istrue = .FALSE. 
        ELSE 
            kgen_istrue = .TRUE. 
        END IF   
    ELSE IF (SIZE(var%lq)==0) THEN 
        kgen_istrue = .FALSE. 
    ELSE 
        kgen_istrue = .TRUE. 
    END IF   
    ...
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%top_level 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%top_level **" // NEW_LINE("A"), var%top_level 
    END IF   
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) var%bot_level 
    IF (PRESENT( printvar )) THEN 
        WRITE (*, *) "** KGEN DEBUG: " // printvar // "%bot_level **" // NEW_LINE("A"), var%bot_level 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim2(var%s, kgen_unit, printvar // "%s") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim2(var%s, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim2(var%u, kgen_unit, printvar // "%u") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim2(var%u, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim2(var%v, kgen_unit, printvar // "%v") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim2(var%v, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim3(var%q, kgen_unit, printvar // "%q") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim3(var%q, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim1(var%hflux_srf, kgen_unit, printvar // "%hflux_srf") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim1(var%hflux_srf, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim1(var%hflux_top, kgen_unit, printvar // "%hflux_top") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim1(var%hflux_top, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim1(var%taux_srf, kgen_unit, printvar // "%taux_srf") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim1(var%taux_srf, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim1(var%taux_top, kgen_unit, printvar // "%taux_top") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim1(var%taux_top, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim1(var%tauy_srf, kgen_unit, printvar // "%tauy_srf") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim1(var%tauy_srf, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim1(var%tauy_top, kgen_unit, printvar // "%tauy_top") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim1(var%tauy_top, kgen_unit) 
    END IF   
      
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim2(var%cflx_srf, kgen_unit, printvar // "%cflx_srf") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim2(var%cflx_srf, kgen_unit) 
    END IF   
    IF (PRESENT( printvar )) THEN 
        CALL kw_physics_ptend_real__r8_dim2(var%cflx_top, kgen_unit, printvar // "%cflx_top") 
    ELSE 
        CALL kw_physics_ptend_real__r8_dim2(var%cflx_top, kgen_unit) 
    END IF   
      
END SUBROUTINE kw_physics_types_physics_ptend 
  
!write state subroutine for kw_physics_ptend_real__r8_dim2 
SUBROUTINE kw_physics_ptend_real__r8_dim2(var, kgen_unit, printvar) 
    REAL(KIND=r8), INTENT(IN), ALLOCATABLE, DIMENSION(:,:) :: var 
    INTEGER, INTENT(IN) :: kgen_unit 
    CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
    LOGICAL :: kgen_istrue 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_ptend_real__r8_dim2 
  
!write state subroutine for kw_physics_ptend_real__r8_dim3 
SUBROUTINE kw_physics_ptend_real__r8_dim3(var, kgen_unit, printvar) 
    REAL(KIND=r8), INTENT(IN), ALLOCATABLE, DIMENSION(:,:,:) :: var 
    INTEGER, INTENT(IN) :: kgen_unit 
    CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
    LOGICAL :: kgen_istrue 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_ptend_real__r8_dim3 
  
!write state subroutine for kw_physics_ptend_real__r8_dim1 
SUBROUTINE kw_physics_ptend_real__r8_dim1(var, kgen_unit, printvar) 
    REAL(KIND=r8), INTENT(IN), ALLOCATABLE, DIMENSION(:) :: var 
    INTEGER, INTENT(IN) :: kgen_unit 
    CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
    LOGICAL :: kgen_istrue 
    ...
    IF (kgen_istrue) THEN 
        ...
        END IF   
    END IF   
END SUBROUTINE kw_physics_ptend_real__r8_dim1 
