...
!  define physics buffer indicies here       
  ...
  PUBLIC kw_externs_in_clubb_intr 
  PUBLIC kw_externs_out_clubb_intr 
  contains
...
!-------------------------------------------------------------------------------
   ...
   USE physics_types, ONLY: kw_physics_types_physics_state 
   USE physics_types, ONLY: kw_physics_types_physics_ptend 
   USE camsrfexch, ONLY: kw_camsrfexch_cam_in_t 
   USE pdf_parameter_module, ONLY: kw_pdf_parameter_module_pdf_parameter 
   USE physconst, ONLY: kw_externs_in_physconst 
   USE scammod, ONLY: kw_externs_in_scammod 
   USE stats_variables, ONLY: kw_externs_in_stats_variables 
   USE stats_variables, ONLY: kw_externs_out_stats_variables 
   USE parameters_tunable, ONLY: kw_externs_in_parameters_tunable 
   USE parameters_tunable, ONLY: kw_externs_out_parameters_tunable 
   USE grid_class, ONLY: kw_externs_in_grid_class 
   USE grid_class, ONLY: kw_externs_out_grid_class 
   USE error_code, ONLY: kw_externs_in_error_code 
   USE error_code, ONLY: kw_externs_out_error_code 
   USE model_flags, ONLY: kw_externs_in_model_flags 
   USE parameters_model, ONLY: kw_externs_in_parameters_model 
   USE stat_file_module, ONLY: kw_externs_in_stat_file_module 
   USE variables_diagnostic_module, ONLY: kw_externs_in_variables_diagnostic_module 
   USE variables_diagnostic_module, ONLY: kw_externs_out_variables_diagnostic_module 
   USE saturation, ONLY: kw_externs_in_saturation 
   USE saturation, ONLY: kw_externs_out_saturation 
   USE array_index, ONLY: kw_externs_in_array_index 
   USE sponge_layer_damping, ONLY: kw_externs_in_sponge_layer_damping 
   USE sponge_layer_damping, ONLY: kw_externs_out_sponge_layer_damping 
   USE shr_log_mod, ONLY: kw_externs_in_shr_log_mod 
   implicit none
   ...
   INTEGER, SAVE :: kgen_mymid, kgen_msize, kgen_osize, kgen_unit, kgen_stopunit, kgen_ierr 
   ...
   real(r8) :: rho(pcols,pverp)                 ! Midpoint density in 1                       [kg/m^3]
...
!$kgen begin_callsite clubb
   ...
   !$OMP CRITICAL (kgen_init) 
   IF (.NOT. ALLOCATED(kgen_isstop)) THEN 
       kgen_osize = OMP_GET_NUM_THREADS() 
       ...
       kgen_invoke(:) = 0 
       kgen_last_invoke(:) = 0 
       CALL mpi_comm_rank(mpicom, kgen_mymid, kgen_ierr) 
       CALL kgen_error_stop(kgen_ierr, "mpi_comm_rank is failed") 
       CALL mpi_comm_size(mpicom, kgen_msize, kgen_ierr) 
       ...
       kgen_isstop(:,:) = .TRUE. 
       CALL kgen_init_vars(INT(100), INT(100), INT(0), INT(1), INT(10), kgen_msize, kgen_osize, kgen_lockpath, kgen_last_invoke, &
       &kgen_isstop) 
       CALL kgen_init_vars(INT(100), INT(100), INT(0), INT(1), INT(50), kgen_msize, kgen_osize, kgen_lockpath, kgen_last_invoke, &
       &kgen_isstop) 
       CALL kgen_init_vars(INT(300), INT(300), INT(0), INT(1), INT(10), kgen_msize, kgen_osize, kgen_lockpath, kgen_last_invoke, &
       &kgen_isstop) 
       CALL kgen_init_vars(INT(300), INT(300), INT(0), INT(1), INT(50), kgen_msize, kgen_osize, kgen_lockpath, kgen_last_invoke, &
       &kgen_isstop) 
       CALL kgen_init_vars(INT(500), INT(500), INT(0), INT(1), INT(10), kgen_msize, kgen_osize, kgen_lockpath, kgen_last_invoke, &
       &kgen_isstop) 
       CALL kgen_init_vars(INT(500), INT(500), INT(0), INT(1), INT(50), kgen_msize, kgen_osize, kgen_lockpath, kgen_last_invoke, &
       &kgen_isstop) 
   END IF   
   !$OMP END CRITICAL (kgen_init) 
   kgen_issave(OMP_GET_THREAD_NUM()) = .FALSE. 
   CALL kgen_check_save(INT(100), INT(100), INT(0), INT(1), INT(10), INT(10), kgen_mymid, OMP_GET_THREAD_NUM(), kgen_osize, &
   &kgen_invoke, kgen_last_invoke, kgen_issave, kgen_islast) 
   CALL kgen_check_save(INT(100), INT(100), INT(0), INT(1), INT(50), INT(50), kgen_mymid, OMP_GET_THREAD_NUM(), kgen_osize, &
   &kgen_invoke, kgen_last_invoke, kgen_issave, kgen_islast) 
   CALL kgen_check_save(INT(300), INT(300), INT(0), INT(1), INT(10), INT(10), kgen_mymid, OMP_GET_THREAD_NUM(), kgen_osize, &
   &kgen_invoke, kgen_last_invoke, kgen_issave, kgen_islast) 
   CALL kgen_check_save(INT(300), INT(300), INT(0), INT(1), INT(50), INT(50), kgen_mymid, OMP_GET_THREAD_NUM(), kgen_osize, &
   &kgen_invoke, kgen_last_invoke, kgen_issave, kgen_islast) 
   CALL kgen_check_save(INT(500), INT(500), INT(0), INT(1), INT(10), INT(10), kgen_mymid, OMP_GET_THREAD_NUM(), kgen_osize, &
   &kgen_invoke, kgen_last_invoke, kgen_issave, kgen_islast) 
   CALL kgen_check_save(INT(500), INT(500), INT(0), INT(1), INT(50), INT(50), kgen_mymid, OMP_GET_THREAD_NUM(), kgen_osize, &
   &kgen_invoke, kgen_last_invoke, kgen_issave, kgen_islast) 
   !$OMP CRITICAL (kgen_kernel) 
   IF (kgen_issave(OMP_GET_THREAD_NUM())) THEN 
       WRITE (kgen_filepath(kgen_mymid, OMP_GET_THREAD_NUM()), FMT="(A,I0,A,I0,A,I0)") &
       &"/glade/scratch/youngsun/kgensystest/kapp_sys_ys_cesm_intel_clubb_tend_cam_Test/kernel/clubb.", kgen_mymid, ".", &
       &OMP_GET_THREAD_NUM(), ".", kgen_invoke(OMP_GET_THREAD_NUM()) 
       OPEN (NEWUNIT=kgen_unit, FILE=TRIM(ADJUSTL(kgen_filepath(kgen_mymid, OMP_GET_THREAD_NUM()))), STATUS="REPLACE", &
       &ACCESS="STREAM", FORM="UNFORMATTED", ACTION="WRITE", CONVERT="BIG_ENDIAN", IOSTAT=kgen_ierr) 
       CALL kgen_error_stop(kgen_ierr, "File open error: " // TRIM(ADJUSTL(kgen_filepath(kgen_mymid, OMP_GET_THREAD_NUM())))) 
         
       !argument input variables 
       CALL kw_camsrfexch_cam_in_t(cam_in, kgen_unit) 
       WRITE (UNIT = kgen_unit) hdtime 
       WRITE (UNIT = kgen_unit) cld_macmic_num_steps 
       WRITE (UNIT = kgen_unit) macmic_it 
         
       !extern input variables 
       CALL kw_externs_in_clubb_intr(kgen_unit) 
       CALL kw_externs_in_physconst(kgen_unit) 
       CALL kw_externs_in_scammod(kgen_unit) 
       CALL kw_externs_in_stats_variables(kgen_unit) 
       CALL kw_externs_in_parameters_tunable(kgen_unit) 
       CALL kw_externs_in_grid_class(kgen_unit) 
       CALL kw_externs_in_error_code(kgen_unit) 
       CALL kw_externs_in_model_flags(kgen_unit) 
       CALL kw_externs_in_parameters_model(kgen_unit) 
       CALL kw_externs_in_stat_file_module(kgen_unit) 
       CALL kw_externs_in_variables_diagnostic_module(kgen_unit) 
       CALL kw_externs_in_saturation(kgen_unit) 
       CALL kw_externs_in_array_index(kgen_unit) 
       CALL kw_externs_in_sponge_layer_damping(kgen_unit) 
       CALL kw_externs_in_shr_log_mod(kgen_unit) 
         
       !local input variables 
       CALL kw_physics_types_physics_state(state1, kgen_unit) 
       CALL kw_physics_types_physics_ptend(ptend_loc, kgen_unit) 
       WRITE (UNIT = kgen_unit) k 
       WRITE (UNIT = kgen_unit) i 
       WRITE (UNIT = kgen_unit) ixind 
       WRITE (UNIT = kgen_unit) nadv 
       WRITE (UNIT = kgen_unit) t 
       WRITE (UNIT = kgen_unit) ixcldice 
       WRITE (UNIT = kgen_unit) ixq 
       WRITE (UNIT = kgen_unit) ixcldliq 
       WRITE (UNIT = kgen_unit) ncol 
       WRITE (UNIT = kgen_unit) lchnk 
       WRITE (UNIT = kgen_unit) err_code 
       WRITE (UNIT = kgen_unit) begin_height 
       WRITE (UNIT = kgen_unit) end_height 
       WRITE (UNIT = kgen_unit) icnt 
       WRITE (UNIT = kgen_unit) dtime 
       IF (SIZE(edsclr_in)==1) THEN 
           IF (UBOUND(edsclr_in, 1)<LBOUND(edsclr_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(edsclr_in, 1)==0 .AND. LBOUND(edsclr_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(edsclr_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       ...
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(edsclr_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) edsclr_in 
       END IF   
       IF (SIZE(wp2_in)==1) THEN 
           IF (UBOUND(wp2_in, 1)<LBOUND(wp2_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wp2_in, 1)==0 .AND. LBOUND(wp2_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wp2_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wp2_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wp2_in 
       END IF   
       IF (SIZE(wp3_in)==1) THEN 
           IF (UBOUND(wp3_in, 1)<LBOUND(wp3_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wp3_in, 1)==0 .AND. LBOUND(wp3_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wp3_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wp3_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wp3_in 
       END IF   
       IF (SIZE(wpthlp_in)==1) THEN 
           IF (UBOUND(wpthlp_in, 1)<LBOUND(wpthlp_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wpthlp_in, 1)==0 .AND. LBOUND(wpthlp_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wpthlp_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wpthlp_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wpthlp_in 
       END IF   
       IF (SIZE(wprtp_in)==1) THEN 
           IF (UBOUND(wprtp_in, 1)<LBOUND(wprtp_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wprtp_in, 1)==0 .AND. LBOUND(wprtp_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wprtp_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wprtp_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wprtp_in 
       END IF   
       IF (SIZE(rtpthlp_in)==1) THEN 
           IF (UBOUND(rtpthlp_in, 1)<LBOUND(rtpthlp_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtpthlp_in, 1)==0 .AND. LBOUND(rtpthlp_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtpthlp_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtpthlp_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtpthlp_in 
       END IF   
       IF (SIZE(rtp2_in)==1) THEN 
           IF (UBOUND(rtp2_in, 1)<LBOUND(rtp2_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtp2_in, 1)==0 .AND. LBOUND(rtp2_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtp2_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtp2_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtp2_in 
       END IF   
       IF (SIZE(thlp2_in)==1) THEN 
           IF (UBOUND(thlp2_in, 1)<LBOUND(thlp2_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlp2_in, 1)==0 .AND. LBOUND(thlp2_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlp2_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlp2_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlp2_in 
       END IF   
       IF (SIZE(up2_in)==1) THEN 
           IF (UBOUND(up2_in, 1)<LBOUND(up2_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(up2_in, 1)==0 .AND. LBOUND(up2_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(up2_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(up2_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) up2_in 
       END IF   
       IF (SIZE(vp2_in)==1) THEN 
           IF (UBOUND(vp2_in, 1)<LBOUND(vp2_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(vp2_in, 1)==0 .AND. LBOUND(vp2_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(vp2_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(vp2_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) vp2_in 
       END IF   
       IF (SIZE(upwp_in)==1) THEN 
           IF (UBOUND(upwp_in, 1)<LBOUND(upwp_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(upwp_in, 1)==0 .AND. LBOUND(upwp_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(upwp_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(upwp_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) upwp_in 
       END IF   
       IF (SIZE(vpwp_in)==1) THEN 
           IF (UBOUND(vpwp_in, 1)<LBOUND(vpwp_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(vpwp_in, 1)==0 .AND. LBOUND(vpwp_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(vpwp_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(vpwp_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) vpwp_in 
       END IF   
       IF (SIZE(thlm_in)==1) THEN 
           IF (UBOUND(thlm_in, 1)<LBOUND(thlm_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlm_in, 1)==0 .AND. LBOUND(thlm_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlm_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlm_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlm_in 
       END IF   
       IF (SIZE(rtm_in)==1) THEN 
           IF (UBOUND(rtm_in, 1)<LBOUND(rtm_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtm_in, 1)==0 .AND. LBOUND(rtm_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtm_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtm_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtm_in 
       END IF   
       IF (SIZE(rvm_in)==1) THEN 
           IF (UBOUND(rvm_in, 1)<LBOUND(rvm_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rvm_in, 1)==0 .AND. LBOUND(rvm_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rvm_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rvm_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rvm_in 
       END IF   
       IF (SIZE(um_in)==1) THEN 
           IF (UBOUND(um_in, 1)<LBOUND(um_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(um_in, 1)==0 .AND. LBOUND(um_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(um_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(um_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) um_in 
       END IF   
       IF (SIZE(vm_in)==1) THEN 
           IF (UBOUND(vm_in, 1)<LBOUND(vm_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(vm_in, 1)==0 .AND. LBOUND(vm_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(vm_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(vm_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) vm_in 
       END IF   
       IF (SIZE(rho_in)==1) THEN 
           IF (UBOUND(rho_in, 1)<LBOUND(rho_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rho_in, 1)==0 .AND. LBOUND(rho_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rho_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rho_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rho_in 
       END IF   
       IF (SIZE(pre_in)==1) THEN 
           IF (UBOUND(pre_in, 1)<LBOUND(pre_in, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(pre_in, 1)==0 .AND. LBOUND(pre_in, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(pre_in)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(pre_in), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) pre_in 
       END IF   
       IF (SIZE(rtp2_mc_out)==1) THEN 
           IF (UBOUND(rtp2_mc_out, 1)<LBOUND(rtp2_mc_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtp2_mc_out, 1)==0 .AND. LBOUND(rtp2_mc_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtp2_mc_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtp2_mc_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtp2_mc_out 
       END IF   
       IF (SIZE(thlp2_mc_out)==1) THEN 
           IF (UBOUND(thlp2_mc_out, 1)<LBOUND(thlp2_mc_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlp2_mc_out, 1)==0 .AND. LBOUND(thlp2_mc_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlp2_mc_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlp2_mc_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlp2_mc_out 
       END IF   
       IF (SIZE(wprtp_mc_out)==1) THEN 
           IF (UBOUND(wprtp_mc_out, 1)<LBOUND(wprtp_mc_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wprtp_mc_out, 1)==0 .AND. LBOUND(wprtp_mc_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wprtp_mc_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wprtp_mc_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wprtp_mc_out 
       END IF   
       IF (SIZE(wpthlp_mc_out)==1) THEN 
           IF (UBOUND(wpthlp_mc_out, 1)<LBOUND(wpthlp_mc_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wpthlp_mc_out, 1)==0 .AND. LBOUND(wpthlp_mc_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wpthlp_mc_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wpthlp_mc_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wpthlp_mc_out 
       END IF   
       IF (SIZE(rtpthlp_mc_out)==1) THEN 
           IF (UBOUND(rtpthlp_mc_out, 1)<LBOUND(rtpthlp_mc_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtpthlp_mc_out, 1)==0 .AND. LBOUND(rtpthlp_mc_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtpthlp_mc_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtpthlp_mc_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtpthlp_mc_out 
       END IF   
       IF (SIZE(rcm_out)==1) THEN 
           IF (UBOUND(rcm_out, 1)<LBOUND(rcm_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rcm_out, 1)==0 .AND. LBOUND(rcm_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rcm_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rcm_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rcm_out 
       END IF   
       IF (SIZE(rcm_out_zm)==1) THEN 
           IF (UBOUND(rcm_out_zm, 1)<LBOUND(rcm_out_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rcm_out_zm, 1)==0 .AND. LBOUND(rcm_out_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rcm_out_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rcm_out_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rcm_out_zm 
       END IF   
       IF (SIZE(wprcp_out)==1) THEN 
           IF (UBOUND(wprcp_out, 1)<LBOUND(wprcp_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wprcp_out, 1)==0 .AND. LBOUND(wprcp_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wprcp_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wprcp_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wprcp_out 
       END IF   
       IF (SIZE(cloud_frac_out)==1) THEN 
           IF (UBOUND(cloud_frac_out, 1)<LBOUND(cloud_frac_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(cloud_frac_out, 1)==0 .AND. LBOUND(cloud_frac_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(cloud_frac_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(cloud_frac_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) cloud_frac_out 
       END IF   
       IF (SIZE(rcm_in_layer_out)==1) THEN 
           IF (UBOUND(rcm_in_layer_out, 1)<LBOUND(rcm_in_layer_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rcm_in_layer_out, 1)==0 .AND. LBOUND(rcm_in_layer_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rcm_in_layer_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rcm_in_layer_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rcm_in_layer_out 
       END IF   
       IF (SIZE(cloud_cover_out)==1) THEN 
           IF (UBOUND(cloud_cover_out, 1)<LBOUND(cloud_cover_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(cloud_cover_out, 1)==0 .AND. LBOUND(cloud_cover_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(cloud_cover_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(cloud_cover_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) cloud_cover_out 
       END IF   
       IF (SIZE(thlprcp_out)==1) THEN 
           IF (UBOUND(thlprcp_out, 1)<LBOUND(thlprcp_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlprcp_out, 1)==0 .AND. LBOUND(thlprcp_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlprcp_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlprcp_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlprcp_out 
       END IF   
       IF (SIZE(rho_ds_zm)==1) THEN 
           IF (UBOUND(rho_ds_zm, 1)<LBOUND(rho_ds_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rho_ds_zm, 1)==0 .AND. LBOUND(rho_ds_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rho_ds_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rho_ds_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rho_ds_zm 
       END IF   
       IF (SIZE(rho_ds_zt)==1) THEN 
           IF (UBOUND(rho_ds_zt, 1)<LBOUND(rho_ds_zt, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rho_ds_zt, 1)==0 .AND. LBOUND(rho_ds_zt, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rho_ds_zt)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rho_ds_zt), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rho_ds_zt 
       END IF   
       IF (SIZE(invrs_rho_ds_zm)==1) THEN 
           IF (UBOUND(invrs_rho_ds_zm, 1)<LBOUND(invrs_rho_ds_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(invrs_rho_ds_zm, 1)==0 .AND. LBOUND(invrs_rho_ds_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(invrs_rho_ds_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(invrs_rho_ds_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) invrs_rho_ds_zm 
       END IF   
       IF (SIZE(invrs_rho_ds_zt)==1) THEN 
           IF (UBOUND(invrs_rho_ds_zt, 1)<LBOUND(invrs_rho_ds_zt, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(invrs_rho_ds_zt, 1)==0 .AND. LBOUND(invrs_rho_ds_zt, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(invrs_rho_ds_zt)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(invrs_rho_ds_zt), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) invrs_rho_ds_zt 
       END IF   
       IF (SIZE(thv_ds_zm)==1) THEN 
           IF (UBOUND(thv_ds_zm, 1)<LBOUND(thv_ds_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thv_ds_zm, 1)==0 .AND. LBOUND(thv_ds_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thv_ds_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thv_ds_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thv_ds_zm 
       END IF   
       IF (SIZE(thv_ds_zt)==1) THEN 
           IF (UBOUND(thv_ds_zt, 1)<LBOUND(thv_ds_zt, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thv_ds_zt, 1)==0 .AND. LBOUND(thv_ds_zt, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thv_ds_zt)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thv_ds_zt), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thv_ds_zt 
       END IF   
       IF (SIZE(rfrzm)==1) THEN 
           IF (UBOUND(rfrzm, 1)<LBOUND(rfrzm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rfrzm, 1)==0 .AND. LBOUND(rfrzm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rfrzm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rfrzm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rfrzm 
       END IF   
       IF (SIZE(radf)==1) THEN 
           IF (UBOUND(radf, 1)<LBOUND(radf, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(radf, 1)==0 .AND. LBOUND(radf, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(radf)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(radf), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) radf 
       END IF   
       IF (SIZE(wprtp_forcing)==1) THEN 
           IF (UBOUND(wprtp_forcing, 1)<LBOUND(wprtp_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wprtp_forcing, 1)==0 .AND. LBOUND(wprtp_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wprtp_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wprtp_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wprtp_forcing 
       END IF   
       IF (SIZE(wpthlp_forcing)==1) THEN 
           IF (UBOUND(wpthlp_forcing, 1)<LBOUND(wpthlp_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wpthlp_forcing, 1)==0 .AND. LBOUND(wpthlp_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wpthlp_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wpthlp_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wpthlp_forcing 
       END IF   
       IF (SIZE(rtp2_forcing)==1) THEN 
           IF (UBOUND(rtp2_forcing, 1)<LBOUND(rtp2_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtp2_forcing, 1)==0 .AND. LBOUND(rtp2_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtp2_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtp2_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtp2_forcing 
       END IF   
       IF (SIZE(thlp2_forcing)==1) THEN 
           IF (UBOUND(thlp2_forcing, 1)<LBOUND(thlp2_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlp2_forcing, 1)==0 .AND. LBOUND(thlp2_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlp2_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlp2_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlp2_forcing 
       END IF   
       IF (SIZE(rtpthlp_forcing)==1) THEN 
           IF (UBOUND(rtpthlp_forcing, 1)<LBOUND(rtpthlp_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtpthlp_forcing, 1)==0 .AND. LBOUND(rtpthlp_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtpthlp_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtpthlp_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtpthlp_forcing 
       END IF   
       IF (SIZE(ice_supersat_frac)==1) THEN 
           IF (UBOUND(ice_supersat_frac, 1)<LBOUND(ice_supersat_frac, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(ice_supersat_frac, 1)==0 .AND. LBOUND(ice_supersat_frac, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(ice_supersat_frac)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(ice_supersat_frac), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) ice_supersat_frac 
       END IF   
       IF (SIZE(zt_g)==1) THEN 
           IF (UBOUND(zt_g, 1)<LBOUND(zt_g, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(zt_g, 1)==0 .AND. LBOUND(zt_g, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(zt_g)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(zt_g), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) zt_g 
       END IF   
       IF (SIZE(zi_g)==1) THEN 
           IF (UBOUND(zi_g, 1)<LBOUND(zi_g, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(zi_g, 1)==0 .AND. LBOUND(zi_g, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(zi_g)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(zi_g), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) zi_g 
       END IF   
       IF (SIZE(zt_out)==1) THEN 
           IF (UBOUND(zt_out, 1)<LBOUND(zt_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(zt_out, 1)==0 .AND. LBOUND(zt_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(zt_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(zt_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) zt_out 
       END IF   
       IF (SIZE(zi_out)==1) THEN 
           IF (UBOUND(zi_out, 1)<LBOUND(zi_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(zi_out, 1)==0 .AND. LBOUND(zi_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(zi_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(zi_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) zi_out 
       END IF   
       WRITE (UNIT = kgen_unit) fcor 
       WRITE (UNIT = kgen_unit) sfc_elevation 
       WRITE (UNIT = kgen_unit) ubar 
       WRITE (UNIT = kgen_unit) ustar 
       IF (SIZE(thlm_forcing)==1) THEN 
           IF (UBOUND(thlm_forcing, 1)<LBOUND(thlm_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlm_forcing, 1)==0 .AND. LBOUND(thlm_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlm_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlm_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlm_forcing 
       END IF   
       IF (SIZE(rtm_forcing)==1) THEN 
           IF (UBOUND(rtm_forcing, 1)<LBOUND(rtm_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rtm_forcing, 1)==0 .AND. LBOUND(rtm_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rtm_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rtm_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rtm_forcing 
       END IF   
       IF (SIZE(um_forcing)==1) THEN 
           IF (UBOUND(um_forcing, 1)<LBOUND(um_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(um_forcing, 1)==0 .AND. LBOUND(um_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(um_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(um_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) um_forcing 
       END IF   
       IF (SIZE(vm_forcing)==1) THEN 
           IF (UBOUND(vm_forcing, 1)<LBOUND(vm_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(vm_forcing, 1)==0 .AND. LBOUND(vm_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(vm_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(vm_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) vm_forcing 
       END IF   
       IF (SIZE(wm_zm)==1) THEN 
           IF (UBOUND(wm_zm, 1)<LBOUND(wm_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wm_zm, 1)==0 .AND. LBOUND(wm_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wm_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wm_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wm_zm 
       END IF   
       IF (SIZE(wm_zt)==1) THEN 
           IF (UBOUND(wm_zt, 1)<LBOUND(wm_zt, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wm_zt, 1)==0 .AND. LBOUND(wm_zt, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wm_zt)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wm_zt), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wm_zt 
       END IF   
       IF (SIZE(p_in_pa)==1) THEN 
           IF (UBOUND(p_in_pa, 1)<LBOUND(p_in_pa, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(p_in_pa, 1)==0 .AND. LBOUND(p_in_pa, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(p_in_pa)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(p_in_pa), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) p_in_pa 
       END IF   
       IF (SIZE(rho_zt)==1) THEN 
           IF (UBOUND(rho_zt, 1)<LBOUND(rho_zt, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rho_zt, 1)==0 .AND. LBOUND(rho_zt, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rho_zt)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rho_zt), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rho_zt 
       END IF   
       IF (SIZE(rho_zm)==1) THEN 
           IF (UBOUND(rho_zm, 1)<LBOUND(rho_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rho_zm, 1)==0 .AND. LBOUND(rho_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rho_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rho_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rho_zm 
       END IF   
       IF (SIZE(exner)==1) THEN 
           IF (UBOUND(exner, 1)<LBOUND(exner, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(exner, 1)==0 .AND. LBOUND(exner, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(exner)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(exner), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) exner 
       END IF   
       WRITE (UNIT = kgen_unit) wpthlp_sfc 
       WRITE (UNIT = kgen_unit) wprtp_sfc 
       WRITE (UNIT = kgen_unit) upwp_sfc 
       WRITE (UNIT = kgen_unit) vpwp_sfc 
       IF (SIZE(edsclrm_forcing)==1) THEN 
           IF (UBOUND(edsclrm_forcing, 1)<LBOUND(edsclrm_forcing, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(edsclrm_forcing, 1)==0 .AND. LBOUND(edsclrm_forcing, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(edsclrm_forcing)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(edsclrm_forcing), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) edsclrm_forcing 
       END IF   
       IF (SIZE(wpedsclrp_sfc)==1) THEN 
           IF (UBOUND(wpedsclrp_sfc, 1)<LBOUND(wpedsclrp_sfc, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wpedsclrp_sfc, 1)==0 .AND. LBOUND(wpedsclrp_sfc, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wpedsclrp_sfc)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wpedsclrp_sfc), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wpedsclrp_sfc 
       END IF   
       WRITE (UNIT = kgen_unit) bflx22 
       IF (SIZE(khzm_out)==1) THEN 
           IF (UBOUND(khzm_out, 1)<LBOUND(khzm_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(khzm_out, 1)==0 .AND. LBOUND(khzm_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(khzm_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(khzm_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) khzm_out 
       END IF   
       IF (SIZE(khzt_out)==1) THEN 
           IF (UBOUND(khzt_out, 1)<LBOUND(khzt_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(khzt_out, 1)==0 .AND. LBOUND(khzt_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(khzt_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(khzt_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) khzt_out 
       END IF   
       IF (SIZE(qclvar_out)==1) THEN 
           IF (UBOUND(qclvar_out, 1)<LBOUND(qclvar_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(qclvar_out, 1)==0 .AND. LBOUND(qclvar_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(qclvar_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(qclvar_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) qclvar_out 
       END IF   
       IF (SIZE(qclvar)==1) THEN 
           IF (UBOUND(qclvar, 1)<LBOUND(qclvar, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(qclvar, 1)==0 .AND. LBOUND(qclvar, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(qclvar)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(qclvar), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) qclvar 
       END IF   
       WRITE (UNIT = kgen_unit) zo 
       IF (SIZE(dz_g)==1) THEN 
           IF (UBOUND(dz_g, 1)<LBOUND(dz_g, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(dz_g, 1)==0 .AND. LBOUND(dz_g, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(dz_g)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(dz_g), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) dz_g 
       END IF   
       IF (SIZE(varmu)==1) THEN 
           IF (UBOUND(varmu, 1)<LBOUND(varmu, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(varmu, 1)==0 .AND. LBOUND(varmu, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(varmu)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(varmu), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) varmu 
       END IF   
       WRITE (UNIT = kgen_unit) varmu2 
       IF (SIZE(ke_a)==1) THEN 
           IF (UBOUND(ke_a, 1)<LBOUND(ke_a, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(ke_a, 1)==0 .AND. LBOUND(ke_a, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(ke_a)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(ke_a), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) ke_a 
       END IF   
       IF (SIZE(ke_b)==1) THEN 
           IF (UBOUND(ke_b, 1)<LBOUND(ke_b, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(ke_b, 1)==0 .AND. LBOUND(ke_b, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(ke_b)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(ke_b), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) ke_b 
       END IF   
       IF (SIZE(te_b)==1) THEN 
           IF (UBOUND(te_b, 1)<LBOUND(te_b, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(te_b, 1)==0 .AND. LBOUND(te_b, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(te_b)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(te_b), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) te_b 
       END IF   
       IF (SIZE(te_a)==1) THEN 
           IF (UBOUND(te_a, 1)<LBOUND(te_a, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(te_a, 1)==0 .AND. LBOUND(te_a, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(te_a)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(te_a), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) te_a 
       END IF   
       IF (SIZE(wv_a)==1) THEN 
           IF (UBOUND(wv_a, 1)<LBOUND(wv_a, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wv_a, 1)==0 .AND. LBOUND(wv_a, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wv_a)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wv_a), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wv_a 
       END IF   
       IF (SIZE(wl_a)==1) THEN 
           IF (UBOUND(wl_a, 1)<LBOUND(wl_a, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wl_a, 1)==0 .AND. LBOUND(wl_a, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wl_a)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wl_a), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wl_a 
       END IF   
       IF (SIZE(wv_b)==1) THEN 
           IF (UBOUND(wv_b, 1)<LBOUND(wv_b, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wv_b, 1)==0 .AND. LBOUND(wv_b, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wv_b)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wv_b), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wv_b 
       END IF   
       IF (SIZE(wl_b)==1) THEN 
           IF (UBOUND(wl_b, 1)<LBOUND(wl_b, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wl_b, 1)==0 .AND. LBOUND(wl_b, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wl_b)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wl_b), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wl_b 
       END IF   
       IF (SIZE(se_a)==1) THEN 
           IF (UBOUND(se_a, 1)<LBOUND(se_a, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(se_a, 1)==0 .AND. LBOUND(se_a, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(se_a)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(se_a), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) se_a 
       END IF   
       IF (SIZE(clubb_s)==1) THEN 
           IF (UBOUND(clubb_s, 1)<LBOUND(clubb_s, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(clubb_s, 1)==0 .AND. LBOUND(clubb_s, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(clubb_s)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(clubb_s), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) clubb_s 
       END IF   
       IF (SIZE(se_b)==1) THEN 
           IF (UBOUND(se_b, 1)<LBOUND(se_b, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(se_b, 1)==0 .AND. LBOUND(se_b, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(se_b)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(se_b), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) se_b 
       END IF   
       WRITE (UNIT = kgen_unit) se_dis 
       IF (SIZE(exner_clubb)==1) THEN 
           IF (UBOUND(exner_clubb, 1)<LBOUND(exner_clubb, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(exner_clubb, 1)==0 .AND. LBOUND(exner_clubb, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(exner_clubb)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(exner_clubb), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) exner_clubb 
       END IF   
       IF (SIZE(rho)==1) THEN 
           IF (UBOUND(rho, 1)<LBOUND(rho, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rho, 1)==0 .AND. LBOUND(rho, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rho)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rho), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rho 
       END IF   
       IF (SIZE(thv)==1) THEN 
           IF (UBOUND(thv, 1)<LBOUND(thv, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thv, 1)==0 .AND. LBOUND(thv, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thv)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thv), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thv 
       END IF   
       IF (SIZE(edsclr_out)==1) THEN 
           IF (UBOUND(edsclr_out, 1)<LBOUND(edsclr_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(edsclr_out, 1)==0 .AND. LBOUND(edsclr_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(edsclr_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(edsclr_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) edsclr_out 
       END IF   
       IF (SIZE(rcm)==1) THEN 
           IF (UBOUND(rcm, 1)<LBOUND(rcm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rcm, 1)==0 .AND. LBOUND(rcm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rcm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rcm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rcm 
       END IF   
       IF (SIZE(cloud_frac)==1) THEN 
           IF (UBOUND(cloud_frac, 1)<LBOUND(cloud_frac, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(cloud_frac, 1)==0 .AND. LBOUND(cloud_frac, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(cloud_frac)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(cloud_frac), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) cloud_frac 
       END IF   
       IF (SIZE(rcm_in_layer)==1) THEN 
           IF (UBOUND(rcm_in_layer, 1)<LBOUND(rcm_in_layer, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rcm_in_layer, 1)==0 .AND. LBOUND(rcm_in_layer, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rcm_in_layer)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rcm_in_layer), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rcm_in_layer 
       END IF   
       IF (SIZE(cloud_cover)==1) THEN 
           IF (UBOUND(cloud_cover, 1)<LBOUND(cloud_cover, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(cloud_cover, 1)==0 .AND. LBOUND(cloud_cover, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(cloud_cover)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(cloud_cover), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) cloud_cover 
       END IF   
       IF (SIZE(wprcp)==1) THEN 
           IF (UBOUND(wprcp, 1)<LBOUND(wprcp, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(wprcp, 1)==0 .AND. LBOUND(wprcp, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(wprcp)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(wprcp), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) wprcp 
       END IF   
       IF (SIZE(rvm)==1) THEN 
           IF (UBOUND(rvm, 1)<LBOUND(rvm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(rvm, 1)==0 .AND. LBOUND(rvm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(rvm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(rvm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) rvm 
       END IF   
       WRITE (UNIT = kgen_unit) dum1 
       IF (SIZE(ksrftms)==1) THEN 
           IF (UBOUND(ksrftms, 1)<LBOUND(ksrftms, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(ksrftms, 1)==0 .AND. LBOUND(ksrftms, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(ksrftms)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(ksrftms), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) ksrftms 
       END IF   
       IF (SIZE(qrl_clubb)==1) THEN 
           IF (UBOUND(qrl_clubb, 1)<LBOUND(qrl_clubb, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(qrl_clubb, 1)==0 .AND. LBOUND(qrl_clubb, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(qrl_clubb)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(qrl_clubb), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) qrl_clubb 
       END IF   
       IF (SIZE(qrl_zm)==1) THEN 
           IF (UBOUND(qrl_zm, 1)<LBOUND(qrl_zm, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(qrl_zm, 1)==0 .AND. LBOUND(qrl_zm, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(qrl_zm)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(qrl_zm), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) qrl_zm 
       END IF   
       IF (SIZE(thlp2_rad_out)==1) THEN 
           IF (UBOUND(thlp2_rad_out, 1)<LBOUND(thlp2_rad_out, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(thlp2_rad_out, 1)==0 .AND. LBOUND(thlp2_rad_out, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(thlp2_rad_out)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(thlp2_rad_out), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) thlp2_rad_out 
       END IF   
       WRITE (UNIT = kgen_unit) orgparam 
       WRITE (UNIT = kgen_unit) delpavg 
       WRITE (UNIT = kgen_unit) time_elapsed 
       IF (SIZE(clubb_params)==1) THEN 
           IF (UBOUND(clubb_params, 1)<LBOUND(clubb_params, 1)) THEN 
               kgen_istrue = .FALSE. 
           ELSE IF (UBOUND(clubb_params, 1)==0 .AND. LBOUND(clubb_params, 1)==0) THEN 
               kgen_istrue = .FALSE. 
           ELSE 
               kgen_istrue = .TRUE. 
           END IF   
       ELSE IF (SIZE(clubb_params)==0) THEN 
           kgen_istrue = .FALSE. 
       ELSE 
           kgen_istrue = .TRUE. 
       END IF   
       WRITE (UNIT = kgen_unit) kgen_istrue 
       IF (kgen_istrue) THEN 
           kgen_array_sum = REAL(SUM(clubb_params), 8) 
           WRITE (UNIT = kgen_unit) kgen_array_sum 
           WRITE (UNIT = kgen_unit) clubb_params 
       END IF   
       CALL kw_clubb_tend_cam_pdf_parameter__pdf_parameter_dim1(pdf_params, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(wp2, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(wp3, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(wpthlp, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(wprtp, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(rtpthlp, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(rtp2, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(thlp2, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(up2, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(vp2, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(upwp, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(vpwp, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(thlm, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(rtm, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(um, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(vm, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(khzt, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(khzm, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(prer_evap, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(qrl, kgen_unit) 
       CALL kw_clubb_tend_cam_real__r8_dim2_ptr(radf_clubb, kgen_unit) 
   END IF   
   do i=1,ncol   ! loop over columns
...
!                     rtpthlp_in = rtpthlp_in + rtpthlp_mc_out * dtime
   ...
   IF (kgen_issave(OMP_GET_THREAD_NUM())) THEN 
       ...
       CALL kw_externs_out_clubb_intr(kgen_unit) 
       CALL kw_externs_out_stats_variables(kgen_unit) 
       CALL kw_externs_out_parameters_tunable(kgen_unit) 
       CALL kw_externs_out_grid_class(kgen_unit) 
       CALL kw_externs_out_error_code(kgen_unit) 
       CALL kw_externs_out_variables_diagnostic_module(kgen_unit) 
       CALL kw_externs_out_saturation(kgen_unit) 
       CALL kw_externs_out_sponge_layer_damping(kgen_unit) 
       ...
       WRITE (*, *) "Collected Kernel Input/Ouput state from: ", kgen_mymid, OMP_GET_THREAD_NUM(), &
       &kgen_invoke(OMP_GET_THREAD_NUM()) 
   END IF   
   !$OMP END CRITICAL (kgen_kernel) 
   !$OMP CRITICAL (kgen_fini) 
   IF (.NOT. kgen_ischecked(OMP_GET_THREAD_NUM()) .AND. kgen_islast(OMP_GET_THREAD_NUM())) THEN 
       kgen_ischecked(OMP_GET_THREAD_NUM()) = .TRUE. 
       OPEN (NEWUNIT=kgen_stopunit, FILE=TRIM(ADJUSTL(kgen_lockpath(kgen_mymid, OMP_GET_THREAD_NUM()))), STATUS="NEW", &
       &IOSTAT=kgen_ierr) 
       IF (kgen_ierr == 0) THEN 
           CLOSE (UNIT=kgen_stopunit, STATUS="KEEP") 
       END IF   
       CALL kgen_check_stop(INT(100), INT(100), INT(0), INT(1), kgen_msize, kgen_osize, OMP_GET_THREAD_NUM(), kgen_lockpath, &
       &kgen_isstop) 
       CALL kgen_check_stop(INT(100), INT(100), INT(0), INT(1), kgen_msize, kgen_osize, OMP_GET_THREAD_NUM(), kgen_lockpath, &
       &kgen_isstop) 
       CALL kgen_check_stop(INT(300), INT(300), INT(0), INT(1), kgen_msize, kgen_osize, OMP_GET_THREAD_NUM(), kgen_lockpath, &
       &kgen_isstop) 
       CALL kgen_check_stop(INT(300), INT(300), INT(0), INT(1), kgen_msize, kgen_osize, OMP_GET_THREAD_NUM(), kgen_lockpath, &
       &kgen_isstop) 
       CALL kgen_check_stop(INT(500), INT(500), INT(0), INT(1), kgen_msize, kgen_osize, OMP_GET_THREAD_NUM(), kgen_lockpath, &
       &kgen_isstop) 
       CALL kgen_check_stop(INT(500), INT(500), INT(0), INT(1), kgen_msize, kgen_osize, OMP_GET_THREAD_NUM(), kgen_lockpath, &
       &kgen_isstop) 
       IF (ALL(kgen_isstop)) THEN 
           DO kgen_count=1,3 
               ...
               &FILE="/glade/scratch/youngsun/kgensystest/kapp_sys_ys_cesm_intel_clubb_tend_cam_Test/kernel/kgen_statefile.lst", &
               &STATUS="REPLACE", FORM="FORMATTED", ACCESS="SEQUENTIAL", ACTION="WRITE", IOSTAT=kgen_ierr) 
               IF (kgen_ierr .EQ. 0) THEN 
                   FLUSH (kgen_stopunit) 
                   CALL kgen_write_list(kgen_stopunit, INT(100), INT(100), INT(0), INT(1), INT(10), INT(10)) 
                   CALL kgen_write_list(kgen_stopunit, INT(100), INT(100), INT(0), INT(1), INT(50), INT(50)) 
                   CALL kgen_write_list(kgen_stopunit, INT(300), INT(300), INT(0), INT(1), INT(10), INT(10)) 
                   CALL kgen_write_list(kgen_stopunit, INT(300), INT(300), INT(0), INT(1), INT(50), INT(50)) 
                   CALL kgen_write_list(kgen_stopunit, INT(500), INT(500), INT(0), INT(1), INT(10), INT(10)) 
                   CALL kgen_write_list(kgen_stopunit, INT(500), INT(500), INT(0), INT(1), INT(50), INT(50)) 
                   FLUSH (kgen_stopunit) 
                   CLOSE (UNIT=kgen_stopunit, STATUS="KEEP") 
               ...
               ELSE 
                   CALL RANDOM_NUMBER(kgen_realnum) 
                   CALL SLEEP(INT(kgen_realnum * kgen_count * 3) + 1) 
               END IF   
           END DO   
       END IF   
   END IF   
   !$OMP END CRITICAL (kgen_fini) 
   kgen_invoke(OMP_GET_THREAD_NUM()) = kgen_invoke(OMP_GET_THREAD_NUM()) + 1 
   !END OF KGEN REGION 
...
!$kgen end_callsite clubb
   ...
   SUBROUTINE kgen_init_vars(mpi_s, mpi_e, omp_s, omp_e, invoke_e, msize, osize, lockpath, last_invoke, isstop) 
       ...
       INTEGER, INTENT(OUT), DIMENSION(0:osize-1) :: last_invoke 
       LOGICAL, INTENT(OUT), DIMENSION(0:msize-1,0:osize-1) :: isstop 
       CHARACTER(LEN=1024), INTENT(OUT), DIMENSION(0:msize-1,0:osize-1) :: lockpath 
       ...
       DO mpi_idx=mpi_s,mpi_e 
           DO openmp_idx=omp_s,omp_e 
               ...
               &"/glade/scratch/youngsun/kgensystest/kapp_sys_ys_cesm_intel_clubb_tend_cam_Test/kernel/done.", mpi_idx, ".", &
               &openmp_idx 
       ...
       DO mpi_idx=mpi_s,mpi_e 
           ...
           DO openmp_idx=omp_s,omp_e 
               ...
               DO invoke_idx=invoke_s,invoke_e 
                   ...
                   WRITE (UNIT = myunit, FMT="(A)") "clubb." // TRIM(ADJUSTL(mpi_str)) // "." // TRIM(ADJUSTL(openmp_str)) // "." &
                   &// TRIM(ADJUSTL(invoke_str)) 
               END DO   
               OPEN (NEWUNIT=temp_unit, &
               &FILE="/glade/scratch/youngsun/kgensystest/kapp_sys_ys_cesm_intel_clubb_tend_cam_Test/kernel/done." // &
   ...
   !write state subroutine for kw_clubb_tend_cam_pdf_parameter__pdf_parameter_dim1 
   SUBROUTINE kw_clubb_tend_cam_pdf_parameter__pdf_parameter_dim1(var, kgen_unit, printvar) 
       TYPE(pdf_parameter), INTENT(IN), DIMENSION(:) :: var 
       ...
       IF (kgen_istrue) THEN 
           ...
           DO idx1=LBOUND(var,1), UBOUND(var,1) 
               IF (PRESENT( printvar )) THEN 
                   CALL kw_pdf_parameter_module_pdf_parameter(var(idx1), kgen_unit, printvar // "(idx1)") 
               ELSE 
                   CALL kw_pdf_parameter_module_pdf_parameter(var(idx1), kgen_unit) 
               END IF   
           END DO   
       END IF   
         
   END SUBROUTINE kw_clubb_tend_cam_pdf_parameter__pdf_parameter_dim1 
     
   !write state subroutine for kw_clubb_tend_cam_real__r8_dim2_ptr 
   SUBROUTINE kw_clubb_tend_cam_real__r8_dim2_ptr(var, kgen_unit, printvar) 
   ...
   END SUBROUTINE kw_clubb_tend_cam_real__r8_dim2_ptr 
...
!!XXgoldyXX: Probably need a hist coord for nnzp for the vertical
  ...
  !write in state subroutine for kw_externs_in_clubb_intr 
  SUBROUTINE kw_externs_in_clubb_intr(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
        
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) do_cldcool 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) clubb_rnevap_effic 
      IF (SIZE(lq)==1) THEN 
          IF (UBOUND(lq, 1)<LBOUND(lq, 1)) THEN 
              kgen_istrue = .FALSE. 
          ELSE IF (UBOUND(lq, 1)==0 .AND. LBOUND(lq, 1)==0) THEN 
              kgen_istrue = .FALSE. 
          ELSE 
              kgen_istrue = .TRUE. 
          END IF   
      ELSE IF (SIZE(lq)==0) THEN 
          kgen_istrue = .FALSE. 
      ELSE 
          kgen_istrue = .TRUE. 
      END IF   
      WRITE (UNIT = kgen_unit) kgen_istrue 
      IF (kgen_istrue) THEN 
          WRITE (UNIT = kgen_unit) lq 
      END IF   
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) do_rainturb 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) do_expldiff 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) clubb_do_adv 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) clubb_do_deep 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) edsclr_dim 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixrtpthlp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixwprtp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixwp3 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixwp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixvp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixwpthlp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixrtp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixup2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ixthlp2 
      CALL kw_clubb_intr_real__r8_dim3(out_zm, kgen_unit) 
      CALL kw_clubb_intr_real__r8_dim3(out_zt, kgen_unit) 
      CALL kw_clubb_intr_real__r8_dim3(out_sfc, kgen_unit) 
      CALL kw_clubb_intr_real__r8_dim3(out_radzm, kgen_unit) 
      CALL kw_clubb_intr_real__r8_dim3(out_radzt, kgen_unit) 
  END SUBROUTINE kw_externs_in_clubb_intr 
    
  !write out state subroutine for kw_externs_out_clubb_intr 
  SUBROUTINE kw_externs_out_clubb_intr(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
      ...
      CALL kw_clubb_intr_real__r8_dim3(out_radzm, kgen_unit) 
      CALL kw_clubb_intr_real__r8_dim3(out_radzt, kgen_unit) 
  END SUBROUTINE kw_externs_out_clubb_intr 
    
  !write state subroutine for kw_clubb_intr_real__r8_dim3 
  SUBROUTINE kw_clubb_intr_real__r8_dim3(var, kgen_unit, printvar) 
  ...
  END SUBROUTINE kw_clubb_intr_real__r8_dim3 
