...
!$omp threadprivate(wp3_on_wp2, wp3_on_wp2_zt)
  ...
  PUBLIC kw_externs_in_variables_diagnostic_module 
  PUBLIC kw_externs_out_variables_diagnostic_module 
...
!------------------------------------------------------------------------
  ...
  !write in state subroutine for kw_externs_in_variables_diagnostic_module 
  SUBROUTINE kw_externs_in_variables_diagnostic_module(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
        
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(skw_zm, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(sigma_sqd_w_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(vg, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rtm_ref, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(thvm, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(skw_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(ug, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(vm_ref, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(um_ref, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(thlm_ref, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rsat, kgen_unit) 
      CALL kw_kgen_subpname_0(pdf_params_zm, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(frad, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(thlprcp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rcp2, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rtprcp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wpthlp2, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp3_zm, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp2rcp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wprtp2, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wprtpthlp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp2rtp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp2thlp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp4, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp2thvp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wpthvp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(thlpthvp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rtpthvp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(kh_zm, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(kh_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(lscale_up, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(lscale, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(lscale_down, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(em, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(tau_zm, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(tau_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(wpedsclrp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(sclrpthvp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(wpsclrp2, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(sclrprcp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(wpsclrprtp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(wpsclrpthlp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim2(wp2sclrp, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(up2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rtpthlp_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(vpwp_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(upwp_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wpthlp_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(rtp2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(vp2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wprtp_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(thlp2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(skw_velocity, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(a3_coef_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(a3_coef, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp3_on_wp2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp3_on_wp2, kgen_unit) 
  END SUBROUTINE kw_externs_in_variables_diagnostic_module 
    
  !write out state subroutine for kw_externs_out_variables_diagnostic_module 
  SUBROUTINE kw_externs_out_variables_diagnostic_module(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
      ...
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp3_on_wp2_zt, kgen_unit) 
      CALL kw_variables_diagnostic_module_real__core_rknd_dim1(wp3_on_wp2, kgen_unit) 
  END SUBROUTINE kw_externs_out_variables_diagnostic_module 
    
  !write state subroutine for kw_variables_diagnostic_module_real__core_rknd_dim1 
  SUBROUTINE kw_variables_diagnostic_module_real__core_rknd_dim1(var, kgen_unit, printvar) 
  ...
  END SUBROUTINE kw_variables_diagnostic_module_real__core_rknd_dim1 
    
  !write state subroutine for kw_kgen_subpname_0 
  SUBROUTINE kw_kgen_subpname_0(var, kgen_unit, printvar) 
      TYPE(pdf_parameter), INTENT(IN), ALLOCATABLE, DIMENSION(:) :: var 
      INTEGER, INTENT(IN) :: kgen_unit 
      CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
  ...
  !write state subroutine for kw_variables_diagnostic_module_real__core_rknd_dim2 
  SUBROUTINE kw_variables_diagnostic_module_real__core_rknd_dim2(var, kgen_unit, printvar) 
      REAL(KIND=core_rknd), INTENT(IN), ALLOCATABLE, DIMENSION(:,:) :: var 
      INTEGER, INTENT(IN) :: kgen_unit 
      CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
      LOGICAL :: kgen_istrue 
  ...
  END SUBROUTINE kw_variables_diagnostic_module_real__core_rknd_dim2 
