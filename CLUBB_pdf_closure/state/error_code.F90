...
!$omp threadprivate(clubb_debug_level)
  ...
  PUBLIC kw_externs_in_error_code
  PUBLIC kw_externs_out_error_code
  contains
...
!-------------------------------------------------------------------------------
  ...
  !write in state subroutine for kw_externs_in_error_code
  SUBROUTINE kw_externs_in_error_code(kgen_unit)
      INTEGER, INTENT(IN) :: kgen_unit
      LOGICAL :: kgen_istrue
      REAL(KIND=8) :: kgen_array_sum
      
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) clubb_debug_level
  END SUBROUTINE kw_externs_in_error_code
  
  !write out state subroutine for kw_externs_out_error_code
  SUBROUTINE kw_externs_out_error_code(kgen_unit)
      INTEGER, INTENT(IN) :: kgen_unit
      LOGICAL :: kgen_istrue
      REAL(KIND=8) :: kgen_array_sum
      
  END SUBROUTINE kw_externs_out_error_code
