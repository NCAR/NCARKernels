    ...
    PROGRAM kernel_driver
        ...
        USE mpas_atmphys_driver_convection, ONLY: driver_convection
        ...
        DO kgen_repeat_counter = 0, 8
            ...
            kgen_filepath = "../data/cu_tiedtke." // TRIM(ADJUSTL(kgen_counter_conv)) // "." // TRIM(ADJUSTL(kgen_mpi_rank_conv))
            ...
            READ (UNIT = kgen_unit) itimestep
            
            !callsite part
            CALL driver_convection(kgen_unit, kgen_total_time, itimestep)
        ...
        WRITE (*, *) ""
        WRITE (*, *) "******************************************************************************"
        WRITE (*, *) "cu_tiedtke summary: Total number of verification cases: 9"
        WRITE (*, *) "cu_tiedtke summary: Average call time of all calls (usec): ", kgen_total_time / 9
        WRITE (*, *) "******************************************************************************"
    END PROGRAM 
