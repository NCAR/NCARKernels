module mo_imp_sol
  ...
  PUBLIC kw_externs_in_mo_imp_sol
  PUBLIC kw_externs_out_mo_imp_sol
contains
...
!
  ...
  !write in state subroutine for kw_externs_in_mo_imp_sol
  SUBROUTINE kw_externs_in_mo_imp_sol(kgen_unit)
      INTEGER, INTENT(IN) :: kgen_unit
      LOGICAL :: kgen_istrue
      REAL(KIND=8) :: kgen_array_sum
      
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) small
      IF (SIZE(epsilon)==1) THEN
          IF (UBOUND(epsilon, 1)<LBOUND(epsilon, 1)) THEN
              kgen_istrue = .FALSE.
          ELSE IF (UBOUND(epsilon, 1)==0 .AND. LBOUND(epsilon, 1)==0) THEN
              kgen_istrue = .FALSE.
          ELSE
              kgen_istrue = .TRUE.
          END IF 
      ELSE IF (SIZE(epsilon)==0) THEN
          kgen_istrue = .FALSE.
      ELSE
          kgen_istrue = .TRUE.
      END IF 
      ...
      IF (kgen_istrue) THEN
          kgen_array_sum = REAL(SUM(epsilon), 8)
          WRITE (UNIT = kgen_unit) kgen_array_sum
          WRITE (UNIT = kgen_unit) epsilon
      END IF 
      IF (SIZE(factor)==1) THEN
          IF (UBOUND(factor, 1)<LBOUND(factor, 1)) THEN
              kgen_istrue = .FALSE.
          ELSE IF (UBOUND(factor, 1)==0 .AND. LBOUND(factor, 1)==0) THEN
              kgen_istrue = .FALSE.
          ELSE
              kgen_istrue = .TRUE.
          END IF 
      ELSE IF (SIZE(factor)==0) THEN
          kgen_istrue = .FALSE.
      ELSE
          kgen_istrue = .TRUE.
      END IF 
      WRITE (UNIT = kgen_unit) kgen_istrue
      IF (kgen_istrue) THEN
          WRITE (UNIT = kgen_unit) factor
      END IF 
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) o1d_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) h2o_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) po2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) oh_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ho2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ch3co3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ch3o2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) c2h5o2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) mco3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) isopo2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) c3h7o2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) macro2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) xo2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) no_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) n2o5_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ro2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) no2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) no3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) mvk_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) c10h16_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) isop_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) c3h6_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) c2h4_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p4_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p5_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p1_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p10_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p6_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p7_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p8_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p9_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p11_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l1_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l4_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l5_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l6_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l7_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l8_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_l9_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr4_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ole_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr17_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr16_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) c2o3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) eneo2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) alko2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) terpo2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) eo2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) tolo2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) meko2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p17_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p13_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p16_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p12_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p14_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) ox_p15_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) full_ozone_chem
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) middle_atm_chem
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) reduced_ozone_chem
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) o3a_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) xno2_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) no2xno3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) xno_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) xno3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) o1da_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) xno2no3_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr4a_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr17b_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr16b_ndx
      kgen_istrue = .TRUE.
      WRITE (UNIT = kgen_unit) usr16a_ndx
  END SUBROUTINE kw_externs_in_mo_imp_sol
  
  !write out state subroutine for kw_externs_out_mo_imp_sol
  SUBROUTINE kw_externs_out_mo_imp_sol(kgen_unit)
      INTEGER, INTENT(IN) :: kgen_unit
      LOGICAL :: kgen_istrue
      REAL(KIND=8) :: kgen_array_sum
      
  END SUBROUTINE kw_externs_out_mo_imp_sol
