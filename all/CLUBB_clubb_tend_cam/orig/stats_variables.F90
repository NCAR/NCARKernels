...
!$omp   threadprivate(zmscr16, zmscr17)
  ...
  SUBROUTINE kr_externs_in_stats_variables(kgen_unit) 
      ...
      CALL kr_stats_type_stats(stats_rad_zm, kgen_unit) 
      CALL kr_stats_type_stats(stats_sfc, kgen_unit) 
      CALL kr_stats_type_stats(stats_rad_zt, kgen_unit) 
  ...
  SUBROUTINE kr_stats_variables_integer___dim1(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("isclrm", kgen_array_sum, REAL(SUM(var), 8), .TRUE.) 
  ...
  SUBROUTINE kr_stats_variables_real__core_rknd_dim1(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          ALLOCATE (var(kgen_bound(1,1):kgen_bound(2,1))) 
          READ (UNIT = kgen_unit) var 
          CALL kgen_array_sumcheck("ztscr16", kgen_array_sum, REAL(SUM(var, mask=(var .eq. var)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
              WRITE (*, *) "** KGEN DEBUG: " // printvar // "**" // NEW_LINE("A"), var 
          END IF   
      END IF   
