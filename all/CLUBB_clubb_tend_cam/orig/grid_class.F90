...
module grid_class
  ...
  !-----------------------------------------------------------------------
    ...
    PUBLIC gr, grid, zt2zm, interp_weights_zt2zm_imp, zm2zt, interp_weights_zm2zt_imp, ddzm, ddzt, setup_grid, cleanup_grid, &
    &setup_grid_heights 
...
!===============================================================================
  ...
  SUBROUTINE kr_externs_out_grid_class(kgen_unit) 
      ...
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
      CALL kr_grid_class_grid(kgenref_gr, kgen_unit) 
  ...
  SUBROUTINE kr_grid_real__core_rknd_dim1_ptr(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          CALL kgen_array_sumcheck("zm", kgen_array_sum, REAL(SUM(var, mask=(var .eq. var)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
  ...
  SUBROUTINE kr_grid_real__core_rknd_dim2_ptr(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          READ (UNIT = kgen_unit) var 
          CALL kgen_array_sumcheck("weights_zm2zt", kgen_array_sum, REAL(SUM(var, mask=(var .eq. var)), 8), .TRUE.) 
          IF (PRESENT( printvar )) THEN 
              WRITE (*, *) "** KGEN DEBUG: REAL(SUM(" // printvar // "), 8) **", REAL(SUM(var), 8) 
          END IF   
      END IF   
