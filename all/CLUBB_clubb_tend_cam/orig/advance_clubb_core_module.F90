...
!-----------------------------------------------------------------------
  ...
  subroutine advance_clubb_core &
    ...
    ! Modules to be included
      ...
      USE constants_clubb, ONLY: em_min, thl_tol, rt_tol, w_tol_sqd, ep2, cp, lv, ls, ep1, p0, kappa, fstderr, zero_threshold, &
      &three_halves, zero, unused_var 
      ...
      &l_host_applies_sfc_fluxes, l_use_cloud_cover, l_rtm_nudge 

      USE grid_class, ONLY: gr, zm2zt, zt2zm 

      USE numerical_check, ONLY: parameterization_check, calculate_spurious_source 

      USE variables_diagnostic_module, ONLY: skw_zt, skw_zm, sigma_sqd_w_zt, wp4, thlpthvp, rtpthvp, rtprcp, thlprcp, rcp2, rsat, &
      &pdf_params_zm, wprtp2, wp2rtp, wpthlp2, wp2thlp, wprtpthlp, wpthvp, wp2thvp, wp2rcp 
      ...
      &irtm_bt, ithlm_bt, ivm_bt, ium_bt, iwp4, irsat, irvm, irel_humidity, iwpthlp_zt, iskw_zt, iskw_zm 
