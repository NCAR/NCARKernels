...
!$omp threadprivate(l_prescribed_avg_deltaz)
  ...
  PUBLIC kw_externs_in_parameters_tunable 
  PUBLIC kw_externs_out_parameters_tunable 
  contains
...
!===============================================================================
  ...
  !write in state subroutine for kw_externs_in_parameters_tunable 
  SUBROUTINE kw_externs_in_parameters_tunable(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
        
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6rtb 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6rtc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c2b 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c2c 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c13 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c12 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c11 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c10 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6rt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c15 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c14 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c11c 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c11b 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6thl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c8b 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c8 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c2rt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6thlc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6thlb 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c7 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c5 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c4 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c1c 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c1b 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c2rtthl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c7c 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c7b 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c2thl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6thl_lscale0 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) wpxp_l_thresh 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c6rt_lscale0 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c7_lscale0 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) taumin 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) k_hm_min_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k_hmb 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k9 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k8 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k6 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k_hm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) gamma_coefc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) mu 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) mult_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) gamma_coefb 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) lmin 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) taumax 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) gamma_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) lscale_pert_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) lscale_mu_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) alpha_corr 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu_hm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu8 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu9 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu6 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) nu10 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu8_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu2_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu9_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu1_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu_hm_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu6_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu10_vert_res_dep, kgen_unit) 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) beta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) lmin_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) coef_hm_1_hm_2_corr_adj 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) skw_denom_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) c_k10 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) thlp2_rad_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) thlp2_rad_cloud_frac_thresh 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) l_prescribed_avg_deltaz 
  END SUBROUTINE kw_externs_in_parameters_tunable 
    
  !write out state subroutine for kw_externs_out_parameters_tunable 
  SUBROUTINE kw_externs_out_parameters_tunable(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
      ...
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu6_vert_res_dep, kgen_unit) 
      CALL kw_parameters_tunable_real__core_rknd_dim1(nu10_vert_res_dep, kgen_unit) 
  END SUBROUTINE kw_externs_out_parameters_tunable 
    
  !write state subroutine for kw_parameters_tunable_real__core_rknd_dim1 
  SUBROUTINE kw_parameters_tunable_real__core_rknd_dim1(var, kgen_unit, printvar) 
  ...
  END SUBROUTINE kw_parameters_tunable_real__core_rknd_dim1 
