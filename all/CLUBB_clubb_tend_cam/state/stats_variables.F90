...
module stats_variables
  ...
  USE stats_type, ONLY: kw_stats_type_stats 
  implicit none
...
!$omp   threadprivate(zmscr16, zmscr17)
  ...
  PUBLIC kw_externs_in_stats_variables 
  PUBLIC kw_externs_out_stats_variables 
  PUBLIC kw_stats_type_stats 
    
  CONTAINS 
    
  !write in state subroutine for kw_externs_in_stats_variables 
  SUBROUTINE kw_externs_in_stats_variables(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
        
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) stats_tsamp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) stats_tout 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) l_output_rad_files 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) l_stats 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) l_stats_samp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) l_stats_last 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_ref 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_ref 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ircm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irho_ds_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2thlp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irvm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icloud_cover 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iskw_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icloud_frac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iexner 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ircm_in_cloud 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwm_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iug 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwm_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ip_in_pa 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithv_ds_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ircm_in_layer 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iice_supersat_frac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ilscale 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithvm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2rtp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) isigma_sqd_w_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ilscale_up 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) itau_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ilscale_down 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ikh_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtpthlp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irho 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ilscale_pert_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2rcp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ilscale_pert_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2thvp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irsat 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irel_humidity 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irsati 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irfrzm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ic11_skw_fnc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icloud_frac_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ircm_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iice_supersat_frac_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) it_in_k 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_tacl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_tacl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_sdmp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_sdmp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_old 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_mfl_min 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_mfl_min 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_old 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_exit_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_mfl_max 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_entermfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_mfl_max 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_enter_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_mfl_min 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_mfl_max 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_enter_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_exit_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_exit_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_without_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_without_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_enter_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_exit_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_mfl_max 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_mfl_min 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_ac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_pr1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_pr2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_bp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_bp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_cf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_f 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_ndg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_sdmp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_gf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_gf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_sdmp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_cf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_ndg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_f 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivarnce_thl_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivarnce_thl_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iw_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icloud_frac_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icloud_frac_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iw_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivarnce_rt_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) imixt_frac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irt_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irt_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irc_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irc_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithl_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithl_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivarnce_rt_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivarnce_w_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irsatl_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irsatl_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivarnce_w_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irrtthl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icovar_chi_eta_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icrt_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icrt_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) istdev_chi_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) istdev_chi_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icthl_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icovar_chi_eta_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icthl_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ichip2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ichi_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icorr_chi_eta_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icorr_chi_eta_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ichi_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) istdev_eta_1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) istdev_eta_2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivpwp_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iupwp_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ichi 
      CALL kw_stats_variables_integer___dim1(isclrm, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(isclrm_f, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iedsclrm_f, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iedsclrm, kgen_unit) 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) itau_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlpthvp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iskw_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthvp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp4 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprcp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthvp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtprcp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ikh_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irc_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivpwp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ircp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlprcp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iupwp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ifrad 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) imean_w_down 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irho_ds_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irho_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ishear 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iem 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) imean_w_up 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithv_ds_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) isigma_sqd_w 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) istability_correction 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ic1_skw_fnc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ic6thl_skw_fnc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ic6rt_skw_fnc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) igamma_skw_fnc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ic7_skw_fnc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_bp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_sf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_pr3 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_pr2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_dp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_pr1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_ac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_ac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_pr3 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_pr2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_pr1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_bp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwprtp_sicl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_ac 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_pr2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_pr3 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_pr1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_mfl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_bp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_sicl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwpthlp_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_sf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_dp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_sf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_dp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_tp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_tp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_sf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_dp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_forcing 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_pr1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_pr2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_bt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_dp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_dp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_dp1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_sf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_sf 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_cl 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_pr2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_pr1 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_ta 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_ma 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_pd 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_tp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_ta 
      CALL kw_stats_variables_integer___dim1(isclrpthlp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iwp2sclrp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(isclrp2, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iwpsclrp2, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iwpsclrprtp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(isclrprtp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(isclrprcp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(isclrpthvp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iwpsclrp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iwpsclrpthlp, kgen_unit) 
      CALL kw_stats_variables_integer___dim1(iwpedsclrp, kgen_unit) 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icc 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivwp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ilwp 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iz_cloud_base 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivm_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ium_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp2_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ivp2_vert_avg 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlp2_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp23_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtp2_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwindm_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtpthlp_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iup2_vp2_matrix_condt_num 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ithlm_spur_src 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) irtm_spur_src 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ia3_coef 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iskw_velocity 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_zm 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ia3_coef_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_on_wp2_zt 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) iwp3_on_wp2 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) icloud_frac_refined 
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) ircm_refined 
      CALL kw_stats_type_stats(stats_rad_zm, kgen_unit) 
      CALL kw_stats_type_stats(stats_sfc, kgen_unit) 
      CALL kw_stats_type_stats(stats_rad_zt, kgen_unit) 
      CALL kw_stats_type_stats(stats_zt, kgen_unit) 
      CALL kw_stats_type_stats(stats_zm, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr16, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr14, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr15, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr12, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr13, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr10, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr11, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr09, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr08, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr01, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr03, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr02, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr05, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr04, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr07, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(ztscr06, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr11, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr10, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr15, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr08, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr09, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr12, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr13, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr14, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr02, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr03, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr01, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr06, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr07, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr04, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr05, kgen_unit) 
  END SUBROUTINE kw_externs_in_stats_variables 
    
  !write out state subroutine for kw_externs_out_stats_variables 
  SUBROUTINE kw_externs_out_stats_variables(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
      ...
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr04, kgen_unit) 
      CALL kw_stats_variables_real__core_rknd_dim1(zmscr05, kgen_unit) 
  END SUBROUTINE kw_externs_out_stats_variables 
    
  !write state subroutine for kw_stats_variables_integer___dim1 
  SUBROUTINE kw_stats_variables_integer___dim1(var, kgen_unit, printvar) 
      INTEGER, INTENT(IN), ALLOCATABLE, DIMENSION(:) :: var 
      INTEGER, INTENT(IN) :: kgen_unit 
  ...
  END SUBROUTINE kw_stats_variables_integer___dim1 
    
  !write state subroutine for kw_stats_variables_real__core_rknd_dim1 
  SUBROUTINE kw_stats_variables_real__core_rknd_dim1(var, kgen_unit, printvar) 
  ...
  END SUBROUTINE kw_stats_variables_real__core_rknd_dim1 
