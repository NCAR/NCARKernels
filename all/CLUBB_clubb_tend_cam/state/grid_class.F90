...
!$omp   threadprivate(gr)
  ...
  PUBLIC kw_externs_in_grid_class 
  PUBLIC kw_externs_out_grid_class 
  PUBLIC kw_grid_class_grid 
  contains
...
!===============================================================================
  ...
  !write in state subroutine for kw_externs_in_grid_class 
  SUBROUTINE kw_externs_in_grid_class(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
        
      CALL kw_grid_class_grid(gr, kgen_unit) 
  END SUBROUTINE kw_externs_in_grid_class 
    
  !write out state subroutine for kw_externs_out_grid_class 
  SUBROUTINE kw_externs_out_grid_class(kgen_unit) 
      INTEGER, INTENT(IN) :: kgen_unit 
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
        
      CALL kw_grid_class_grid(gr, kgen_unit) 
  END SUBROUTINE kw_externs_out_grid_class 
    
  !read state subroutine for kw_grid_class_grid 
  RECURSIVE SUBROUTINE kw_grid_class_grid(var, kgen_unit, printvar) 
      TYPE(grid), INTENT(IN) :: var 
      INTEGER, INTENT(IN) :: kgen_unit 
      ...
      kgen_istrue = .TRUE. 
      WRITE (UNIT = kgen_unit) var%nz 
      IF (PRESENT( printvar )) THEN 
          WRITE (*, *) "** KGEN DEBUG: " // printvar // "%nz **" // NEW_LINE("A"), var%nz 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%zm, kgen_unit, printvar // "%zm") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%zm, kgen_unit) 
      END IF   
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%zt, kgen_unit, printvar // "%zt") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%zt, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%invrs_dzm, kgen_unit, printvar // "%invrs_dzm") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%invrs_dzm, kgen_unit) 
      END IF   
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%invrs_dzt, kgen_unit, printvar // "%invrs_dzt") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%invrs_dzt, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%dzm, kgen_unit, printvar // "%dzm") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%dzm, kgen_unit) 
      END IF   
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%dzt, kgen_unit, printvar // "%dzt") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim1_ptr(var%dzt, kgen_unit) 
      END IF   
        
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim2_ptr(var%weights_zm2zt, kgen_unit, printvar // "%weights_zm2zt") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim2_ptr(var%weights_zm2zt, kgen_unit) 
      END IF   
      IF (PRESENT( printvar )) THEN 
          CALL kw_grid_real__core_rknd_dim2_ptr(var%weights_zt2zm, kgen_unit, printvar // "%weights_zt2zm") 
      ELSE 
          CALL kw_grid_real__core_rknd_dim2_ptr(var%weights_zt2zm, kgen_unit) 
      END IF   
        
  END SUBROUTINE kw_grid_class_grid 
    
  !write state subroutine for kw_grid_real__core_rknd_dim1_ptr 
  SUBROUTINE kw_grid_real__core_rknd_dim1_ptr(var, kgen_unit, printvar) 
      ...
      IF (kgen_istrue) THEN 
          ...
          END IF   
      END IF   
  END SUBROUTINE kw_grid_real__core_rknd_dim1_ptr 
    
  !write state subroutine for kw_grid_real__core_rknd_dim2_ptr 
  SUBROUTINE kw_grid_real__core_rknd_dim2_ptr(var, kgen_unit, printvar) 
      REAL(KIND=core_rknd), INTENT(IN), POINTER, DIMENSION(:,:) :: var 
      INTEGER, INTENT(IN) :: kgen_unit 
      CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: printvar 
      LOGICAL :: kgen_istrue 
      ...
      IF (kgen_istrue) THEN 
          ...
          END IF   
      END IF   
  END SUBROUTINE kw_grid_real__core_rknd_dim2_ptr 
