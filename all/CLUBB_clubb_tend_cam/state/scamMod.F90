...
subroutine scam_default_opts(iopfile_out, &
...
!write in state subroutine for kw_externs_in_scammod 
SUBROUTINE kw_externs_in_scammod(kgen_unit) 
    INTEGER, INTENT(IN) :: kgen_unit 
    LOGICAL :: kgen_istrue 
    REAL(KIND=8) :: kgen_array_sum 
      
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) single_column 
    kgen_istrue = .TRUE. 
    WRITE (UNIT = kgen_unit) scm_clubb_iop_name 
END SUBROUTINE kw_externs_in_scammod 
