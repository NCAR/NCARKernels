...
!------------------------------------------------------------------------
    ...
    PUBLIC set_boundary_conditions_lhs, set_boundary_conditions_rhs, calc_stability_correction
  ...
  function calc_stability_correction( thlm, Lscale, em ) &
    result ( stability_correction )
      ...
      USE constants_clubb, ONLY: zero, grav

      USE grid_class, ONLY: gr, zt2zm, ddzt
