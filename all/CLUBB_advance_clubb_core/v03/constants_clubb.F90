...
module constants_clubb
  ...
  !---------------------------------------------------------------------------
    ...
    USE shr_const_mod, ONLY: shr_const_rdair, shr_const_cpdair, shr_const_latvap, shr_const_latice, shr_const_latsub, shr_const_rgas, shr_const_mwwv, shr_const_tkfrz, shr_const_mwdair, shr_const_g
