...
module stats_clubb_utilities
  ...
  subroutine stats_accumulate & 
    ...
    !----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: stats_zt, stats_zm, stats_sfc, l_stats_samp, ithlm, it_in_k, ithvm, irtm, ircm, ium, ivm, iwm_zt, iwm_zm, iug, ivg, icloud_frac, iice_supersat_frac, ircm_in_layer, icloud_cover

      USE stats_variables, ONLY: ip_in_pa, iexner, irho_ds_zt, ithv_ds_zt, ilscale, iwp3, iwp3_zm, iwpthlp2, iwp2thlp, iwprtp2, iwp2rtp, ilscale_up, ilscale_down, itau_zt, ikh_zt

      USE stats_variables, ONLY: iwp2thvp, iwp2rcp, iwprtpthlp, isigma_sqd_w_zt, irho, irsat, irsati

      USE stats_variables, ONLY: imixt_frac, iw_1, iw_2, ivarnce_w_1, ivarnce_w_2, ithl_1, ithl_2, ivarnce_thl_1, ivarnce_thl_2, irt_1, irt_2, ivarnce_rt_1, ivarnce_rt_2, irc_1, irc_2, irsatl_1, irsatl_2, icloud_frac_1, icloud_frac_2

      USE stats_variables, ONLY: ichi_1, ichi_2, istdev_chi_1, istdev_chi_2, ichip2, istdev_eta_1, istdev_eta_2, icovar_chi_eta_1, icovar_chi_eta_2, icorr_chi_eta_1, icorr_chi_eta_2, icrt_1, icrt_2, icthl_1, icthl_2, irrtthl, ichi

      USE stats_variables, ONLY: iwp2_zt, ithlp2_zt, iwpthlp_zt, iwprtp_zt, irtp2_zt, irtpthlp_zt, iup2_zt, ivp2_zt, iupwp_zt, ivpwp_zt, iwp2, irtp2, ithlp2, irtpthlp, iwprtp, iwpthlp, iwp4, iwpthvp, irtpthvp

      USE stats_variables, ONLY: ithlpthvp, itau_zm, ikh_zm, iwprcp, irc_coef, ithlprcp, irtprcp, ircp2, iupwp, ivpwp, iup2, ivp2, irho_zm, isigma_sqd_w, irho_ds_zm, ithv_ds_zm, iem

      USE stats_variables, ONLY: ishear, ifrad, icc, iz_cloud_base, ilwp, ivwp, ithlm_vert_avg, irtm_vert_avg, ium_vert_avg, ivm_vert_avg, iwp2_vert_avg, iup2_vert_avg, ivp2_vert_avg, irtp2_vert_avg, ithlp2_vert_avg

      USE stats_variables, ONLY: isclrm, isclrm_f, iedsclrm, iedsclrm_f, isclrprtp, isclrp2, isclrpthvp, isclrpthlp, isclrprcp, iwpsclrp, iwp2sclrp, iwpsclrp2, iwpsclrprtp, iwpsclrpthlp, iwpedsclrp
      ...
      USE variables_diagnostic_module, ONLY: wp2_zt, thlp2_zt, wpthlp_zt, wprtp_zt, rtp2_zt, rtpthlp_zt, up2_zt, vp2_zt, upwp_zt,&
                    vpwp_zt, wp4, rtpthvp, thlpthvp, wpthvp, tau_zm, kh_zm, thlprcp, rtprcp, rcp2, em, frad, sclrpthvp, sclrprcp, &
                    wp2sclrp, wpsclrp2, wpsclrprtp, wpsclrpthlp, wpedsclrp
