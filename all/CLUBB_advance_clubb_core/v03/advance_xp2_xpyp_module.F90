...
!Generated at : 2016-01-07 12:08:47
!KGEN version : 0.6.1
...
module advance_xp2_xpyp_module
  ...
  !-----------------------------------------------------------------------
    ...
    PRIVATE xp2_xpyp_lhs, xp2_xpyp_solve, xp2_xpyp_uv_rhs, xp2_xpyp_rhs, xp2_xpyp_implicit_stats, term_ta_lhs, term_ta_lhs_upwind, term_ta_rhs, term_tp, term_dp1_lhs, term_dp1_rhs, term_pr1, term_pr2
  ...
  subroutine advance_xp2_xpyp( tau_zm, wm_zm, rtm, wprtp, thlm, &
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: w_tol_sqd, rt_tol, thl_tol, w_tol_sqd, fstderr, one, two_thirds, one_half, one_third, zero, zero_threshold

      USE model_flags, ONLY: l_hole_fill, l_single_c2_skw

      USE parameters_tunable, ONLY: c2rt, c2thl, c2rtthl, c_k2, nu2_vert_res_dep, c_k9, nu9_vert_res_dep, beta, c4, c14, c5, c2, c2b, c2c
...
!        band_solve
      ...
      USE stats_variables, ONLY: stats_sfc, irtp2_matrix_condt_num, ithlp2_matrix_condt_num, irtpthlp_matrix_condt_num, iup2_vp2_matrix_condt_num, l_stats_samp
  ...
  subroutine xp2_xpyp_implicit_stats( solve_type, xapxbp )
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: stats_zm, irtp2_dp1, irtp2_dp2, irtp2_ta, irtp2_ma, ithlp2_dp1, ithlp2_dp2, ithlp2_ta, ithlp2_ma, irtpthlp_dp1, irtpthlp_dp2, irtpthlp_ta, irtpthlp_ma, iup2_dp1, iup2_dp2, iup2_ta, iup2_ma, iup2_pr1, ivp2_dp1

      USE stats_variables, ONLY: ivp2_dp2, ivp2_ta, ivp2_ma, ivp2_pr1, zmscr01, zmscr02, zmscr03, zmscr04, zmscr05, zmscr06, zmscr07, zmscr08, zmscr09, zmscr10, zmscr11
  ...
  subroutine xp2_xpyp_uv_rhs( solve_type, dt, l_iter, a1, a1_zt, wp2, &
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: ivp2_ta, ivp2_tp, ivp2_dp1, ivp2_pr1, ivp2_pr2, iup2_ta, iup2_tp, iup2_dp1, iup2_pr1, iup2_pr2, stats_zm, zmscr01, zmscr11, l_stats_samp
  ...
  subroutine xp2_xpyp_rhs( solve_type, dt, l_iter, a1, a1_zt, &
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: irtp2_ta, irtp2_tp, irtp2_dp1, irtp2_forcing, ithlp2_ta, ithlp2_tp, ithlp2_dp1, ithlp2_forcing, irtpthlp_ta, irtpthlp_tp1, irtpthlp_tp2, irtpthlp_dp1, irtpthlp_forcing, stats_zm, l_stats_samp
