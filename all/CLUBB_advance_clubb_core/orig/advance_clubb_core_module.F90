...
!-----------------------------------------------------------------------
  ...
  subroutine advance_clubb_core &
    ...
    ! Modules to be included
      ...
      USE constants_clubb, ONLY: em_min, thl_tol, rt_tol, w_tol_sqd, ep2, cp, lv, ls, ep1, p0, kappa, fstderr, zero_threshold, three_halves, zero, unused_var

      USE parameters_tunable, ONLY: gamma_coefc, gamma_coefb, gamma_coef, taumax, c_k, mu, lscale_mu_coef, lscale_pert_coef, c_k10

      USE parameters_model, ONLY: sclr_dim, edsclr_dim, sclr_tol, ts_nudge, rtm_min, rtm_nudge_max_altitude

      USE model_flags, ONLY: l_tke_aniso, l_gamma_skw, l_trapezoidal_rule_zt, l_trapezoidal_rule_zm, l_call_pdf_closure_twice, l_host_applies_sfc_fluxes, l_use_cloud_cover, l_rtm_nudge

      USE grid_class, ONLY: gr, zm2zt, zt2zm

      USE numerical_check, ONLY: parameterization_check, calculate_spurious_source

      USE variables_diagnostic_module, ONLY: skw_zt, skw_zm, sigma_sqd_w_zt, wp4, thlpthvp, rtpthvp, rtprcp, thlprcp, rcp2, rsat, pdf_params_zm, wprtp2, wp2rtp, wpthlp2, wp2thlp, wprtpthlp, wpthvp, wp2thvp, wp2rcp

      USE variables_diagnostic_module, ONLY: thvm, em, lscale, lscale_up, lscale_down, tau_zm, tau_zt, kh_zm, kh_zt, vg, ug, um_ref, vm_ref
      USE variables_diagnostic_module, ONLY: wp2_zt, thlp2_zt, wpthlp_zt, wprtp_zt, rtp2_zt, rtpthlp_zt, up2_zt, vp2_zt, upwp_zt, vpwp_zt, rtm_ref, thlm_ref

      USE variables_diagnostic_module, ONLY: wpedsclrp, sclrpthvp, sclrprcp, wp2sclrp, wpsclrp2, wpsclrprtp, wpsclrpthlp, wp3_zm, skw_velocity, a3_coef, a3_coef_zt
      ...
      USE stats_type_utilities, ONLY: stat_update_var_pt, stat_update_var, stat_begin_update, stat_begin_update_pt, stat_end_update, stat_end_update_pt

      USE stats_variables, ONLY: irtp2_bt, ithlp2_bt, irtpthlp_bt, iwp2_bt, iwp3_bt, ivp2_bt, iup2_bt, iwprtp_bt, iwpthlp_bt, irtm_bt, ithlm_bt, ivm_bt, ium_bt, iwp4, irsat, irvm, irel_humidity, iwpthlp_zt, iskw_zt, iskw_zm

      USE stats_variables, ONLY: iwprtp_zt, iup2_zt, ivp2_zt, iupwp_zt, ivpwp_zt, ithlp2_sf, irtp2_sf, irtpthlp_sf, iup2_sf, ivp2_sf, iwp2_sf, l_stats_samp, l_stats, stats_zt, stats_zm, stats_sfc, irtm_spur_src, ithlm_spur_src
