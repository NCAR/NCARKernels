...
subroutine wv_sat_qsat_water_rkind_comp(t, p, es, qs, idx)
  !------------------------------------------------------------------!
  ! Purpose:                                                         !
...
end subroutine wv_sat_qsat_water_rkind_comp

subroutine wv_sat_qsat_water(t, p, es, qs, vlen, idx)
  !------------------------------------------------------------------!
  ! Purpose:                                                         !
  !   Calculate SVP over water at a given temperature, and then      !
  !   calculate and return saturation specific humidity.             !
...
subroutine wv_sat_qsat_ice_rkind_comp(t, p, es, qs, idx)
  !------------------------------------------------------------------!
  ! Purpose:                                                         !
...
end subroutine wv_sat_qsat_ice_rkind_comp

subroutine wv_sat_qsat_ice(t, p, es, qs, vlen, idx)
  !------------------------------------------------------------------!
  ! Purpose:                                                         !
  !   Calculate SVP over ice at a given temperature, and then        !
  !   calculate and return saturation specific humidity.             !
