...
module advance_windm_edsclrm_module
  ...
  subroutine advance_windm_edsclrm &
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: ium_ref, ivm_ref, ium_sdmp, ivm_sdmp, ium_ndg, ivm_ndg, iwindm_matrix_condt_num, stats_zt, l_stats_samp
...
!===============================================================================
  subroutine windm_edsclrm_lhs( dt, nu, wm_zt, Km_zm, wind_speed, u_star_sqd,  &
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: ium_ma, ium_ta, ivm_ma, ivm_ta, ztscr01, ztscr02, ztscr03, ztscr04, ztscr05, ztscr06, l_stats_samp
