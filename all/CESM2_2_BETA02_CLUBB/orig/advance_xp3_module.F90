...
module advance_xp3_module
  ...
  !-------------------------------------------------------------------------
    ...
    PRIVATE advance_xp3_simplified, term_tp_rhs, term_ac_rhs 
  ...
  subroutine advance_xp3_simplified( solve_type, dt, xm, & ! Intent(in)
    ...
    !
      ...
      USE stats_variables, ONLY: irtp3_bt, irtp3_tp, irtp3_ac, irtp3_dp, ithlp3_bt, ithlp3_tp, ithlp3_ac, ithlp3_dp, stats_zt, &
      &l_stats_samp 
