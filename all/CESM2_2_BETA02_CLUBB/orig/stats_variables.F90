...
!$omp   threadprivate(stats_tsamp, stats_tout)
  ...
  LOGICAL, public :: l_stats                       = .false., l_output_rad_files = .false. 
...
!$omp   imass_ice_cryst, ircm_icedfs, iu_T_cm)
  ...
  INTEGER, public :: irtm_bt = 0, irtm_ma = 0, irtm_ta = 0, irtm_forcing = 0, irtm_sdmp = 0, irtm_mfl = 0, irtm_tacl = 0, irtm_cl &
  &= 0, irtm_pd = 0, ithlm_bt = 0, ithlm_ma = 0, ithlm_ta = 0, ithlm_forcing = 0, ithlm_sdmp = 0, ithlm_mfl = 0, ithlm_tacl = 0, &
  &ithlm_cl = 0 
...
!$omp   iNG_INST, iT_in_K_mc, ihl_on_Cp_residual, iqto_residual  )
  ...
  INTEGER, public :: irho_zm = 0, isigma_sqd_w = 0, irho_ds_zm = 0, ithv_ds_zm = 0, iem = 0, ishear = 0, imean_w_up = 0, &
  &imean_w_down = 0, ifrad = 0 
...
!$omp   threadprivate(iwp2_sdmp, iwp2_pd, iwp2_cl, iwp2_sf, iwp2_splat)
  ...
  INTEGER, public :: iwprtp_bt = 0, iwprtp_ma = 0, iwprtp_ta = 0, iwprtp_tp = 0, iwprtp_ac = 0, iwprtp_bp = 0, iwprtp_pr1 = 0, &
  &iwprtp_pr2 = 0, iwprtp_pr3 = 0, iwprtp_dp1 = 0, iwprtp_mfl = 0, iwprtp_cl = 0, iwprtp_sicl = 0, iwprtp_pd = 0, iwprtp_forcing &
  &= 0 
...
!$omp   threadprivate(iwprtp_sicl, iwprtp_pd, iwprtp_forcing, iwprtp_mc)
  ...
  INTEGER, public :: iwpthlp_bt = 0, iwpthlp_ma = 0, iwpthlp_ta = 0, iwpthlp_tp = 0, iwpthlp_ac = 0, iwpthlp_bp = 0, iwpthlp_pr1 &
  &= 0, iwpthlp_pr2 = 0, iwpthlp_pr3 = 0, iwpthlp_dp1 = 0, iwpthlp_mfl = 0, iwpthlp_cl = 0, iwpthlp_sicl = 0, iwpthlp_forcing = 0 
...
!$omp   threadprivate(ivpwp_dp1, ivpwp_mfl, ivpwp_cl)
  ...
  INTEGER, public :: irtp2_bt = 0, irtp2_ma = 0, irtp2_ta = 0, irtp2_tp = 0, irtp2_dp1 = 0, irtp2_dp2 = 0, irtp2_pd = 0, irtp2_cl &
  &= 0, irtp2_sf = 0, irtp2_forcing = 0 
...
!$omp   threadprivate(irtp2_mc)
  ...
  INTEGER, public :: ithlp2_bt = 0, ithlp2_ma = 0, ithlp2_ta = 0, ithlp2_tp = 0, ithlp2_dp1 = 0, ithlp2_dp2 = 0, ithlp2_pd = 0, &
  &ithlp2_cl = 0, ithlp2_sf = 0, ithlp2_forcing = 0 
...
!$omp   threadprivate(ithlp2_forcing, ithlp2_mc)
  ...
  INTEGER, public :: irtpthlp_bt = 0, irtpthlp_ma = 0, irtpthlp_ta = 0, irtpthlp_tp1 = 0, irtpthlp_tp2 = 0, irtpthlp_dp1 = 0, &
  &irtpthlp_dp2 = 0, irtpthlp_cl = 0, irtpthlp_sf = 0, irtpthlp_forcing = 0 
...
!$omp   iwpthlp_sfc, iprecip_frac_tol )
  ...
  INTEGER, public :: ithlm_vert_avg = 0, irtm_vert_avg = 0, ium_vert_avg = 0, ivm_vert_avg = 0, iwp2_vert_avg = 0, iup2_vert_avg &
  &= 0, ivp2_vert_avg = 0, irtp2_vert_avg = 0, ithlp2_vert_avg = 0 
...
!$omp threadprivate(irtm_spur_src, ithlm_spur_src)
  ...
  INTEGER, public :: iskw_velocity = 0, iwp3_zm = 0, ia3_coef = 0, ia3_coef_zt = 0 
...
!$omp threadprivate( irtp2_from_chi )
  ...
  TYPE(stats), target, public :: stats_zt, stats_zm, stats_rad_zt, stats_rad_zm, stats_sfc 
  ! Scratch space
...
!$omp threadprivate(stats_rad_zt, stats_rad_zm, stats_sfc)
  ...
  REAL(KIND=core_rknd), dimension(:), allocatable, public :: ztscr01, ztscr02, ztscr03, ztscr04, ztscr05, ztscr06, ztscr07, &
  &ztscr08, ztscr09, ztscr10, ztscr11, ztscr12, ztscr13, ztscr14, ztscr15, ztscr16 
...
!$omp threadprivate(ztscr21)
  ...
  REAL(KIND=core_rknd), dimension(:), allocatable, public :: zmscr01, zmscr02, zmscr03, zmscr04, zmscr05, zmscr06, zmscr07, &
  &zmscr08, zmscr09, zmscr10, zmscr11, zmscr12, zmscr13, zmscr14, zmscr15 
  ...
  REAL(KIND=core_rknd) :: kgenref_stats_tsamp = 0._core_rknd, kgenref_stats_tout   = 0._core_rknd 
  LOGICAL :: kgenref_l_stats_samp = .false., kgenref_l_stats_last = .false. 
  REAL(KIND=core_rknd), dimension(:), allocatable :: kgenref_ztscr01, kgenref_ztscr02, kgenref_ztscr03, kgenref_ztscr04, &
  &kgenref_ztscr05, kgenref_ztscr06, kgenref_ztscr07, kgenref_ztscr08, kgenref_ztscr09, kgenref_ztscr10, kgenref_ztscr11, &
  &kgenref_ztscr12, kgenref_ztscr13, kgenref_ztscr14, kgenref_ztscr15, kgenref_ztscr16 
  REAL(KIND=core_rknd), dimension(:), allocatable :: kgenref_zmscr01, kgenref_zmscr02, kgenref_zmscr03, kgenref_zmscr04, &
  &kgenref_zmscr05, kgenref_zmscr06, kgenref_zmscr07, kgenref_zmscr08, kgenref_zmscr09, kgenref_zmscr10, kgenref_zmscr11, &
  &kgenref_zmscr12, kgenref_zmscr13, kgenref_zmscr14, kgenref_zmscr15 
...
!$omp   threadprivate(zmscr16, zmscr17)
  ...
  SUBROUTINE kr_externs_in_stats_variables(kgen_unit) 
      ...
      READ (UNIT = kgen_unit) stats_tsamp 
      READ (UNIT = kgen_unit) stats_tout 
      READ (UNIT = kgen_unit) l_output_rad_files 
      READ (UNIT = kgen_unit) l_stats 
      READ (UNIT = kgen_unit) l_stats_samp 
      READ (UNIT = kgen_unit) l_stats_last 
      ...
      READ (UNIT = kgen_unit) iskthl_zt 
      READ (UNIT = kgen_unit) irtm 
      READ (UNIT = kgen_unit) irtp3 
      READ (UNIT = kgen_unit) ircm_supersat_adj 
      ...
      READ (UNIT = kgen_unit) imixt_frac_zm 
      READ (UNIT = kgen_unit) iw_2_zm 
      READ (UNIT = kgen_unit) ivarnce_w_2_zm 
      READ (UNIT = kgen_unit) ivarnce_w_1_zm 
      READ (UNIT = kgen_unit) iw_1_zm 
      ...
      READ (UNIT = kgen_unit) iwp3_splat 
      READ (UNIT = kgen_unit) iwp3_dp1 
      READ (UNIT = kgen_unit) iwp3_sdmp 
      ...
      READ (UNIT = kgen_unit) iwp3_pr3 
      READ (UNIT = kgen_unit) iwp3_bp1 
      READ (UNIT = kgen_unit) iwp3_bp2 
      READ (UNIT = kgen_unit) irtp3_ac 
      READ (UNIT = kgen_unit) ithlp3_ac 
      READ (UNIT = kgen_unit) ithlp3_bt 
      READ (UNIT = kgen_unit) ithlp3_tp 
      READ (UNIT = kgen_unit) irtp3_bt 
      READ (UNIT = kgen_unit) irtp3_dp 
      READ (UNIT = kgen_unit) ithlp3_dp 
      READ (UNIT = kgen_unit) irtp3_tp 
      ...
      READ (UNIT = kgen_unit) icorr_w_eta_1 
      READ (UNIT = kgen_unit) icorr_w_eta_2 
      READ (UNIT = kgen_unit) icorr_w_chi_2 
      READ (UNIT = kgen_unit) icovar_chi_eta_1 
      READ (UNIT = kgen_unit) icovar_chi_eta_2 
      READ (UNIT = kgen_unit) icorr_w_rt_2 
      READ (UNIT = kgen_unit) icorr_w_rt_1 
      READ (UNIT = kgen_unit) icorr_w_chi_1 
      READ (UNIT = kgen_unit) icorr_w_thl_1 
      READ (UNIT = kgen_unit) icorr_w_thl_2 
      ...
      READ (UNIT = kgen_unit) icorr_rt_thl_2 
      READ (UNIT = kgen_unit) icorr_rt_thl_1 
      READ (UNIT = kgen_unit) ichip2 
      READ (UNIT = kgen_unit) icorr_chi_eta_2 
      READ (UNIT = kgen_unit) icorr_chi_eta_1 
      READ (UNIT = kgen_unit) imin_f_rt 
      READ (UNIT = kgen_unit) if_w 
      READ (UNIT = kgen_unit) if_thl 
      READ (UNIT = kgen_unit) if_rt 
      READ (UNIT = kgen_unit) imin_f_w 
      READ (UNIT = kgen_unit) imax_f_w 
      READ (UNIT = kgen_unit) imax_f_rt 
      READ (UNIT = kgen_unit) imax_f_thl 
      READ (UNIT = kgen_unit) imin_f_thl 
      READ (UNIT = kgen_unit) iterm_wprtp2_explicit 
      READ (UNIT = kgen_unit) icoef_wp2rtp_implicit 
      READ (UNIT = kgen_unit) iterm_wpthlp2_explicit 
      READ (UNIT = kgen_unit) iterm_wp2rtp_explicit 
      READ (UNIT = kgen_unit) iterm_wp2thlp_explicit 
      READ (UNIT = kgen_unit) icoef_wp2thlp_implicit 
      READ (UNIT = kgen_unit) icoef_wprtp2_implicit 
      READ (UNIT = kgen_unit) iterm_wprtpthlp_explicit 
      READ (UNIT = kgen_unit) icoef_wprtpthlp_implicit 
      READ (UNIT = kgen_unit) icoef_wpthlp2_implicit 
      ...
      CALL kr_stats_variables_integer___dim1(isclrm, kgen_unit, "isclrm", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(isclrm_f, kgen_unit, "isclrm_f", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iedsclrm_f, kgen_unit, "iedsclrm_f", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iedsclrm, kgen_unit, "iedsclrm", .FALSE.) 
      READ (UNIT = kgen_unit) irc_coef_zm 
      READ (UNIT = kgen_unit) iwpthvp 
      READ (UNIT = kgen_unit) iskthl_zm 
      ...
      READ (UNIT = kgen_unit) ishear_sqd 
      READ (UNIT = kgen_unit) ic6thl_skw_fnc 
      READ (UNIT = kgen_unit) ic1_skw_fnc 
      READ (UNIT = kgen_unit) ibrunt_vaisala_freq_sqd 
      READ (UNIT = kgen_unit) igamma_skw_fnc 
      READ (UNIT = kgen_unit) irichardson_num 
      READ (UNIT = kgen_unit) icoef_wp4_implicit 
      ...
      READ (UNIT = kgen_unit) iwp2_splat 
      READ (UNIT = kgen_unit) iwp2_pd 
      READ (UNIT = kgen_unit) iwp2_ma 
      READ (UNIT = kgen_unit) iwp2_sdmp 
      ...
      READ (UNIT = kgen_unit) iupwp_bp 
      READ (UNIT = kgen_unit) iupwp_tp 
      READ (UNIT = kgen_unit) iupwp_bt 
      READ (UNIT = kgen_unit) iupwp_mfl 
      READ (UNIT = kgen_unit) iupwp_ac 
      READ (UNIT = kgen_unit) iupwp_pr1 
      READ (UNIT = kgen_unit) iupwp_pr3 
      READ (UNIT = kgen_unit) iupwp_pr2 
      READ (UNIT = kgen_unit) iupwp_ta 
      READ (UNIT = kgen_unit) iupwp_dp1 
      READ (UNIT = kgen_unit) iupwp_pr4 
      READ (UNIT = kgen_unit) iupwp_ma 
      READ (UNIT = kgen_unit) iupwp_cl 
      READ (UNIT = kgen_unit) ivpwp_tp 
      READ (UNIT = kgen_unit) ivpwp_cl 
      READ (UNIT = kgen_unit) ivpwp_bp 
      READ (UNIT = kgen_unit) ivpwp_mfl 
      READ (UNIT = kgen_unit) ivpwp_ta 
      READ (UNIT = kgen_unit) ivpwp_bt 
      READ (UNIT = kgen_unit) ivpwp_ma 
      READ (UNIT = kgen_unit) ivpwp_pr4 
      READ (UNIT = kgen_unit) ivpwp_ac 
      READ (UNIT = kgen_unit) ivpwp_dp1 
      READ (UNIT = kgen_unit) ivpwp_pr1 
      READ (UNIT = kgen_unit) ivpwp_pr2 
      READ (UNIT = kgen_unit) ivpwp_pr3 
      ...
      READ (UNIT = kgen_unit) ivp2_splat 
      READ (UNIT = kgen_unit) ivp2_pr1 
      READ (UNIT = kgen_unit) ivp2_pr2 
      READ (UNIT = kgen_unit) iup2_splat 
      ...
      CALL kr_stats_variables_integer___dim1(isclrpthlp, kgen_unit, "isclrpthlp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iwp2sclrp, kgen_unit, "iwp2sclrp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(isclrp2, kgen_unit, "isclrp2", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iwpsclrp2, kgen_unit, "iwpsclrp2", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iwpsclrprtp, kgen_unit, "iwpsclrprtp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(isclrprtp, kgen_unit, "isclrprtp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(isclrprcp, kgen_unit, "isclrprcp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(isclrpthvp, kgen_unit, "isclrpthvp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iwpsclrp, kgen_unit, "iwpsclrp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iwpsclrpthlp, kgen_unit, "iwpsclrpthlp", .FALSE.) 
      CALL kr_stats_variables_integer___dim1(iwpedsclrp, kgen_unit, "iwpedsclrp", .FALSE.) 
      ...
      CALL kr_stats_type_stats(stats_rad_zm, kgen_unit, "stats_rad_zm", .FALSE.) 
      CALL kr_stats_type_stats(stats_sfc, kgen_unit, "stats_sfc", .FALSE.) 
      CALL kr_stats_type_stats(stats_rad_zt, kgen_unit, "stats_rad_zt", .FALSE.) 
      CALL kr_stats_type_stats(stats_zt, kgen_unit, "stats_zt", .FALSE.) 
      CALL kr_stats_type_stats(stats_zm, kgen_unit, "stats_zm", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr16, kgen_unit, "ztscr16", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr14, kgen_unit, "ztscr14", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr15, kgen_unit, "ztscr15", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr12, kgen_unit, "ztscr12", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr13, kgen_unit, "ztscr13", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr10, kgen_unit, "ztscr10", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr11, kgen_unit, "ztscr11", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr09, kgen_unit, "ztscr09", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr08, kgen_unit, "ztscr08", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr01, kgen_unit, "ztscr01", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr03, kgen_unit, "ztscr03", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr02, kgen_unit, "ztscr02", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr05, kgen_unit, "ztscr05", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr04, kgen_unit, "ztscr04", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr07, kgen_unit, "ztscr07", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(ztscr06, kgen_unit, "ztscr06", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr11, kgen_unit, "zmscr11", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr10, kgen_unit, "zmscr10", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr15, kgen_unit, "zmscr15", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr08, kgen_unit, "zmscr08", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr09, kgen_unit, "zmscr09", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr12, kgen_unit, "zmscr12", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr13, kgen_unit, "zmscr13", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr14, kgen_unit, "zmscr14", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr02, kgen_unit, "zmscr02", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr03, kgen_unit, "zmscr03", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr01, kgen_unit, "zmscr01", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr06, kgen_unit, "zmscr06", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr07, kgen_unit, "zmscr07", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr04, kgen_unit, "zmscr04", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(zmscr05, kgen_unit, "zmscr05", .FALSE.) 
  ...
  SUBROUTINE kr_externs_out_stats_variables(kgen_unit) 
      ...
      LOGICAL :: kgen_istrue 
      REAL(KIND=8) :: kgen_array_sum 
      READ (UNIT = kgen_unit) kgenref_stats_tsamp 
      READ (UNIT = kgen_unit) kgenref_stats_tout 
      READ (UNIT = kgen_unit) kgenref_l_stats_samp 
      READ (UNIT = kgen_unit) kgenref_l_stats_last 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr16, kgen_unit, "kgenref_ztscr16", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr14, kgen_unit, "kgenref_ztscr14", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr15, kgen_unit, "kgenref_ztscr15", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr12, kgen_unit, "kgenref_ztscr12", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr13, kgen_unit, "kgenref_ztscr13", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr10, kgen_unit, "kgenref_ztscr10", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr11, kgen_unit, "kgenref_ztscr11", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr09, kgen_unit, "kgenref_ztscr09", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr08, kgen_unit, "kgenref_ztscr08", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr01, kgen_unit, "kgenref_ztscr01", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr03, kgen_unit, "kgenref_ztscr03", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr02, kgen_unit, "kgenref_ztscr02", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr05, kgen_unit, "kgenref_ztscr05", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr04, kgen_unit, "kgenref_ztscr04", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr07, kgen_unit, "kgenref_ztscr07", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_ztscr06, kgen_unit, "kgenref_ztscr06", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr11, kgen_unit, "kgenref_zmscr11", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr10, kgen_unit, "kgenref_zmscr10", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr15, kgen_unit, "kgenref_zmscr15", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr08, kgen_unit, "kgenref_zmscr08", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr09, kgen_unit, "kgenref_zmscr09", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr12, kgen_unit, "kgenref_zmscr12", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr13, kgen_unit, "kgenref_zmscr13", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr14, kgen_unit, "kgenref_zmscr14", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr02, kgen_unit, "kgenref_zmscr02", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr03, kgen_unit, "kgenref_zmscr03", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr01, kgen_unit, "kgenref_zmscr01", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr06, kgen_unit, "kgenref_zmscr06", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr07, kgen_unit, "kgenref_zmscr07", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr04, kgen_unit, "kgenref_zmscr04", .FALSE.) 
      CALL kr_stats_variables_real__core_rknd_dim1(kgenref_zmscr05, kgen_unit, "kgenref_zmscr05", .FALSE.) 
  ...
  SUBROUTINE kv_externs_stats_variables(check_status) 
      ...
      CALL kv_stats_variables_real__core_rknd("stats_tsamp", check_status, stats_tsamp, kgenref_stats_tsamp) 
      CALL kv_stats_variables_real__core_rknd("stats_tout", check_status, stats_tout, kgenref_stats_tout) 
      CALL kv_stats_variables_logical__("l_stats_samp", check_status, l_stats_samp, kgenref_l_stats_samp) 
      CALL kv_stats_variables_logical__("l_stats_last", check_status, l_stats_last, kgenref_l_stats_last) 
  ...
  SUBROUTINE kr_stats_variables_integer___dim1(var, kgen_unit, printname, printvar) 
  ...
  SUBROUTINE kr_stats_variables_real__core_rknd_dim1(var, kgen_unit, printname, printvar) 
  ...
  !verify state subroutine for kv_stats_variables_real__core_rknd 
  RECURSIVE SUBROUTINE kv_stats_variables_real__core_rknd(varname, check_status, var, kgenref_var) 
  ...
  END SUBROUTINE kv_stats_variables_real__core_rknd 
    
  !verify state subroutine for kv_stats_variables_logical__ 
  RECURSIVE SUBROUTINE kv_stats_variables_logical__(varname, check_status, var, kgenref_var) 
      CHARACTER(LEN=*), INTENT(IN) :: varname 
      TYPE(check_t), INTENT(INOUT) :: check_status 
  ...
  END SUBROUTINE kv_stats_variables_logical__ 
