...
module new_tsdadg_pdf
  ...
  ! PDF.
    ...
    PUBLIC tsdadg_pdf_driver, calc_setter_parameters, calc_l_x_skx_fnc 

    PRIVATE calc_respnder_parameters 
  ...
  subroutine tsdadg_pdf_driver( wm, rtm, thlm, wp2, rtp2, thlp2,   & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: one, zero, fstderr 
  ...
  subroutine calc_setter_parameters( xm, xp2, Skx, sgn_wpxp,        & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: four, three, one, one_half, zero, eps 
  ...
  subroutine calc_L_x_Skx_fnc( Skx, sgn_wpxp,            & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: four, zero 
  ...
  subroutine calc_respnder_parameters( xm, xp2, Skx, sgn_wpxp,       & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: four, three, one, zero, eps 
