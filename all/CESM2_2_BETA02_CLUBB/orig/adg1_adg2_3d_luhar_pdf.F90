...
module adg1_adg2_3d_luhar_pdf
  ...
  !-------------------------------------------------------------------------
    ...
    PUBLIC adg1_pdf_driver, adg2_pdf_driver, luhar_3d_pdf_driver, adg1_w_closure, calc_luhar_params, close_luhar_pdf 

    PRIVATE adg1_adg2_responder_params, backsolve_luhar_params, max_cubic_root 
  ...
  subroutine ADG1_pdf_driver( wm, rtm, thlm, wp2, rtp2, thlp2,         & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: rt_tol, thl_tol 
  ...
  subroutine ADG2_pdf_driver( wm, rtm, thlm, wp2, rtp2, thlp2,         & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: one, w_tol_sqd, rt_tol, thl_tol 
  ...
  subroutine ADG1_w_closure( wm, wp2, Skw, sigma_sqd_w, &        ! In
    ...
    !
      ...
      USE constants_clubb, ONLY: four, one, one_half, zero, w_tol_sqd 
  ...
  subroutine calc_Luhar_params( nz, Skx, wpxp,            & ! In
    ...
    !
      ...
      USE constants_clubb, ONLY: four, three, one, two_thirds, one_half, one_third, zero 
  ...
  subroutine ADG1_ADG2_responder_params( xm, xp2, wp2, sqrt_wp2, &        ! In
    ...
    !
      ...
      USE constants_clubb, ONLY: two, one, two_thirds, one_half, zero, zero_threshold, w_tol_sqd 
...
!          x_2_n = - ( wpxp / ( sqrt( wp2 ) * sqrt( xp2 ) ) ) / w_1_n
  ...
  subroutine backsolve_Luhar_params( Sk_max, Skx,          & ! In
    ...
    !
      ...
      USE constants_clubb, ONLY: nine, six, five, four, three, two, one, one_half, zero, eps 
  ...
  result( max_root )
    ...
    !
      ...
      USE calc_roots, ONLY: cubic_solve, quadratic_solve 
