...
module new_pdf
  ...
  !-------------------------------------------------------------------------
    ...
    PUBLIC calc_mixture_fraction, calc_setter_var_params, calc_responder_params, calc_limits_f_x_responder, &
    &calc_coef_wp4_implicit, calc_coef_wpxp2_implicit, calc_coefs_wp2xp_semiimpl, calc_coefs_wpxpyp_semiimpl 
  ...
  result( mixt_frac )
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: thirty_six, eighteen, twelve, six, four, three, two, one, zero, fstderr 
  ...
  subroutine calc_responder_params( xm, xp2, Skx, sgn_wpxp,       & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: three, one, zero 
  ...
  subroutine calc_limits_F_x_responder( mixt_frac, Skx, sgn_wpxp,  & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: three, two, one, zero 
  ...
  result( coef_wpxp2_implicit )
    ...
    !
      ...
      USE constants_clubb, ONLY: two, one, zero 
