...
module clip_explicit
    ...
    PUBLIC clip_covars_denom, clip_covar, clip_variance, clip_variance_level, clip_skewness, clip_skewness_core 
...
!    clip_scalar = 7, &       ! Named constant for scalar clipping
  ...
  subroutine clip_covar( solve_type, l_first_clip_ts,  & 
    ...
    !
      ...
      USE constants_clubb, ONLY: max_mag_correlation, max_mag_correlation_flux 

      USE model_flags, ONLY: l_predict_upwp_vpwp 

      USE clubb_precision, ONLY: core_rknd 

      USE stats_type_utilities, ONLY: stat_begin_update, stat_modify, stat_end_update 

      USE stats_variables, ONLY: stats_zm, iwprtp_cl, iwpthlp_cl, irtpthlp_cl, iupwp_cl, ivpwp_cl, l_stats_samp 
  ...
  subroutine clip_variance( solve_type, dt, threshold, &
    ...
    !
      ...
      USE stats_variables, ONLY: stats_zm, iwp2_cl, irtp2_cl, ithlp2_cl, iup2_cl, ivp2_cl, l_stats_samp 
  ...
  subroutine clip_variance_level( solve_type, dt, threshold, level, &
    ...
    !
      ...
      USE stats_type_utilities, ONLY: stat_begin_update_pt, stat_end_update_pt 
  ...
  subroutine clip_skewness( dt, sfc_elevation, wp2_zt, wp3 )
    ...
    !
      ...
      USE stats_variables, ONLY: stats_zt, iwp3_cl, l_stats_samp 
...
!
      ...
      USE parameters_tunable, ONLY: skw_max_mag 
