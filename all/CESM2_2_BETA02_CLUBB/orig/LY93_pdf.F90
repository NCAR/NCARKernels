...
module LY93_pdf
  ...
  !-------------------------------------------------------------------------
    ...
    PUBLIC ly93_driver, calc_mixt_frac_ly93, calc_params_ly93 
  ...
  result( mixt_frac )
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: one, three_fourths, one_half, zero 
  ...
  subroutine calc_params_LY93( xm, xp2, Skx, mixt_frac,     & ! In
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: three, one, one_third, zero 
