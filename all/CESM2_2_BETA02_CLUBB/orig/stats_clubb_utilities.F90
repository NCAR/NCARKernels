...
module stats_clubb_utilities
  ...
  subroutine stats_accumulate & 
    ...
    !
      ...
      &iwm_zt, iwm_zm, iug, ivg, icloud_frac, iice_supersat_frac, ircm_in_layer, icloud_cover, ircm_supersat_adj 
      ...
      USE stats_variables, ONLY: iwp2thvp, iwp2rcp, iwprtpthlp, irc_coef, isigma_sqd_w_zt, irho, irsat, irsati 
      ...
      &icovar_chi_eta_1, icovar_chi_eta_2, icorr_w_chi_1, icorr_w_chi_2, icorr_w_eta_1, icorr_w_eta_2, icorr_chi_eta_1, &
      &icorr_chi_eta_2, icrt_1, icrt_2, icthl_1, icthl_2, icorr_w_rt_1, icorr_w_rt_2, icorr_w_thl_1, icorr_w_thl_2, &
      &icorr_rt_thl_1, icorr_rt_thl_2, ichi 

      USE stats_variables, ONLY: iwp2_zt, ithlp2_zt, iwpthlp_zt, iwprtp_zt, irtp2_zt, irtpthlp_zt, iup2_zt, ivp2_zt, iupwp_zt, &
      &ivpwp_zt, iwp2, irtp2, irtp3, ithlp2, ithlp3, irtpthlp, iwprtp, iwpthlp, iwp4, iwpthvp, irtpthvp 

      USE stats_variables, ONLY: ithlpthvp, itau_zm, ikh_zm, iwprcp, irc_coef_zm, ithlprcp, irtprcp, ircp2, iupwp, ivpwp, iup2, &
      ...
      USE stats_variables, ONLY: iw_1_zm, iw_2_zm, ivarnce_w_1_zm, ivarnce_w_2_zm, imixt_frac_zm 
      ...
      &tau_zt, kh_zt, wp2rcp, wprtpthlp, sigma_sqd_w_zt, rsat 

      USE variables_diagnostic_module, ONLY: wp2_zt, thlp2_zt, wpthlp_zt, wprtp_zt, rtp2_zt, rtpthlp_zt, up2_zt, vp2_zt, upwp_zt, &
      &vpwp_zt, wp4, tau_zm, kh_zm, thlprcp, rtprcp, rcp2, em, frad, sclrprcp, wp2sclrp, wpsclrp2, wpsclrprtp, wpsclrpthlp, &
      &wpedsclrp 
