...
module mixing_length
  ...
  subroutine compute_mixing_length( thvm, thlm, &
    ...
    ! 
      ...
      USE constants_clubb, ONLY: cp, rd, ep, ep1, ep2, lv, grav, fstderr, zero_threshold, eps 
...
!===============================================================================
  ...
  !-----------------------------------------------------------------------
      ...
      USE saturation, ONLY: sat_mixrat_liq, sat_mixrat_liq_lookup, sat_mixrat_ice 

      USE constants_clubb, ONLY: zero, one, t_freeze_k 
