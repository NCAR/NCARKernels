...
module advance_xp2_xpyp_module
  ...
  !-----------------------------------------------------------------------
    ...
    PUBLIC advance_xp2_xpyp, update_xp2_mc 

    PRIVATE xp2_xpyp_lhs, xp2_xpyp_solve, xp2_xpyp_uv_rhs, xp2_xpyp_rhs, xp2_xpyp_implicit_stats, term_tp, term_dp1_lhs, &
  ...
  subroutine advance_xp2_xpyp( tau_zm, wm_zm, rtm, wprtp, thlm,        & ! In
    ...
    !  
      ...
      USE constants_clubb, ONLY: w_tol_sqd, rt_tol, thl_tol, max_mag_correlation_flux, cloud_frac_min, fstderr, one, two_thirds, &
      &one_half, one_third, zero, zero_threshold 

      USE model_flags, ONLY: l_hole_fill, l_single_c2_skw, l_explicit_turbulent_adv_xpyp, l_upwind_xpyp_ta, &
      &l_min_xp2_from_corr_wx, l_c2_cloud_frac 

      USE parameters_tunable, ONLY: c2rt, c2thl, c2rtthl, c_k2, nu2_vert_res_dep, c_k9, nu9_vert_res_dep, beta, c4, c14, c5, c2, &
      &c2b, c2c 

      USE parameters_model, ONLY: sclr_dim, sclr_tol 
      ...
      USE clip_explicit, ONLY: clip_covar, clip_variance, clip_variance_level, clip_sclrp2, clip_sclrprtp, clip_sclrpthlp 

      USE sponge_layer_damping, ONLY: up2_vp2_sponge_damp_settings, up2_vp2_sponge_damp_profile, sponge_damp_xp2 
      
      USE stats_type_utilities, ONLY: stat_begin_update, stat_end_update, stat_modify, stat_update_var 

      USE error_code, ONLY: clubb_at_least_debug_level, err_code, clubb_fatal_error 

      USE stats_variables, ONLY: stats_zm, stats_zt, icoef_wprtp2_implicit, iterm_wprtp2_explicit, icoef_wpthlp2_implicit, &
      &iterm_wpthlp2_explicit, icoef_wprtpthlp_implicit, iterm_wprtpthlp_explicit, irtp2_cl, iup2_sdmp, ivp2_sdmp, iup2_cl, &
      &ivp2_cl, l_stats_samp 
...
!
  ...
  ! 
      ...
      USE constants_clubb, ONLY: gamma_over_implicit_ts, one 

      USE turbulent_adv_pdf, ONLY: xpyp_term_ta_pdf_lhs_all 

      USE mean_adv, ONLY: term_ma_zm_lhs_all 

      USE diffusion, ONLY: diffusion_zm_lhs_all 
      ...
      USE stats_variables, ONLY: l_stats_samp, zmscr01, zmscr02, zmscr03, zmscr04, zmscr05, zmscr06, zmscr07, zmscr08, zmscr09, &
      &zmscr10, irtp2_ma, irtp2_ta, irtp2_dp1, irtp2_dp2, ithlp2_ma, ithlp2_ta, ithlp2_dp1, ithlp2_dp2, irtpthlp_ma, irtpthlp_ta, &
      &irtpthlp_dp1, irtpthlp_dp2, iup2_ma, iup2_ta, iup2_dp2, ivp2_ma, ivp2_ta, ivp2_dp2 
  ...
  subroutine xp2_xpyp_solve( solve_type, nrhs, rhs, lhs, xapxbp )
    ...
    !
      ...
      USE lapack_wrap, ONLY: tridag_solve, tridag_solvex 
!        band_solve
      ...
      USE stats_variables, ONLY: stats_sfc, irtp2_matrix_condt_num, ithlp2_matrix_condt_num, irtpthlp_matrix_condt_num, &
      &iup2_vp2_matrix_condt_num, l_stats_samp 
  ...
  subroutine xp2_xpyp_implicit_stats( solve_type, xapxbp )
    ...
    !
      ...
      USE stats_type_utilities, ONLY: stat_end_update_pt, stat_update_var_pt 

      USE stats_variables, ONLY: stats_zm, irtp2_dp1, irtp2_dp2, irtp2_ta, irtp2_ma, ithlp2_dp1, ithlp2_dp2, ithlp2_ta, &
      &ithlp2_ma, irtpthlp_dp1, irtpthlp_dp2, irtpthlp_ta, irtpthlp_ma, iup2_dp1, iup2_dp2, iup2_ta, iup2_ma, iup2_pr1, ivp2_dp1 

      USE stats_variables, ONLY: ivp2_dp2, ivp2_ta, ivp2_ma, ivp2_pr1, zmscr01, zmscr02, zmscr03, zmscr04, zmscr05, zmscr06, &
      &zmscr07, zmscr08, zmscr09, zmscr10, zmscr11 
  ...
  ! 
      ...
      USE constants_clubb, ONLY: gamma_over_implicit_ts, w_tol_sqd, one, two_thirds, one_third, zero 
      ...
      USE stats_type_utilities, ONLY: stat_begin_update_pt, stat_update_var_pt, stat_modify_pt 

      USE stats_variables, ONLY: ivp2_ta, ivp2_tp, ivp2_dp1, ivp2_pr1, ivp2_pr2, ivp2_splat, iup2_ta, iup2_tp, iup2_dp1, &
      &iup2_pr1, iup2_pr2, iup2_splat, stats_zm, zmscr01, zmscr11, l_stats_samp 
  ...
  ! 
      ...
      USE stats_variables, ONLY: irtp2_ta, irtp2_tp, irtp2_dp1, irtp2_forcing, ithlp2_ta, ithlp2_tp, ithlp2_dp1, ithlp2_forcing, &
      &irtpthlp_ta, irtpthlp_tp1, irtpthlp_tp2, irtpthlp_dp1, irtpthlp_forcing, stats_zm, l_stats_samp 
  ...
  result( rhs )
    ...
    !
      ...
      USE constants_clubb, ONLY: w_tol_sqd, one_third 
  ...
  result( rhs )
    ...
    !
      ...
      USE constants_clubb, ONLY: grav, one, two_thirds, zero, zero_threshold 
  ...
  subroutine find_endpts_for_vert_avg_winds &
    ...
    !-----------------------------------------------------------------------
      ...
      USE interpolation, ONLY: binary_search, lin_interpolate_two_points 
  ...
  subroutine pos_definite_variances( solve_type, dt, tolerance, &
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: stats_zm, l_stats_samp, irtp2_pd, ithlp2_pd, iup2_pd, ivp2_pd 
      USE stats_type_utilities, ONLY: stat_begin_update, stat_end_update 
  ...
  subroutine update_xp2_mc( nz, dt, cloud_frac, rcm, rvm, thlm,        &
    ...
    !variables on the zt grid, and the outputs are on the zm grid --storer
      ...
      USE constants_clubb, ONLY: cloud_frac_min, cp, lv 
