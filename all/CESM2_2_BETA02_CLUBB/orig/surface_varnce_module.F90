...
module surface_varnce_module
  ...
  subroutine calc_surface_varnce( upwp_sfc, vpwp_sfc, wpthlp_sfc, wprtp_sfc, & 
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: four, two, one, two_thirds, one_third, one_fourth, zero, grav, eps, w_tol_sqd, thl_tol, rt_tol, &
      &max_mag_correlation_flux, fstderr 
      ...
      USE parameters_tunable, ONLY: up2_vp2_factor 
