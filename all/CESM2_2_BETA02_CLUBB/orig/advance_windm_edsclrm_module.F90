...
module advance_windm_edsclrm_module
    ...
    PRIVATE windm_edsclrm_solve, compute_uv_tndcy, windm_edsclrm_lhs, windm_edsclrm_rhs 
  ...
  subroutine advance_windm_edsclrm &
    ...
    !-----------------------------------------------------------------------
      ...
      USE parameters_model, ONLY: ts_nudge, edsclr_dim 

      USE parameters_tunable, ONLY: nu10_vert_res_dep 

      USE model_flags, ONLY: l_predict_upwp_vpwp, l_uv_nudge, l_tke_aniso 

      USE clubb_precision, ONLY: core_rknd 

      USE stats_type_utilities, ONLY: stat_begin_update, stat_end_update, stat_update_var 

      USE stats_variables, ONLY: ium_ref, ivm_ref, ium_sdmp, ivm_sdmp, ium_ndg, ivm_ndg, iwindm_matrix_condt_num, stats_zt, &
      &l_stats_samp 
      ...
      USE constants_clubb, ONLY: one_half, zero, fstderr, eps 

      USE sponge_layer_damping, ONLY: uv_sponge_damp_settings, uv_sponge_damp_profile, sponge_damp_xm 
...
!HPF$ INDEPENDENT, REDUCTION(wpedsclrp)
  ...
  subroutine windm_edsclrm_solve( nrhs, ixm_matrix_condt_num, &
    ...
    !
      ...
      USE stats_variables, ONLY: stats_sfc, l_stats_samp 
  ...
  subroutine windm_edsclrm_implicit_stats( solve_type, xm )
    ...
    !-----------------------------------------------------------------------
      ...
      USE stats_variables, ONLY: ium_ma, ium_ta, ivm_ma, ivm_ta, ztscr01, ztscr02, ztscr03, ztscr04, ztscr05, ztscr06, stats_zt 
  ...
  subroutine compute_uv_tndcy( solve_type, fcor, perp_wind_m, perp_wind_g, xm_forcing, &
    ...
    !
      ...
      USE stats_variables, ONLY: ium_gf, ium_cf, ivm_gf, ivm_cf, ium_f, ivm_f, stats_zt, l_stats_samp 
...
!======================================================================================
  ...
  subroutine windm_edsclrm_lhs( dt, nu, wm_zt, Km_zm, wind_speed, u_star_sqd,  &
    ...
    !
      ...
      USE diffusion, ONLY: diffusion_zt_lhs, diffusion_zt_lhs_all 

      USE mean_adv, ONLY: term_ma_zt_lhs_all 

      USE stats_variables, ONLY: ium_ma, ium_ta, ivm_ma, ivm_ta, ztscr01, ztscr02, ztscr03, ztscr04, ztscr05, ztscr06, &
      &l_stats_samp 
  ...
  subroutine windm_edsclrm_rhs( solve_type, dt, nu, Km_zm, xm, xm_tndcy,  &
    ...
    ! 
      ...
      USE stats_variables, ONLY: ium_ta, ivm_ta, stats_zt, l_stats_samp 

      USE stats_type_utilities, ONLY: stat_begin_update_pt, stat_modify_pt 
