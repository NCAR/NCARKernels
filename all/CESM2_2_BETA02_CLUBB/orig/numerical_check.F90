...
!       Joshua Fasching March 2008
    ...
    PUBLIC is_nan_2d, parameterization_check, surface_varnce_check, pdf_closure_check, length_check, is_nan_sclr, &
...
!
      ...
      USE error_code, ONLY: clubb_at_least_debug_level, err_code, clubb_no_error, clubb_fatal_error 
