...
!------------------------------------------------------------------------
    ...
    PUBLIC set_boundary_conditions_lhs, set_boundary_conditions_rhs, calc_stability_correction, calc_brunt_vaisala_freq_sqd, &
    &compute_cx_fnc_richardson, term_wp2_splat, term_wp3_splat 
  ...
  !
      ...
      USE parameters_tunable, ONLY: lambda0_stability_coef 
  ...
  !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: grav, lv, cp, rd, ep, one 
      ...
      USE model_flags, ONLY: l_brunt_vaisala_freq_moist, l_use_thvm_in_bv_freq 
...
!===============================================================================
  ...
  !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: one_fourth, one_third, one 

      USE interpolation, ONLY: linear_interp_factor 

      USE stats_variables, ONLY: irichardson_num, ibrunt_vaisala_freq_sqd, ishear_sqd, stats_zm, l_stats_samp 
 ...
 !============================================================================
  ...
  !
      ...
      USE constants_clubb, ONLY: three, five 
