...
#ifdef _NEWINDEX 
      nc = ceiling(real(avec_len)/real(blklen)) 
      do i=1,nc
      do k = (i-1)*blklen+1,min(i*blklen,avec_len)
#else
      do k = 1,avec_len
#endif
         ...
         prod(k,139) = (.200_r8*rxt(k,333)*y(k,77) +.200_r8*rxt(k,339)*y(k,78) + &
                 .100_r8*rxt(k,357)*y(k,83))*y(k,1) + (.250_r8*rxt(k,301)*y(k,48) + &
                 .250_r8*rxt(k,349)*y(k,76))*y(k,24) +rxt(k,115)*y(k,4)*y(k,2)
         loss(k,146) = (rxt(k,116)* y(k,1) + 2._r8*rxt(k,117)* y(k,2) +rxt(k,115) &
         ...
         prod(k,146) = (rxt(k,1) +2.000_r8*rxt(k,2) +rxt(k,95) +rxt(k,96) +rxt(k,97) + &
                 2.000_r8*rxt(k,100) +rxt(k,107) +rxt(k,108) +rxt(k,109) + &
                 2.000_r8*rxt(k,112) +rxt(k,129)*y(k,3) +rxt(k,130)*y(k,3) + &
                 rxt(k,182)*y(k,8) +rxt(k,449)*y(k,130) +rxt(k,457)*y(k,129))*y(k,4) &
                  + (rxt(k,183)*y(k,9) +rxt(k,184)*y(k,10) +rxt(k,454)*y(k,128)) &
                 *y(k,8) + (rxt(k,461)*y(k,131) +1.150_r8*rxt(k,462)*y(k,128)) &
         ...
         prod(k,143) = (rxt(k,1) +rxt(k,179)*y(k,133))*y(k,4) +rxt(k,3)*y(k,1) &
                  +.850_r8*rxt(k,462)*y(k,132)*y(k,128) +rxt(k,20)*y(k,134)
         ...
         prod(k,129) = (rxt(k,163)*y(k,22) +rxt(k,167)*y(k,23) +rxt(k,173)*y(k,2) + &
                 2.000_r8*rxt(k,174)*y(k,1) +rxt(k,175)*y(k,24) +rxt(k,200)*y(k,11) + &
                 ...
                 .750_r8*rxt(k,349)*y(k,76))*y(k,24) + (rxt(k,4) + &
                 2.000_r8*rxt(k,116)*y(k,2) +2.000_r8*rxt(k,134)*y(k,3) + &
                 ...
                 2.000_r8*rxt(k,125)*y(k,4))*y(k,6) +rxt(k,133)*y(k,7)*y(k,3) &
         ...
         prod(k,115) = (rxt(k,17) +rxt(k,18) +rxt(k,209)*y(k,28) +rxt(k,233)*y(k,37) + &
                 rxt(k,266)*y(k,11) +rxt(k,267)*y(k,23) +rxt(k,268)*y(k,2))*y(k,19) &
                  + (.500_r8*rxt(k,290)*y(k,44) +.560_r8*rxt(k,311)*y(k,59) + &
                 .050_r8*rxt(k,333)*y(k,77) +.200_r8*rxt(k,339)*y(k,78) + &
                 .300_r8*rxt(k,357)*y(k,83))*y(k,1) + (.220_r8*rxt(k,340)*y(k,9) + &
                 .220_r8*rxt(k,342)*y(k,11) +.110_r8*rxt(k,344)*y(k,16) + &
                 .220_r8*rxt(k,345)*y(k,48))*y(k,79) + (.250_r8*rxt(k,375)*y(k,9) + &
                 .500_r8*rxt(k,376)*y(k,11) +.200_r8*rxt(k,378)*y(k,16) + &
                 .250_r8*rxt(k,379)*y(k,48))*y(k,91) + (.350_r8*rxt(k,283)*y(k,135) + &
                 rxt(k,306)*y(k,53) +rxt(k,327)*y(k,68))*y(k,23) + (rxt(k,74) + &
                 rxt(k,328)*y(k,11))*y(k,68) +rxt(k,251)*y(k,108)*y(k,28) +rxt(k,61) &
                 *y(k,50) +rxt(k,79)*y(k,52) +2.000_r8*rxt(k,82)*y(k,53) &
                  +.700_r8*rxt(k,68)*y(k,77) +1.340_r8*rxt(k,67)*y(k,78) &
                  +.450_r8*rxt(k,81)*y(k,86) +rxt(k,76)*y(k,90) +rxt(k,453)*y(k,130) &
                 *y(k,126)
         ...
         prod(k,105) = (rxt(k,180)*y(k,133) +rxt(k,458)*y(k,129))*y(k,2) &
                  + (.200_r8*rxt(k,461)*y(k,131) +1.100_r8*rxt(k,463)*y(k,127)) &
         ...
         loss(k,134) = (rxt(k,189)* y(k,1) +rxt(k,187)* y(k,2) +rxt(k,183)* y(k,8) &
                 ...
                 * y(k,128) +rxt(k,278)* y(k,137) + rxt(k,6) + rxt(k,7) &
                  + het_rates(k,9))* y(k,9)
         prod(k,134) = (rxt(k,8) +.500_r8*rxt(k,402) +2.000_r8*rxt(k,185)*y(k,8) + &
                 rxt(k,190)*y(k,2))*y(k,10) + (rxt(k,179)*y(k,133) +rxt(k,182)*y(k,8)) &
                 *y(k,4) +2.000_r8*rxt(k,132)*y(k,7)*y(k,3) +rxt(k,181)*y(k,23)*y(k,8) &
         ...
         prod(k,144) = (rxt(k,187)*y(k,2) +rxt(k,188)*y(k,24) +rxt(k,189)*y(k,1) + &
                 2.000_r8*rxt(k,197)*y(k,11) +rxt(k,216)*y(k,30) +rxt(k,237)*y(k,38) + &
                 ...
                 .920_r8*rxt(k,359)*y(k,88) +1.206_r8*rxt(k,365)*y(k,89) + &
                 .900_r8*rxt(k,372)*y(k,84) +rxt(k,375)*y(k,91) + &
                 .900_r8*rxt(k,383)*y(k,96) +.900_r8*rxt(k,390)*y(k,100) + &
                 .900_r8*rxt(k,393)*y(k,103) +rxt(k,397)*y(k,106))*y(k,9) &
                  + (rxt(k,12) +rxt(k,198)*y(k,2) +rxt(k,199)*y(k,23) + &
                 rxt(k,200)*y(k,24) +rxt(k,342)*y(k,79) +rxt(k,348)*y(k,76) + &
                 rxt(k,360)*y(k,88) +1.206_r8*rxt(k,366)*y(k,89) +rxt(k,370)*y(k,90) + &
                 rxt(k,376)*y(k,91) +rxt(k,396)*y(k,105))*y(k,11) + (rxt(k,15) + &
                 rxt(k,203) +rxt(k,202)*y(k,23))*y(k,13) + (rxt(k,9) +rxt(k,194)) &
                 *y(k,14) + (rxt(k,329)*y(k,82) +.400_r8*rxt(k,369)*y(k,90))*y(k,23) &
                  + (.600_r8*rxt(k,64) +rxt(k,308))*y(k,58) + (rxt(k,65) +rxt(k,354)) &
                 *y(k,81) +.700_r8*rxt(k,387)*y(k,98)*y(k,10) +rxt(k,11)*y(k,12) &
                  +.206_r8*rxt(k,367)*y(k,89)*y(k,24) +rxt(k,30)*y(k,35) +rxt(k,36) &
         ...
         loss(k,138) = (rxt(k,166)* y(k,1) +rxt(k,165)* y(k,2) +rxt(k,181)* y(k,8) &
                 ...
                 * y(k,20) +rxt(k,170)* y(k,21) + 2._r8*(rxt(k,168) +rxt(k,169)) &
         ...
         prod(k,138) = (rxt(k,161)*y(k,22) +rxt(k,174)*y(k,24) + &
                 .120_r8*rxt(k,290)*y(k,44) +.330_r8*rxt(k,311)*y(k,59) + &
                 .080_r8*rxt(k,333)*y(k,77) +.215_r8*rxt(k,339)*y(k,78) + &
                 .270_r8*rxt(k,357)*y(k,83) +.700_r8*rxt(k,395)*y(k,105))*y(k,1) &
                 ...
                 rxt(k,245)*y(k,40) +rxt(k,268)*y(k,19))*y(k,2) &
                  + (rxt(k,153)*y(k,15) +2.000_r8*rxt(k,131)*y(k,134) + &
                 rxt(k,156)*y(k,21) +rxt(k,157)*y(k,33) +rxt(k,158)*y(k,39) + &
                 rxt(k,159)*y(k,42))*y(k,3) + (.300_r8*rxt(k,275)*y(k,17) + &
                 .650_r8*rxt(k,283)*y(k,135) +.500_r8*rxt(k,296)*y(k,47) + &
                 .500_r8*rxt(k,320)*y(k,65) +.100_r8*rxt(k,346)*y(k,80))*y(k,23) &
                  + (2.000_r8*rxt(k,162)*y(k,22) +rxt(k,188)*y(k,9) + &
                 rxt(k,200)*y(k,11) +rxt(k,208)*y(k,28) +.206_r8*rxt(k,367)*y(k,89)) &
                 *y(k,24) + (rxt(k,19) +rxt(k,247)*y(k,141))*y(k,134) &
                  +.500_r8*rxt(k,402)*y(k,10) +rxt(k,11)*y(k,12) +rxt(k,14)*y(k,13) &
                  +rxt(k,16)*y(k,17) +2.000_r8*rxt(k,22)*y(k,25) +rxt(k,27)*y(k,34) &
         ...
         prod(k,135) = (rxt(k,196)*y(k,12) +rxt(k,229)*y(k,35) +rxt(k,309)*y(k,58) + &
                 .500_r8*rxt(k,355)*y(k,81))*y(k,23) + (rxt(k,191)*y(k,10) + &
                 ...
                 *y(k,35) +rxt(k,192)*y(k,10)*y(k,1) +rxt(k,250)*y(k,141)*y(k,12) &
                  +rxt(k,14)*y(k,13) +rxt(k,35)*y(k,41) +.400_r8*rxt(k,64)*y(k,58)
         ...
         prod(k,131) = (rxt(k,433) +rxt(k,439) +rxt(k,444) +rxt(k,435)*y(k,33) + &
                 ...
                 rxt(k,407)*y(k,157))*y(k,11) + (2.000_r8*rxt(k,400) + &
                 2.000_r8*rxt(k,432) +2.000_r8*rxt(k,438) +2.000_r8*rxt(k,443)) &
                 *y(k,14) + (rxt(k,434) +rxt(k,442) +rxt(k,445))*y(k,41) &
                  + (.500_r8*rxt(k,402) +rxt(k,195)*y(k,23))*y(k,10)
         ...
         loss(k,136) = (rxt(k,270)* y(k,9) + 2._r8*(rxt(k,272) +rxt(k,273))* y(k,16) &
         ...
         prod(k,136) = (rxt(k,299)*y(k,9) +.900_r8*rxt(k,302)*y(k,16) + &
                 2.000_r8*rxt(k,303)*y(k,48) +rxt(k,345)*y(k,79) +rxt(k,351)*y(k,76) + &
                 rxt(k,364)*y(k,88) +rxt(k,379)*y(k,91))*y(k,48) &
                  + (rxt(k,153)*y(k,3) +rxt(k,210)*y(k,28) +rxt(k,249)*y(k,141) + &
                 rxt(k,263)*y(k,23))*y(k,15) + (.700_r8*rxt(k,275)*y(k,17) + &
                 rxt(k,291)*y(k,49))*y(k,23) +.310_r8*rxt(k,311)*y(k,59)*y(k,1) &
                  +rxt(k,61)*y(k,50) +rxt(k,63)*y(k,54) +.400_r8*rxt(k,64)*y(k,58) &
                  +rxt(k,73)*y(k,63) +.300_r8*rxt(k,68)*y(k,77)
         ...
         prod(k,140) = (rxt(k,215)*y(k,30) +rxt(k,270)*y(k,9) + &
                 2.000_r8*rxt(k,272)*y(k,16) +rxt(k,273)*y(k,16) + &
                 .700_r8*rxt(k,294)*y(k,46) +rxt(k,302)*y(k,48) +rxt(k,315)*y(k,61) + &
                 .800_r8*rxt(k,324)*y(k,67) +.880_r8*rxt(k,344)*y(k,79) + &
                 2.000_r8*rxt(k,350)*y(k,76) +1.200_r8*rxt(k,363)*y(k,88) + &
                 .800_r8*rxt(k,378)*y(k,91))*y(k,16) + (.500_r8*rxt(k,286)*y(k,55) + &
                 rxt(k,318)*y(k,64) +rxt(k,322)*y(k,67) +.500_r8*rxt(k,331)*y(k,73) + &
                 .250_r8*rxt(k,340)*y(k,79) +rxt(k,347)*y(k,76) + &
                 .550_r8*rxt(k,359)*y(k,88) +.072_r8*rxt(k,365)*y(k,89) + &
                 .100_r8*rxt(k,372)*y(k,84) +.250_r8*rxt(k,375)*y(k,91))*y(k,9) &
                  + (rxt(k,274)*y(k,18) +.300_r8*rxt(k,275)*y(k,17) + &
                 .500_r8*rxt(k,304)*y(k,54) +.800_r8*rxt(k,305)*y(k,52) + &
                 rxt(k,309)*y(k,58) +.500_r8*rxt(k,355)*y(k,81))*y(k,23) &
                  + (rxt(k,290)*y(k,44) +.540_r8*rxt(k,311)*y(k,59) + &
                 .800_r8*rxt(k,333)*y(k,77) +.700_r8*rxt(k,339)*y(k,78) + &
                 .600_r8*rxt(k,357)*y(k,83))*y(k,1) + (.250_r8*rxt(k,342)*y(k,79) + &
                 rxt(k,348)*y(k,76) +.600_r8*rxt(k,360)*y(k,88) + &
                 .072_r8*rxt(k,366)*y(k,89))*y(k,11) + (.250_r8*rxt(k,345)*y(k,79) + &
                 rxt(k,351)*y(k,76) +.600_r8*rxt(k,364)*y(k,88) + &
                 .250_r8*rxt(k,379)*y(k,91))*y(k,48) + (rxt(k,154)*y(k,15) + &
                 rxt(k,155)*y(k,15))*y(k,3) +rxt(k,16)*y(k,17) &
                  +.206_r8*rxt(k,367)*y(k,89)*y(k,24) +rxt(k,79)*y(k,52) &
                  +2.000_r8*rxt(k,289)*y(k,56) +rxt(k,62)*y(k,65) +rxt(k,78)*y(k,66) &
                  +rxt(k,72)*y(k,69) +2.000_r8*rxt(k,352)*y(k,76)*y(k,76) &
                  +1.340_r8*rxt(k,66)*y(k,78) +.100_r8*rxt(k,83)*y(k,85) +rxt(k,76) &
                 *y(k,90) +.690_r8*rxt(k,77)*y(k,93) +rxt(k,277)*y(k,137)
         ...
         prod(k,141) = (rxt(k,156)*y(k,3) +rxt(k,170)*y(k,23) +rxt(k,172)*y(k,2) + &
                 ...
                 rxt(k,267)*y(k,19))*y(k,23) + (rxt(k,19) +2.000_r8*rxt(k,21)) &
                 *y(k,134) +rxt(k,154)*y(k,15)*y(k,3) +rxt(k,16)*y(k,17) &
                  +2.000_r8*rxt(k,17)*y(k,19) +rxt(k,28)*y(k,33) +rxt(k,34)*y(k,39) &
                  +rxt(k,57)*y(k,140)
         loss(k,142) = (rxt(k,174)* y(k,1) +rxt(k,173)* y(k,2) +rxt(k,188)* y(k,9) &
                  ...
                  +rxt(k,167)* y(k,23) + 2._r8*rxt(k,175)* y(k,24) + (rxt(k,207) + &
         ...
         prod(k,142) = (rxt(k,252)*y(k,108) +rxt(k,255)*y(k,109) +rxt(k,166)*y(k,1) + &
                 ...
                 .350_r8*rxt(k,283)*y(k,135) +rxt(k,305)*y(k,52) +rxt(k,306)*y(k,53) + &
                 rxt(k,307)*y(k,51) +rxt(k,326)*y(k,66) +.200_r8*rxt(k,346)*y(k,80) + &
                 .500_r8*rxt(k,355)*y(k,81) +rxt(k,369)*y(k,90) + &
                 .250_r8*rxt(k,382)*y(k,94) +.500_r8*rxt(k,406)*y(k,157))*y(k,23) &
                  + (rxt(k,270)*y(k,16) +rxt(k,278)*y(k,137) + &
                 .250_r8*rxt(k,286)*y(k,55) +rxt(k,292)*y(k,46) +rxt(k,313)*y(k,61) + &
                 rxt(k,318)*y(k,64) +rxt(k,331)*y(k,73) +.470_r8*rxt(k,340)*y(k,79) + &
                 .920_r8*rxt(k,359)*y(k,88) +.794_r8*rxt(k,365)*y(k,89) + &
                 .900_r8*rxt(k,372)*y(k,84) +rxt(k,375)*y(k,91) + &
                 .900_r8*rxt(k,383)*y(k,96) +.900_r8*rxt(k,390)*y(k,100) + &
                 .900_r8*rxt(k,393)*y(k,103) +rxt(k,397)*y(k,106))*y(k,9) &
                  + (rxt(k,215)*y(k,30) +2.000_r8*rxt(k,272)*y(k,16) + &
                 rxt(k,294)*y(k,46) +.900_r8*rxt(k,302)*y(k,48) +rxt(k,315)*y(k,61) + &
                 .300_r8*rxt(k,324)*y(k,67) +.730_r8*rxt(k,344)*y(k,79) + &
                 rxt(k,350)*y(k,76) +rxt(k,363)*y(k,88) +.800_r8*rxt(k,378)*y(k,91)) &
                 *y(k,16) + (.120_r8*rxt(k,290)*y(k,44) +.190_r8*rxt(k,311)*y(k,59) + &
                 .060_r8*rxt(k,333)*y(k,77) +.275_r8*rxt(k,339)*y(k,78) + &
                 .060_r8*rxt(k,357)*y(k,83) +rxt(k,395)*y(k,105))*y(k,1) &
                  + (rxt(k,266)*y(k,19) +.470_r8*rxt(k,342)*y(k,79) + &
                 rxt(k,360)*y(k,88) +.794_r8*rxt(k,366)*y(k,89) +rxt(k,370)*y(k,90) + &
                 rxt(k,376)*y(k,91))*y(k,11) + (rxt(k,251)*y(k,108) + &
                 rxt(k,256)*y(k,109) +rxt(k,206)*y(k,25) +rxt(k,209)*y(k,19))*y(k,28) &
                  + (.470_r8*rxt(k,345)*y(k,79) +rxt(k,364)*y(k,88) + &
                 rxt(k,379)*y(k,91))*y(k,48) + (rxt(k,176)*y(k,25) + &
                 rxt(k,268)*y(k,19))*y(k,2) + (rxt(k,160)*y(k,22) +rxt(k,288)*y(k,56)) &
                 *y(k,4) + (rxt(k,15) +rxt(k,203))*y(k,13) + (1.340_r8*rxt(k,66) + &
                 .660_r8*rxt(k,67))*y(k,78) +rxt(k,154)*y(k,15)*y(k,3) &
                  +.700_r8*rxt(k,387)*y(k,98)*y(k,10) +rxt(k,233)*y(k,37)*y(k,19) &
                  +1.200_r8*rxt(k,295)*y(k,46)*y(k,46) +rxt(k,69)*y(k,47) +rxt(k,61) &
                 *y(k,50) +2.000_r8*rxt(k,79)*y(k,52) +2.000_r8*rxt(k,82)*y(k,53) &
                  +rxt(k,289)*y(k,56) +rxt(k,71)*y(k,62) +rxt(k,62)*y(k,65) +rxt(k,78) &
                 *y(k,66) +rxt(k,74)*y(k,68) +.900_r8*rxt(k,83)*y(k,85) &
                  +.560_r8*rxt(k,81)*y(k,86) +rxt(k,76)*y(k,90) +rxt(k,77)*y(k,93) &
         ...
         prod(k,89) = (.500_r8*rxt(k,410) +rxt(k,175)*y(k,24))*y(k,24) &
         ...
         prod(k,130) = (rxt(k,252)*y(k,108) +rxt(k,253)*y(k,115) + &
                 ...
                 rxt(k,325)*y(k,69) +rxt(k,327)*y(k,68) +.500_r8*rxt(k,338)*y(k,78) + &
         ...
         prod(k,145) = (2.000_r8*rxt(k,135)*y(k,110) +2.000_r8*rxt(k,136)*y(k,111) + &
                 ...
                 rxt(k,215)*y(k,16) +rxt(k,216)*y(k,9) +2.000_r8*rxt(k,218)*y(k,30) + &
                 rxt(k,220)*y(k,30) +rxt(k,240)*y(k,38))*y(k,30) &
                  + (rxt(k,252)*y(k,108) +3.000_r8*rxt(k,253)*y(k,115) + &
                 rxt(k,254)*y(k,113) +rxt(k,257)*y(k,118) +rxt(k,258)*y(k,119) + &
                 rxt(k,223)*y(k,33))*y(k,23) + (rxt(k,28) +rxt(k,224)*y(k,2))*y(k,33) &
                  +2.000_r8*rxt(k,23)*y(k,29) +2.000_r8*rxt(k,26)*y(k,32) +rxt(k,27) &
         ...
         loss(k,132) = (rxt(k,211)* y(k,2) +rxt(k,216)* y(k,9) +rxt(k,217)* y(k,10) &
                 ...
                 * y(k,24) + 2._r8*(rxt(k,218) +rxt(k,219) +rxt(k,220) +rxt(k,221)) &
         ...
         prod(k,132) = (rxt(k,204)*y(k,1) +rxt(k,208)*y(k,24) +rxt(k,226)*y(k,34)) &
                 *y(k,28) + (rxt(k,225)*y(k,34) +rxt(k,228)*y(k,35))*y(k,2) &
                  +rxt(k,227)*y(k,34)*y(k,23) +rxt(k,25)*y(k,31) +2.000_r8*rxt(k,222) &
         ...
         prod(k,137) = (rxt(k,210)*y(k,15) +2.000_r8*rxt(k,251)*y(k,108) + &
         ...
         prod(k,133) = (rxt(k,144)*y(k,109) +rxt(k,145)*y(k,117) + &
                 rxt(k,146)*y(k,116) +2.000_r8*rxt(k,147)*y(k,122) + &
                 2.000_r8*rxt(k,148)*y(k,123) +3.000_r8*rxt(k,149)*y(k,124) + &
                 2.000_r8*rxt(k,150)*y(k,125) +rxt(k,158)*y(k,39))*y(k,3) &
                  + (rxt(k,32) +rxt(k,234)*y(k,2) +rxt(k,235)*y(k,23) + &
                 rxt(k,237)*y(k,9) +rxt(k,239)*y(k,30) +rxt(k,240)*y(k,30) + &
                 2.000_r8*rxt(k,242)*y(k,38))*y(k,38) + (rxt(k,255)*y(k,109) + &
                 2.000_r8*rxt(k,259)*y(k,125) +3.000_r8*rxt(k,260)*y(k,124) + &
                 rxt(k,243)*y(k,39))*y(k,23) + (rxt(k,256)*y(k,109) + &
                 2.000_r8*rxt(k,261)*y(k,125) +3.000_r8*rxt(k,262)*y(k,124))*y(k,28) &
         ...
         loss(k,128) = (rxt(k,234)* y(k,2) +rxt(k,237)* y(k,9) +rxt(k,238)* y(k,10) &
                 ...
                 rxt(k,240) +rxt(k,241))* y(k,30) + 2._r8*rxt(k,242)* y(k,38) &
         ...
         loss(k,76) = (rxt(k,180)* y(k,2) +rxt(k,179)* y(k,4) + het_rates(k,133)) &
                 * y(k,133)
         prod(k,76) = (rxt(k,451)*y(k,2) +.900_r8*rxt(k,463)*y(k,132))*y(k,127) &
                  +.800_r8*rxt(k,461)*y(k,132)*y(k,131)
         ...
         prod(k,114) =.070_r8*rxt(k,357)*y(k,83)*y(k,1) +.700_r8*rxt(k,68)*y(k,77)
         ...
         loss(k,103) = (rxt(k,318)* y(k,9) +rxt(k,319)* y(k,24) + het_rates(k,64)) &
                 * y(k,64)
         prod(k,103) = (rxt(k,310)*y(k,59) +.500_r8*rxt(k,320)*y(k,65))*y(k,23)
         loss(k,116) = (rxt(k,298)* y(k,11) +rxt(k,297)* y(k,23) + rxt(k,61) &
                  + het_rates(k,50))* y(k,50)
         prod(k,116) = (rxt(k,292)*y(k,46) +.270_r8*rxt(k,313)*y(k,61) + &
                 rxt(k,318)*y(k,64) +rxt(k,331)*y(k,73) +rxt(k,335)*y(k,74) + &
                 .400_r8*rxt(k,372)*y(k,84))*y(k,9) + (.500_r8*rxt(k,311)*y(k,59) + &
                 .040_r8*rxt(k,333)*y(k,77))*y(k,1) + (.500_r8*rxt(k,296)*y(k,47) + &
                 rxt(k,307)*y(k,51))*y(k,23) + (.800_r8*rxt(k,294)*y(k,16) + &
                 1.600_r8*rxt(k,295)*y(k,46))*y(k,46) +rxt(k,69)*y(k,47) +rxt(k,62) &
                 *y(k,65) +rxt(k,84)*y(k,75) +.400_r8*rxt(k,83)*y(k,85)
         loss(k,87) = (rxt(k,291)* y(k,23) + het_rates(k,49))* y(k,49)
         prod(k,87) = (.250_r8*rxt(k,311)*y(k,59) +.200_r8*rxt(k,357)*y(k,83))*y(k,1) &
                  + (.250_r8*rxt(k,301)*y(k,48) +.250_r8*rxt(k,349)*y(k,76))*y(k,24) &
                  +.100_r8*rxt(k,302)*y(k,48)*y(k,16)
         ...
         loss(k,127) = (rxt(k,299)* y(k,9) +rxt(k,300)* y(k,10) +rxt(k,302)* y(k,16) &
                  +rxt(k,301)* y(k,24) + 2._r8*rxt(k,303)* y(k,48) +rxt(k,345) &
                 * y(k,79) +rxt(k,364)* y(k,88) +rxt(k,379)* y(k,91) &
                  + het_rates(k,48))* y(k,48)
         prod(k,127) = (rxt(k,322)*y(k,67) +rxt(k,335)*y(k,74) + &
                 .530_r8*rxt(k,340)*y(k,79) +rxt(k,347)*y(k,76))*y(k,9) &
                  + (rxt(k,298)*y(k,50) +rxt(k,328)*y(k,68) + &
                 .530_r8*rxt(k,342)*y(k,79) +rxt(k,348)*y(k,76))*y(k,11) &
                  + (.300_r8*rxt(k,324)*y(k,67) +.260_r8*rxt(k,344)*y(k,79) + &
                 rxt(k,350)*y(k,76))*y(k,16) + (rxt(k,297)*y(k,50) + &
                 .500_r8*rxt(k,304)*y(k,54) +rxt(k,327)*y(k,68))*y(k,23) &
                  + (.600_r8*rxt(k,64) +rxt(k,308))*y(k,58) &
                  +.530_r8*rxt(k,345)*y(k,79)*y(k,48) +rxt(k,73)*y(k,63) +rxt(k,78) &
                 *y(k,66) +rxt(k,74)*y(k,68) +rxt(k,72)*y(k,69) +rxt(k,80)*y(k,72) &
                  +rxt(k,84)*y(k,75) +2.000_r8*rxt(k,352)*y(k,76)*y(k,76) &
                  +.300_r8*rxt(k,68)*y(k,77) +1.340_r8*rxt(k,66)*y(k,78) &
                  +.130_r8*rxt(k,81)*y(k,86)
         loss(k,75) = (rxt(k,304)* y(k,23) + rxt(k,63) + het_rates(k,54))* y(k,54)
         prod(k,75) = (.750_r8*rxt(k,301)*y(k,48) +.750_r8*rxt(k,349)*y(k,76))*y(k,24)
         ...
         prod(k,61) =.100_r8*rxt(k,372)*y(k,84)*y(k,9) +rxt(k,312)*y(k,59)*y(k,11)
         ...
         prod(k,68) =.800_r8*rxt(k,372)*y(k,84)*y(k,9) +.800_r8*rxt(k,83)*y(k,85)
         ...
         prod(k,39) =.250_r8*rxt(k,382)*y(k,94)*y(k,23)
         loss(k,84) = (rxt(k,383)* y(k,9) +rxt(k,384)* y(k,24) + het_rates(k,96)) &
                 * y(k,96)
         prod(k,84) = (.700_r8*rxt(k,382)*y(k,94) +rxt(k,385)*y(k,97))*y(k,23)
         ...
         prod(k,85) = (.900_r8*rxt(k,383)*y(k,96) +.900_r8*rxt(k,390)*y(k,100) + &
                 .620_r8*rxt(k,393)*y(k,103))*y(k,9) +.700_r8*rxt(k,387)*y(k,98) &
                 *y(k,10) +.900_r8*rxt(k,85)*y(k,97)
         loss(k,95) = (rxt(k,306)* y(k,23) + rxt(k,82) + het_rates(k,53))* y(k,53)
         prod(k,95) = (.020_r8*rxt(k,359)*y(k,88) +.250_r8*rxt(k,375)*y(k,91) + &
                 .450_r8*rxt(k,383)*y(k,96) +.900_r8*rxt(k,390)*y(k,100) + &
                 .340_r8*rxt(k,393)*y(k,103))*y(k,9) + (.250_r8*rxt(k,376)*y(k,11) + &
                 .100_r8*rxt(k,378)*y(k,16) +.250_r8*rxt(k,379)*y(k,48))*y(k,91) &
                  + (.650_r8*rxt(k,283)*y(k,135) +.200_r8*rxt(k,305)*y(k,52))*y(k,23) &
                  +.130_r8*rxt(k,81)*y(k,86) +.450_r8*rxt(k,85)*y(k,97)
         ...
         loss(k,123) = (rxt(k,359)* y(k,9) +rxt(k,360)* y(k,11) +rxt(k,363)* y(k,16) &
                 ...
                 * y(k,88)
         prod(k,123) = (rxt(k,356)*y(k,83) +.200_r8*rxt(k,362)*y(k,93))*y(k,23)
         loss(k,125) = (rxt(k,333)* y(k,1) +rxt(k,332)* y(k,23) + rxt(k,68) &
                  + het_rates(k,77))* y(k,77)
         prod(k,125) = (.320_r8*rxt(k,359)*y(k,9) +.350_r8*rxt(k,360)*y(k,11) + &
                 .260_r8*rxt(k,363)*y(k,16) +.350_r8*rxt(k,364)*y(k,48))*y(k,88) &
                  + (.039_r8*rxt(k,365)*y(k,9) +.039_r8*rxt(k,366)*y(k,11) + &
                 .039_r8*rxt(k,367)*y(k,24))*y(k,89) + (.200_r8*rxt(k,357)*y(k,83) + &
                 rxt(k,395)*y(k,105))*y(k,1) +rxt(k,397)*y(k,106)*y(k,9) &
                  +.402_r8*rxt(k,77)*y(k,93) +rxt(k,86)*y(k,107)
         loss(k,119) = (rxt(k,339)* y(k,1) +rxt(k,338)* y(k,23) + rxt(k,66) &
                  + rxt(k,67) + het_rates(k,78))* y(k,78)
         prod(k,119) = (.230_r8*rxt(k,359)*y(k,9) +.250_r8*rxt(k,360)*y(k,11) + &
                 .190_r8*rxt(k,363)*y(k,16) +.250_r8*rxt(k,364)*y(k,48))*y(k,88) &
                  + (.167_r8*rxt(k,365)*y(k,9) +.167_r8*rxt(k,366)*y(k,11) + &
                 .167_r8*rxt(k,367)*y(k,24))*y(k,89) + (.400_r8*rxt(k,357)*y(k,83) + &
                 rxt(k,395)*y(k,105))*y(k,1) +rxt(k,397)*y(k,106)*y(k,9) &
                  +.288_r8*rxt(k,77)*y(k,93) +rxt(k,86)*y(k,107)
         ...
         prod(k,124) = (rxt(k,332)*y(k,77) +.500_r8*rxt(k,338)*y(k,78) + &
                 .200_r8*rxt(k,346)*y(k,80))*y(k,23)
         ...
         loss(k,126) = (rxt(k,347)* y(k,9) +rxt(k,353)* y(k,10) +rxt(k,348)* y(k,11) &
                  ...
                  + 2._r8*rxt(k,352)* y(k,76) + het_rates(k,76))* y(k,76)
         prod(k,126) = (.500_r8*rxt(k,338)*y(k,78) +.500_r8*rxt(k,346)*y(k,80)) &
                 *y(k,23) + (rxt(k,65) +rxt(k,354))*y(k,81) &
                  +.200_r8*rxt(k,357)*y(k,83)*y(k,1) +.660_r8*rxt(k,66)*y(k,78)
         loss(k,106) = (rxt(k,292)* y(k,9) +rxt(k,294)* y(k,16) +rxt(k,293)* y(k,24) &
                  + 2._r8*rxt(k,295)* y(k,46) + het_rates(k,46))* y(k,46)
         prod(k,106) = (rxt(k,284)*y(k,45) +.500_r8*rxt(k,296)*y(k,47))*y(k,23) &
         ...
         prod(k,94) = (.820_r8*rxt(k,313)*y(k,61) +.500_r8*rxt(k,331)*y(k,73) + &
                 .250_r8*rxt(k,372)*y(k,84) +.100_r8*rxt(k,397)*y(k,106))*y(k,9) &
                  +.820_r8*rxt(k,315)*y(k,61)*y(k,16) +.820_r8*rxt(k,71)*y(k,62) &
                  +.250_r8*rxt(k,83)*y(k,85) +.100_r8*rxt(k,86)*y(k,107)
         ...
         prod(k,79) = (rxt(k,273)*y(k,16) +.300_r8*rxt(k,294)*y(k,46) + &
                 .500_r8*rxt(k,324)*y(k,67) +.250_r8*rxt(k,344)*y(k,79) + &
                 .250_r8*rxt(k,363)*y(k,88) +.300_r8*rxt(k,378)*y(k,91))*y(k,16)
         loss(k,51) = (rxt(k,307)* y(k,23) + het_rates(k,51))* y(k,51)
         prod(k,51) = (.200_r8*rxt(k,294)*y(k,16) +.400_r8*rxt(k,295)*y(k,46))*y(k,46)
         loss(k,110) = (rxt(k,305)* y(k,23) + rxt(k,79) + het_rates(k,52))* y(k,52)
         prod(k,110) = (.530_r8*rxt(k,340)*y(k,9) +.530_r8*rxt(k,342)*y(k,11) + &
                 .260_r8*rxt(k,344)*y(k,16) +.530_r8*rxt(k,345)*y(k,48))*y(k,79) &
                  + (.250_r8*rxt(k,375)*y(k,9) +.250_r8*rxt(k,376)*y(k,11) + &
                 .100_r8*rxt(k,378)*y(k,16) +.250_r8*rxt(k,379)*y(k,48))*y(k,91) &
                  +rxt(k,288)*y(k,56)*y(k,4) +.020_r8*rxt(k,359)*y(k,88)*y(k,9)
         loss(k,118) = (rxt(k,326)* y(k,23) + rxt(k,78) + het_rates(k,66))* y(k,66)
         prod(k,118) = (.220_r8*rxt(k,340)*y(k,9) +.220_r8*rxt(k,342)*y(k,11) + &
                 .230_r8*rxt(k,344)*y(k,16) +.220_r8*rxt(k,345)*y(k,48))*y(k,79) &
                  + (.250_r8*rxt(k,375)*y(k,9) +.250_r8*rxt(k,376)*y(k,11) + &
                 .100_r8*rxt(k,378)*y(k,16) +.250_r8*rxt(k,379)*y(k,48))*y(k,91) &
                  + (.500_r8*rxt(k,320)*y(k,65) +.500_r8*rxt(k,355)*y(k,81))*y(k,23) &
                  +.020_r8*rxt(k,359)*y(k,88)*y(k,9) +.200_r8*rxt(k,324)*y(k,67) &
                 *y(k,16)
         ...
         prod(k,69) =.750_r8*rxt(k,286)*y(k,55)*y(k,9) +rxt(k,70)*y(k,57)
         ...
         prod(k,60) = (.330_r8*rxt(k,359)*y(k,9) +.400_r8*rxt(k,360)*y(k,11) + &
                 .300_r8*rxt(k,363)*y(k,16) +.400_r8*rxt(k,364)*y(k,48))*y(k,88) &
         ...
         prod(k,121) = (.250_r8*rxt(k,340)*y(k,79) +.020_r8*rxt(k,359)*y(k,88) + &
                 .250_r8*rxt(k,375)*y(k,91) +.450_r8*rxt(k,383)*y(k,96) + &
                 .540_r8*rxt(k,393)*y(k,103))*y(k,9) + (.500_r8*rxt(k,324)*y(k,67) + &
                 .240_r8*rxt(k,344)*y(k,79) +.100_r8*rxt(k,378)*y(k,91))*y(k,16) &
                  + (.950_r8*rxt(k,333)*y(k,77) +.800_r8*rxt(k,339)*y(k,78))*y(k,1) &
                  + (.250_r8*rxt(k,342)*y(k,79) +.250_r8*rxt(k,376)*y(k,91))*y(k,11) &
                  + (rxt(k,326)*y(k,66) +rxt(k,329)*y(k,82))*y(k,23) &
                  + (.250_r8*rxt(k,345)*y(k,79) +.250_r8*rxt(k,379)*y(k,91))*y(k,48) &
                  +.180_r8*rxt(k,81)*y(k,86) +.450_r8*rxt(k,85)*y(k,97)
         ...
         prod(k,111) = (.800_r8*rxt(k,341)*y(k,79) +.080_r8*rxt(k,359)*y(k,88) + &
                 .794_r8*rxt(k,365)*y(k,89))*y(k,9) + (.794_r8*rxt(k,366)*y(k,11) + &
                 .794_r8*rxt(k,367)*y(k,24))*y(k,89)
         loss(k,122) = (rxt(k,375)* y(k,9) +rxt(k,376)* y(k,11) +rxt(k,378)* y(k,16) &
                  +rxt(k,377)* y(k,24) +rxt(k,379)* y(k,48) + het_rates(k,91)) &
                 * y(k,91)
         prod(k,122) = (.800_r8*rxt(k,362)*y(k,93) +rxt(k,371)*y(k,87) + &
         ...
         prod(k,78) = (rxt(k,278)*y(k,9) +rxt(k,279)*y(k,24))*y(k,137) &
                  +.500_r8*rxt(k,290)*y(k,44)*y(k,1) +.350_r8*rxt(k,283)*y(k,135) &
                 *y(k,23)
         ...
         prod(k,41) = (rxt(k,136)*y(k,111) +rxt(k,137)*y(k,112) + &
                 ...
                 2.000_r8*rxt(k,148)*y(k,123))*y(k,3) + (rxt(k,254)*y(k,113) + &
         ...
         prod(k,101) = (rxt(k,139)*y(k,121) +rxt(k,146)*y(k,116) + &
                 2.000_r8*rxt(k,151)*y(k,138) +rxt(k,152)*y(k,139))*y(k,3) &
                  +2.000_r8*rxt(k,55)*y(k,138) +rxt(k,56)*y(k,139) +rxt(k,57)*y(k,140)
         loss(k,36) = (rxt(k,404)* y(k,23) + het_rates(k,156))* y(k,156)
         prod(k,36) = (rxt(k,405)*y(k,23) +.500_r8*rxt(k,406)*y(k,23) + &
