...
!    write(*,nml=clubb_params_nl) ! %% debug
  ...
  subroutine pack_parameters &
    ...
    !-----------------------------------------------------------------------
      ...
      &ic_k_hmb, ik_hm_min_coef, inu_hm, igamma_coef, igamma_coefb, igamma_coefc, imu, ibeta, ilmin_coef, iomicron, &
      &izeta_vrnce_rat, iupsilon_precip_frac_rat, ilambda0_stability_coef, imult_coef, itaumin, itaumax, ilscale_mu_coef, &
      &ilscale_pert_coef, ialpha_corr, iskw_denom_coef, ic_k10, ic_k10h, ithlp2_rad_coef, ithlp2_rad_cloud_frac_thresh, nparams 
