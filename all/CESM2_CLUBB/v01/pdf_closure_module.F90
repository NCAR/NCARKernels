...
!------------------------------------------------------------------------
  ...
  subroutine pdf_closure( hydromet_dim, p_in_Pa, exner, thv_ds, wm, &
    ...
    !
      ...
      USE constants_clubb, ONLY: two, one, one_half, zero, cp, lv, rd, ep, ep1, ep2, w_tol_sqd, rt_tol, thl_tol, t_freeze_k, &
      &fstderr, zero_threshold, chi_tol, eps, w_tol 
    ...
    ! The error function
      ...
      USE model_flags, ONLY: l_use_adg2, l_use_3d_closure 
...
!                        * sqrt( sclrp2(i) )) )/w_1_n
  ...
  !
      ...
      USE constants_clubb, ONLY: one, one_half 
  ...
  elemental subroutine backsolve_Luhar_params( Sk_max, Skx, &
    ...
    !
      ...
      USE constants_clubb, ONLY: three, two, one, one_half, zero, eps 
