...
!
  ...
  subroutine advance_clubb_core &
    ...
    ! Modules to be included
      ...
      USE constants_clubb, ONLY: em_min, thl_tol, rt_tol, w_tol, w_tol_sqd, ep2, cp, lv, ls, ep1, p0, kappa, fstderr, &
      &zero_threshold, three_halves, zero, unused_var 

      USE parameters_tunable, ONLY: gamma_coefc, gamma_coefb, gamma_coef, taumax, c_k, mu, lscale_mu_coef, lscale_pert_coef, &
      &c_k10, c_k10h, beta, c1, c14 

      USE parameters_model, ONLY: sclr_dim, edsclr_dim, sclr_tol, ts_nudge, rtm_min, rtm_nudge_max_altitude 

      USE model_flags, ONLY: l_tke_aniso, l_gamma_skw, l_trapezoidal_rule_zt, l_trapezoidal_rule_zm, l_call_pdf_closure_twice, &
      &l_host_applies_sfc_fluxes, l_use_cloud_cover, l_rtm_nudge, l_use_3d_closure, l_stability_correct_tau_zm, &
      &l_do_expldiff_rtm_thlm, l_lscale_plume_centered, l_use_ice_latent, l_damp_wp2_using_em 

      USE grid_class, ONLY: gr, zm2zt, zt2zm 

      USE numerical_check, ONLY: parameterization_check, calculate_spurious_source 

      USE variables_diagnostic_module, ONLY: skw_zt, skw_zm, skthl_zt, skthl_zm, skrt_zt, skrt_zm, sigma_sqd_w_zt, wp4, thlpthvp, &
      &rtpthvp, rtprcp, thlprcp, rcp2, rsat, pdf_params_zm, wprtp2, wp2rtp, wpthlp2, wp2thlp, wprtpthlp, wpthvp, wp2thvp, wp2rcp 
      ...
      USE variables_diagnostic_module, ONLY: wpedsclrp, sclrpthvp, sclrprcp, wp2sclrp, wpsclrp2, wpsclrprtp, wpsclrpthlp, wp3_zm, &
      &thlp3_zm, rtp3_zm, skw_velocity, a3_coef, a3_coef_zt 
      ...
      USE skx_module, ONLY: skx_func, lg_2005_ansatz 
      ...
      &irtm_bt, ithlm_bt, ivm_bt, ium_bt, iwp4, irsat, irvm, irel_humidity, iwpthlp_zt, iskw_zt, iskw_zm, iskthl_zt, iskthl_zm, &
      &iskrt_zt, iskrt_zm 
      ...
      USE stats_variables, ONLY: irfrzm, icloud_frac_refined, istability_correction, ircm_refined 

      USE stats_variables, ONLY: iskw_velocity, igamma_skw_fnc, ilscale_pert_1, ilscale_pert_2 
