...
module surface_varnce_module
  ...
  subroutine surface_varnce( upwp_sfc, vpwp_sfc, wpthlp_sfc, wprtp_sfc, & 
    ...
    !-----------------------------------------------------------------------
      ...
      USE constants_clubb, ONLY: four, two, one, two_thirds, one_third, one_fourth, zero, grav, eps, fstderr 

      USE parameters_model, ONLY: sclr_dim 

      USE numerical_check, ONLY: surface_varnce_check 

      USE error_code, ONLY: clubb_var_equals_nan, clubb_at_least_debug_level, clubb_no_error 
