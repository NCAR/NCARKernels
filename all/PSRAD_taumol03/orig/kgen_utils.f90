    ...
    interface read_var
        ...
        module procedure read_var_real_wp_dim2_pointer
        module procedure read_var_real_wp_dim3

        module procedure read_var_integer_dim1
        module procedure read_var_integer_dim2
    ...
    interface verify_var
        ...
        module procedure verify_var_real_wp_dim1
        module procedure verify_var_real_wp_dim2
        module procedure verify_var_real_wp_dim3
    ...
    subroutine read_var_integer_dim1(var, kgen_unit)
    integer, intent(in) :: kgen_unit
    integer, intent(out), dimension(:), allocatable :: var
    logical is_save
    ...
    subroutine read_var_integer_dim2(var, kgen_unit)
    integer, intent(in) :: kgen_unit
    integer, intent(out), dimension(:,:), allocatable :: var
    logical is_save
    ...
    subroutine read_var_real_wp_dim2_pointer(var, kgen_unit, is_pointer)
    integer, intent(in) :: kgen_unit
    real(kind=wp), intent(out), dimension(:,:), pointer :: var
    ...
    subroutine verify_var_real_wp_dim1(varname, var, ref_var)
    character(*), intent(in) :: varname
    real(kind=wp), intent(in), dimension(:) :: var, ref_var
    ...
    subroutine verify_var_real_wp_dim2(varname, var, ref_var)
    character(*), intent(in) :: varname
    real(kind=wp), intent(in), dimension(:,:) :: var, ref_var
    ...
    subroutine verify_var_real_wp_dim3(varname, var, ref_var)
    character(*), intent(in) :: varname
    real(kind=wp), intent(in), dimension(:,:,:) :: var, ref_var
