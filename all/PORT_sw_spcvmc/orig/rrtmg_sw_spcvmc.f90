         ...
         do jg = 1,igt
            ...
            do jk=1,klev
               ...
               lrtchkcld(iplon,jk)=(pcldfmc(iplon,ikl,iw(iplon)) > repclc(iplon))
                            ...
                            !               zomco(iplon,jk) = ptaucmc(ikl,iw(iplon)) * pomgcmc(ikl,iw(iplon)) + ztaur(ikl,iw(
                            ! iplon))
               ...
               elseif (icpr .eq. 0) then
                  ...
                  zomco(iplon,jk) = zomco(iplon,jk) / ztauo(iplon,jk)
                                ...
                                !   Use only if subroutine rrtmg_sw_cldprop is not used to get cloud properties and to apply 
                                ! delta scaling
