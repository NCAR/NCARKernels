...
contains
  ...
  !-----------------------------------------------------------------------------------!
  !YSK subroutine reconstruction(fcube,recons,irecons,llimiter,ntrac_in,&
  subroutine reconstruction(fcube,nlev_in,k_in,recons,irecons,llimiter,ntrac_in,&
    ...
    !
    !
    ! c(1-nhc:nc+nhc,1-nhc:nc+nhc,nlev,ntrac_d,2)
    !!!YSK  k,ntrac,no_fvm
    !!!YSK call reconstruction(fvm(ie)%c(1-nhc:nc+nhc,1-nhc:nc+nhc,k,1:ntrac,n0_fvm),&
    integer, intent(in) :: irecons
    integer, intent(in) :: nlev_in, k_in !YSK
    integer, intent(in) :: ntrac_in,nc,nhe,nhr,nhc,nht,ns,nh,cubeboundary
    !YSKreal (kind=r8), dimension(1-nhc:nc+nhc,1-nhc:nc+nhc,ntrac_in),         intent(inout) :: fcube
    real (kind=r8), dimension(1-nhc:nc+nhc,1-nhc:nc+nhc,nlev_in,ntrac_in), TARGET, intent(inout) :: fcube
    !!!real (kind=r8), dimension(:,:,:), POINTER :: fcube
...
!                recons(2:6,i,j,itr)  = 0.0_r8       !hack first-order
  ...
  subroutine slope_limiter(nhe,nc,nhc,fcube,jx,jy,irecons,recons,spherecentroid,recons_metrics,&
    ...
    !!YSK real (kind=r8), dimension(1-nhc:, 1-nhc:),                      intent(inout)  :: fcube
    real (kind=r8), dimension(1-nhc:nc+nhc, 1-nhc:nc+nhc),                      intent(inout)  :: fcube !YSK
