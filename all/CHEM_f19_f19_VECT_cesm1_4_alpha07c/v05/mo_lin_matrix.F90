...
!----------------------------------------------
      ...
      do k = ofl,ofu
         ...
         mat(k,852) = rxt(k,1) + 2.000_r4*rxt(k,2) + rxt(k,95) + rxt(k,96) + rxt(k,97) &
         ...
         mat(k,613) = rxt(k,61)
         mat(k,643) = 1.340_r4*rxt(k,67)
         mat(k,745) = .700_r4*rxt(k,68)
         mat(k,668) = rxt(k,74)
         mat(k,559) = rxt(k,76)
         mat(k,553) = rxt(k,79)
         mat(k,314) = .450_r4*rxt(k,81)
         mat(k,398) = 2.000_r4*rxt(k,82)
         ...
         mat(k,1388) = rxt(k,8) + .500_r4*rxt(k,402)
         mat(k,128) = rxt(k,10)
         mat(k,1012) = rxt(k,13)
         mat(k,425) = rxt(k,460)
         mat(k,1353) = 2.000_r4*rxt(k,132)*y(k,7)
         ...
         mat(k,588) = rxt(k,30)
         mat(k,277) = rxt(k,36)
         mat(k,243) = .600_r4*rxt(k,64) + rxt(k,308)
         ...
         mat(k,585) = rxt(k,29)
         mat(k,276) = rxt(k,35)
         mat(k,239) = .400_r4*rxt(k,64)

         mat(k,870) = -( rxt(k,11) + het_rates(k,12) )
         mat(k,127) = 2.000_r4*rxt(k,400) + 2.000_r4*rxt(k,432) + 2.000_r4*rxt(k,438) &
                      + 2.000_r4*rxt(k,443)
         mat(k,1011) = rxt(k,401)
         mat(k,1385) = .500_r4*rxt(k,402)
         ...
         mat(k,619) = rxt(k,61)
         mat(k,247) = rxt(k,63)
         mat(k,240) = .400_r4*rxt(k,64)
         mat(k,758) = .300_r4*rxt(k,68)
         mat(k,395) = rxt(k,73)
         ...
         mat(k,196) = rxt(k,16)
         mat(k,293) = rxt(k,62)
         mat(k,652) = 1.340_r4*rxt(k,66)
         mat(k,185) = rxt(k,72)
         mat(k,563) = rxt(k,76)
         mat(k,301) = .690_r4*rxt(k,77)
         mat(k,641) = rxt(k,78)
         mat(k,555) = rxt(k,79)
         mat(k,354) = .100_r4*rxt(k,83)
         mat(k,189) = rxt(k,277)
         mat(k,206) = 2.000_r4*rxt(k,289)
         mat(k,1359) = rxt(k,154)*y(k,15) + rxt(k,155)*y(k,15)

         mat(k,1263) = -( het_rates(k,22) )
         mat(k,197) = rxt(k,16)
         mat(k,1246) = 2.000_r4*rxt(k,17)
         mat(k,862) = rxt(k,19) + 2.000_r4*rxt(k,21)
         mat(k,1083) = rxt(k,28)
         mat(k,481) = rxt(k,34)
         mat(k,96) = rxt(k,57)
         ...
         mat(k,622) = rxt(k,61)
         mat(k,294) = rxt(k,62)
         mat(k,654) = 1.340_r4*rxt(k,66) + .660_r4*rxt(k,67)
         mat(k,153) = rxt(k,69)
         mat(k,179) = rxt(k,71)
         mat(k,676) = rxt(k,74)
         mat(k,564) = rxt(k,76)
         mat(k,302) = rxt(k,77)
         mat(k,642) = rxt(k,78)
         mat(k,556) = 2.000_r4*rxt(k,79)
         mat(k,317) = .560_r4*rxt(k,81)
         mat(k,400) = 2.000_r4*rxt(k,82)
         mat(k,355) = .900_r4*rxt(k,83)
         mat(k,214) = rxt(k,86)
         mat(k,190) = rxt(k,277)
         mat(k,207) = rxt(k,289)
         ...
         mat(k,81) = 2.000_r4*rxt(k,23)
         mat(k,903) = rxt(k,24)
         mat(k,32) = 2.000_r4*rxt(k,26)
         mat(k,516) = rxt(k,27)
         mat(k,1087) = rxt(k,28)
         mat(k,589) = rxt(k,29)
         mat(k,105) = rxt(k,31)
         mat(k,89) = rxt(k,56)
         mat(k,1364) = 2.000_r4*rxt(k,135)*y(k,110) + 2.000_r4*rxt(k,136)*y(k,111) &
                      ...
                      + rxt(k,145)*y(k,117)
         mat(k,1186) = rxt(k,252)*y(k,108) + 3.000_r4*rxt(k,253)*y(k,115) &
         ...
         mat(k,1425) = rxt(k,210)*y(k,15) + 2.000_r4*rxt(k,251)*y(k,108) &
...
!----------------------------------------------
      ...
      do k = ofl,ofu
         ...
         mat(k,1352) = rxt(k,144)*y(k,109) + rxt(k,145)*y(k,117) + rxt(k,146)*y(k,116) &
                      + 2.000_r4*rxt(k,147)*y(k,122) + 2.000_r4*rxt(k,148)*y(k,123) &
                      + 3.000_r4*rxt(k,149)*y(k,124) + 2.000_r4*rxt(k,150)*y(k,125)
         mat(k,1174) = rxt(k,255)*y(k,109) + 2.000_r4*rxt(k,259)*y(k,125) &
                      + 3.000_r4*rxt(k,260)*y(k,124)
         mat(k,1421) = rxt(k,256)*y(k,109) + 2.000_r4*rxt(k,261)*y(k,125) &
                      + 3.000_r4*rxt(k,262)*y(k,124)
         ...
         mat(k,238) = .600_r4*rxt(k,64) + rxt(k,308)
         mat(k,648) = 1.340_r4*rxt(k,66)
         mat(k,752) = .300_r4*rxt(k,68)
         mat(k,182) = rxt(k,72)
         mat(k,393) = rxt(k,73)
         mat(k,670) = rxt(k,74)
         mat(k,639) = rxt(k,78)
         mat(k,201) = rxt(k,80)
         mat(k,316) = .130_r4*rxt(k,81)
         mat(k,142) = rxt(k,84)
         ...
         mat(k,163) = .900_r4*rxt(k,85)

         mat(k,397) = -( rxt(k,82) + het_rates(k,53) )
         mat(k,313) = .130_r4*rxt(k,81)
         mat(k,164) = .450_r4*rxt(k,85)
         ...
         mat(k,299) = .402_r4*rxt(k,77)
         mat(k,212) = rxt(k,86)

         mat(k,644) = -( rxt(k,66) + rxt(k,67) + het_rates(k,78) )
         mat(k,296) = .288_r4*rxt(k,77)
         mat(k,211) = rxt(k,86)
         ...
         mat(k,175) = .820_r4*rxt(k,71)
         mat(k,349) = .250_r4*rxt(k,83)
         mat(k,209) = .100_r4*rxt(k,86)
         ...
         mat(k,315) = .180_r4*rxt(k,81)
         mat(k,165) = .450_r4*rxt(k,85)
