...
! * only leave required use information
    ...
    call verify_var("packed_rate1ord_cw2pr_st", packed_rate1ord_cw2pr_st, ref_packed_rate1ord_cw2pr_st)
    call verify_var("packed_tlat", packed_tlat, ref_packed_tlat)
    call verify_var("packed_qvlat", packed_qvlat, ref_packed_qvlat)
    call verify_var("packed_qctend", packed_qctend, ref_packed_qctend)
    call verify_var("packed_qitend", packed_qitend, ref_packed_qitend)
    call verify_var("packed_nctend", packed_nctend, ref_packed_nctend)
    call verify_var("packed_nitend", packed_nitend, ref_packed_nitend)
    call verify_var("packed_qrtend", packed_qrtend, ref_packed_qrtend)
    call verify_var("packed_qstend", packed_qstend, ref_packed_qstend)
    call verify_var("packed_nrtend", packed_nrtend, ref_packed_nrtend)
    call verify_var("packed_nstend", packed_nstend, ref_packed_nstend)
    call verify_var("packed_prect", packed_prect, ref_packed_prect)
    call verify_var("packed_preci", packed_preci, ref_packed_preci)
    call verify_var("packed_nevapr", packed_nevapr, ref_packed_nevapr)
    call verify_var("packed_evapsnow", packed_evapsnow, ref_packed_evapsnow)
    call verify_var("packed_prain", packed_prain, ref_packed_prain)
    call verify_var("packed_prodsnow", packed_prodsnow, ref_packed_prodsnow)
    call verify_var("packed_cmeout", packed_cmeout, ref_packed_cmeout)
    call verify_var("packed_qsout", packed_qsout, ref_packed_qsout)
    call verify_var("packed_rflx", packed_rflx, ref_packed_rflx)
    call verify_var("packed_sflx", packed_sflx, ref_packed_sflx)
    call verify_var("packed_qrout", packed_qrout, ref_packed_qrout)
    call verify_var("packed_qcsevap", packed_qcsevap, ref_packed_qcsevap)
    call verify_var("packed_qisevap", packed_qisevap, ref_packed_qisevap)
    call verify_var("packed_qvres", packed_qvres, ref_packed_qvres)
    call verify_var("packed_cmei", packed_cmei, ref_packed_cmei)
    call verify_var("packed_vtrmc", packed_vtrmc, ref_packed_vtrmc)
    call verify_var("packed_vtrmi", packed_vtrmi, ref_packed_vtrmi)
    call verify_var("packed_umr", packed_umr, ref_packed_umr)
    call verify_var("packed_ums", packed_ums, ref_packed_ums)
    call verify_var("packed_qcsedten", packed_qcsedten, ref_packed_qcsedten)
    call verify_var("packed_qisedten", packed_qisedten, ref_packed_qisedten)
    call verify_var("packed_pra", packed_pra, ref_packed_pra)
    call verify_var("packed_prc", packed_prc, ref_packed_prc)
    call verify_var("packed_mnuccc", packed_mnuccc, ref_packed_mnuccc)
    call verify_var("packed_mnucct", packed_mnucct, ref_packed_mnucct)
    call verify_var("packed_msacwi", packed_msacwi, ref_packed_msacwi)
    call verify_var("packed_psacws", packed_psacws, ref_packed_psacws)
    call verify_var("packed_bergs", packed_bergs, ref_packed_bergs)
    call verify_var("packed_berg", packed_berg, ref_packed_berg)
    call verify_var("packed_melt", packed_melt, ref_packed_melt)
    call verify_var("packed_homo", packed_homo, ref_packed_homo)
    call verify_var("packed_qcres", packed_qcres, ref_packed_qcres)
    call verify_var("packed_prci", packed_prci, ref_packed_prci)
    call verify_var("packed_prai", packed_prai, ref_packed_prai)
    call verify_var("packed_qires", packed_qires, ref_packed_qires)
    call verify_var("packed_mnuccr", packed_mnuccr, ref_packed_mnuccr)
    call verify_var("packed_pracs", packed_pracs, ref_packed_pracs)
    call verify_var("packed_meltsdt", packed_meltsdt, ref_packed_meltsdt)
    call verify_var("packed_frzrdt", packed_frzrdt, ref_packed_frzrdt)
    call verify_var("packed_mnuccd", packed_mnuccd, ref_packed_mnuccd)
    call verify_var("packed_nrout", packed_nrout, ref_packed_nrout)
    call verify_var("packed_nsout", packed_nsout, ref_packed_nsout)
    call verify_var("packed_refl", packed_refl, ref_packed_refl)
    call verify_var("packed_arefl", packed_arefl, ref_packed_arefl)
    call verify_var("packed_areflz", packed_areflz, ref_packed_areflz)
    call verify_var("packed_frefl", packed_frefl, ref_packed_frefl)
    call verify_var("packed_csrfl", packed_csrfl, ref_packed_csrfl)
    call verify_var("packed_acsrfl", packed_acsrfl, ref_packed_acsrfl)
    call verify_var("packed_fcsrfl", packed_fcsrfl, ref_packed_fcsrfl)
    call verify_var("packed_rercld", packed_rercld, ref_packed_rercld)
    call verify_var("packed_ncai", packed_ncai, ref_packed_ncai)
    call verify_var("packed_ncal", packed_ncal, ref_packed_ncal)
    call verify_var("packed_qrout2", packed_qrout2, ref_packed_qrout2)
    call verify_var("packed_qsout2", packed_qsout2, ref_packed_qsout2)
    call verify_var("packed_nrout2", packed_nrout2, ref_packed_nrout2)
    call verify_var("packed_nsout2", packed_nsout2, ref_packed_nsout2)
    call verify_var("packed_freqs", packed_freqs, ref_packed_freqs)
    call verify_var("packed_freqr", packed_freqr, ref_packed_freqr)
    call verify_var("packed_nfice", packed_nfice, ref_packed_nfice)
    call verify_var("packed_qcrat", packed_qcrat, ref_packed_qcrat)
    call verify_var("packed_rel", packed_rel, ref_packed_rel)
    call verify_var("packed_rei", packed_rei, ref_packed_rei)
    call verify_var("packed_lambdac", packed_lambdac, ref_packed_lambdac)
    call verify_var("packed_mu", packed_mu, ref_packed_mu)
    call verify_var("packed_des", packed_des, ref_packed_des)
    call verify_var("packed_dei", packed_dei, ref_packed_dei)
    call verify_var("rel_fn_dum", rel_fn_dum, ref_rel_fn_dum)
    call verify_var("dsout2_dum", dsout2_dum, ref_dsout2_dum)
    call verify_var("drout_dum", drout_dum, ref_drout_dum)
    call verify_var("reff_rain_dum", reff_rain_dum, ref_reff_rain_dum)
    call verify_var("reff_snow_dum", reff_snow_dum, ref_reff_snow_dum)
